<?php
/* SVN FILE: $Id: javascript.php,v 1.3 2009-11-12 14:44:45 sigep Exp $ */
/**
 ...
 * @lastmodified	$Date: 2009-11-12 14:44:45 $
 ...
 */
 ...
 function helpers_javascript($script){
 ...
 */
	function link($url) {
		...
		return sprintf($this->tags['javascriptlink'], $this->webroot . $this->themeWeb . JS_URL . $url."?var=javascript_sisap_".date("d_m_Y")."_sisap");
	}
/**

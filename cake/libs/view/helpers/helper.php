<?php
/* SVN FILE: $Id: helper.php,v 1.2 2009-10-29 15:49:17 sigep Exp $ */
/**
 * Backend for helpers.
 *
 ...
 * @lastmodified	$Date: 2009-10-29 15:49:17 $
 ...
 */
	var $tags = array('link' => '<a href="%s" %s>%s</a>',
							...
							'radio' => '<input type="radio" name="data[%s][%s]" id="%s" %s /><label for="%s" %s>%s</label>',

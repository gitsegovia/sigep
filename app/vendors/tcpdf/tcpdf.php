...
if (!class_exists('TCPDF', false)) {
	 ...
	 */
	define('PDF_PRODUCER', 'TCPDF 4.5.031 (http://www.tcpdf.org)');
	...
	*/
	class TCPDF {
		...
		*/
		public function Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=0, $link='', $stretch=0, $minuscula=null) {
	 ...
	 /**
		...
		* @see Close()
		*/
		public function Output($name='doc.pdf', $dest='D',$automatico=1) {
			...
			switch($dest) {
				...
				case 'SISAP_AJAX_NORMAL':{
						...
						if(file_exists("../webroot/pdf_generados/".$name.".pdf")){
							     //chmod("../webroot/pdf_generados/".$name.".pdf", 0777);
							     $chm= "/var/www/sigep/app/webroot/pdf_generados/$name.pdf";
							     shell_exec($chm);
						}
						echo " <script type='text/javascript'>
...
function info_top_reporte($titulo_varios = array(), $posicion_img = array(), $posicion_pie_pagina = array(), $consolidado=true){
               ...
               $img_dependencia_o = '/var/www/sigep/app/webroot/img/escudo_base/escudo10.jpg';
...
function portal_top_reporte($titulo_varios = array(), $posicion_img = array(), $posicion_pie_pagina = array(), $consolidado=true,$logo_top_portal = '1_11_30_11'){
               ...
               $img_dependencia_o = '/var/www/sigep/app/webroot/img/escudos/escudo_'.$logo_top_portal.'.jpg';

		        if(file_exists($img_dependencia_o)){
		        	$escudo=$img_dependencia_o;
		        }else{
		        	$escudo="/var/www/sigep/app/webroot/img/infogobierno/escudo_venezuela.jpg";
		        }

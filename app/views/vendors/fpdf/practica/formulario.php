...
<form name="f1" method="POST" action="cabecera.php">
<center>
<br><br><br><br>
<table width="500" bgcolor="#EFEFEF" border="0" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#F4F4F4"><div align="right"><strong>Cantidad de registros a imprimir:</strong></div></td>
    <td bgcolor="#F8F8F8"><input type="text" name="num_registro" size="4" maxlength="3"></td>
  </tr>

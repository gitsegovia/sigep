...
if (!defined("K_TCPDF_EXTERNAL_CONFIG")) {
	 ...
	 * installation path
	 */
	define ("K_PATH_MAIN", "/var/www/sigep/app/vendors/utf8_tcpdf/");

	/**
	 * url path
	 */
	define ("K_PATH_URL", "http://deerme/tcpdf/");
	 ...
	 * header title
	 */
	define ("PDF_HEADER_TITLE", "Comunidad DeeRme");

	/**
	 * header description string
	 */
	define ("PDF_HEADER_STRING", "http://deerme.org");

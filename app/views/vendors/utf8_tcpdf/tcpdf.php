...
(0,10,'Page '.$this->PageNo().'/{nb}',0,0,'C');
		...
		*/
		function Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=0, $link='',$minuscula=false) {
			//Output a cell
			$k=$this->k;
			if(isset($minuscula) && $minuscula==true){
				$txt = $txt;
			}else{
				$txt = strtoupper($txt);
			}
		...
		*/
		function MultiCell($w, $h, $txt, $border=0, $align='J', $fill=0,$minuscula=false) {

...
(
  ...
  CONSTRAINT shd100_declaracion_ingresos_pkey PRIMARY KEY (cod_presi, cod_entidad, cod_tipo_inst, cod_inst, cod_dep,rif_cedula, numero_declaracion),
...
(
  ...
  CONSTRAINT shd900_cobranza_acumulada_pkey PRIMARY KEY (cod_presi, cod_entidad, cod_tipo_inst, cod_inst, cod_dep, ano, mes, dia, cod_partida, cod_generica, cod_especifica, cod_sub_espec, cod_auxiliar)
)
WITH (OIDS=FALSE);

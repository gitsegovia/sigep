-- View: cscd05_consumo_productos_dep

-- DROP VIEW cscd05_consumo_productos_dep;

CREATE OR REPLACE VIEW cscd05_consumo_productos_dep AS
...
GROUP BY ne.cod_presi, ne.cod_entidad, ne.cod_tipo_inst, ne.cod_inst, ne.cod_dep, ne.ano_nota_entrega, ne.codigo_prod_serv
ORDER BY ne.cod_presi, ne.cod_entidad, ne.cod_tipo_inst, ne.cod_inst, ne.cod_dep, ne.ano_nota_entrega, ne.codigo_prod_serv;

ALTER TABLE cscd05_consumo_productos_dep OWNER TO sisap;

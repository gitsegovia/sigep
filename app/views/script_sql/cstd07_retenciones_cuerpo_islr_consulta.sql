...
DROP VIEW cstd07_retenciones_cuerpo_islr_consutal;



CREATE OR REPLACE VIEW cstd07_retenciones_cuerpo_islr_consutal AS
...
FROM
       ...
       cstd07_retenciones_cuerpo_islr a;


ALTER TABLE cstd07_retenciones_cuerpo_islr_consutal OWNER TO sisap;

-- View: d_p_super_busqueda_solo_cnmd06_ficha

--DROP VIEW d_p_super_busqueda_solo_cnmd06_ficha;

CREATE OR REPLACE VIEW d_p_super_busqueda_solo_cnmd06_ficha AS
 ...
 SELECT
  ...
  a.username_registro,
  a.fecha_registro,
  a.username_movimiento,
  a.fecha_movimiento,
  a.ultimo_recibo,
  text_null_(a.mensaje_personal) as mensaje_personal,
 b.cedula_identidad,
 b.nacionalidad,
 b.primer_apellido,
 b.segundo_apellido,
...
ALTER TABLE d_p_super_busqueda_solo_cnmd06_ficha OWNER TO sisap;
...
DROP VIEW cstd07_retenciones_cuerpo_multa_consutal;


CREATE OR REPLACE VIEW cstd07_retenciones_cuerpo_multa_consutal AS
...
FROM
       ...
       cstd07_retenciones_cuerpo_multa a;


ALTER TABLE cstd07_retenciones_cuerpo_multa_consutal OWNER TO sisap;

DROP VIEW v_cstd03_cheque_ordenes_orden_pago;

CREATE OR REPLACE VIEW v_cstd03_cheque_ordenes_orden_pago AS
...
FROM   cstd03_cheque_ordenes a, cepd03_ordenpago_cuerpo b
...
ALTER TABLE v_cstd03_cheque_ordenes_orden_pago OWNER TO sisap;

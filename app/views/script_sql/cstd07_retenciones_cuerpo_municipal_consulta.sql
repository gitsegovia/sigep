...
DROP VIEW cstd07_retenciones_cuerpo_municipal_consutal;


CREATE OR REPLACE VIEW cstd07_retenciones_cuerpo_municipal_consutal AS
...
FROM
       ...
       cstd07_retenciones_cuerpo_municipal a;


ALTER TABLE cstd07_retenciones_cuerpo_municipal_consutal OWNER TO sisap;

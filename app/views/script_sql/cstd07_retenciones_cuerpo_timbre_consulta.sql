...
DROP VIEW cstd07_retenciones_cuerpo_timbre_consutal;


CREATE OR REPLACE VIEW cstd07_retenciones_cuerpo_timbre_consutal AS
...
FROM
       ...
       cstd07_retenciones_cuerpo_timbre a;


ALTER TABLE cstd07_retenciones_cuerpo_timbre_consutal OWNER TO sisap;

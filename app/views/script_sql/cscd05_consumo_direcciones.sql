-- View: cscd05_consumo_direcciones

-- DROP VIEW cscd05_consumo_direcciones;

CREATE OR REPLACE VIEW cscd05_consumo_direcciones AS
...
GROUP BY ne.cod_presi, ne.cod_entidad, ne.cod_tipo_inst, ne.cod_inst, ne.cod_dep, ne.ano_nota_entrega, ne.codigo_prod_serv, c.denominacion, c.cod_snc, u.expresion
ORDER BY ne.cod_presi, ne.cod_entidad, ne.cod_tipo_inst, ne.cod_inst, ne.cod_dep, ne.ano_nota_entrega, ne.codigo_prod_serv;

ALTER TABLE cscd05_consumo_direcciones OWNER TO sisap;

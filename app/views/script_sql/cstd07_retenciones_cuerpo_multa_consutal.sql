...
DROP VIEW cstd07_retenciones_cuerpo_responsabilidad_consutal;


CREATE OR REPLACE VIEW cstd07_retenciones_cuerpo_responsabilidad_consutal AS
...
FROM
       ...
       cstd07_retenciones_cuerpo_responsabilidad a;


ALTER TABLE cstd07_retenciones_cuerpo_responsabilidad_consutal OWNER TO sisap;

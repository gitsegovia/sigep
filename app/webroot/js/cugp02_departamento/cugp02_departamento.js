...
//			return false;
			...
			fun_msj('Ingrese la Denominacion');
		...
		return false;
			...
			fun_msj2('Fue Almacenado el Registro del Departamento');
...
function mensajes_cugp02_departamento_eliminar(){


	fun_msj('Fue Eliminado el Registro del Departamento');

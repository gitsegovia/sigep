...
function cstp07_cancelaciones_timbre_calcula_total(){
...
function cstp07_cancelaciones_timbre_valida(){
...
//------- Estas funciones son para los programas de congelar y descongelar Retenciones (Ya no estan siendo utilizadas)---------//
function congelar_retencion(ano_orden, num_orden, monto, tipo_impuesto, i){
    //document.getElementById('actual_'+i).innerHTML="<center><font color='000'>"+mascara_num_orden+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></center>";
	//document.getElementById('poremitir_'+i).innerHTML="&nbsp;";
	//document.getElementById('congelado_'+i).innerHTML="<font color='000'><b>X</b>";
	ver_documento('/cstp07_retenciones_acumuladas_pendientes/congelar/'+ano_orden+'/'+num_orden+'/'+monto+'/'+tipo_impuesto+'/'+i, i);
}

function descongelar_retencion(ano_orden, num_orden, mascara_num_orden, tipo_impuesto, i){
    //document.getElementById('actual_'+i).innerHTML="<center><font color='000'>"+mascara_num_orden+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></center>";
	//document.getElementById('poremitir_'+i).innerHTML="<font color='000'><b>X</b>";
	//document.getElementById('congelado_'+i).innerHTML="&nbsp;";
	ver_documento('/cstp07_retenciones_acumuladas_pendientes/descongelar/'+ano_orden+'/'+num_orden+'/'+monto+'/'+tipo_impuesto+'/'+i, i);
}

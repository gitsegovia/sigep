...
function cobp01_contratoobras_valuacion_uso_general_valida(){
...
function cobp01_contratoobras_valuacion_uso_general_pregunta_pago_parcial(opc){
...
//////////////////////////////////////////////////////////////
		...
		// moneda('monto_iva_var');
         ...
         cobp01_contratoobras_valuacion_uso_general_detalles_del_pago();
...
function cobp01_contratoobras_valuacion_uso_general_monto_id_editar_2(id_i,op_i){
...
function cobp01_contratoobras_valuacion_uso_general_colocar_iva(id_i,op_i){
...
function cobp01_contratoobras_valuacion_uso_general_detalles_del_pago(){
...
function cobp01_contratoobras_valuacion_uso_general_respuesta_pago_parcial(opcion){
...
cobp01_contratoobras_valuacion_uso_general_detalles_del_pago();for(ii=0; ii<document.getElementById('cuenta_i').value; ii++){moneda("pago_"+ii);}
...
function cobp01_contratoobras_valuacion_uso_general_valida_consulta(){
...
function cobp01_contratoobras_valuacion_uso_general_detalles_del_pago_personalizado(){
...
function cobp01_contratoobras_valuacion_uso_general_detalles_del_pago_personalizado_monto_descontar_impuesto(){

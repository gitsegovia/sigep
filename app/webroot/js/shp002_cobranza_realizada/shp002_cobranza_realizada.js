function shp002_cobranza_realizada_guardar(){
                   ...
                   if($("rif").value==""){
			          ...
			          return false;
			  }else if($("cobranza_acumulada").value==""){
			          fun_msj('Por favor inserte el monto acumulado');
                      document.getElementById('cobranza_acumulada').focus();
			          return false;
			  }else if($("enero").value==""){
					  ...
					  $("ano").readOnly=true;
					  $("cobranza_acumulada").readOnly=true;
				      $("enero").readOnly=true;
...
function shp002_cobranza_realizada_editar(){
      $("cobranza_acumulada").readOnly=false;
...
function shp002_cobranza_realizada_cancelar(){
      $("cobranza_acumulada").readOnly=true;
      $("enero").readOnly=true;
      $("febrero").readOnly=true;
      $("marzo").readOnly=true;

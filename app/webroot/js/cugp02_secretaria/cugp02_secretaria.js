...
//
	...
	//		return false;
		...
		return false;
			...
			fun_msj2('Fue Almacenado el Registro de Secretaria');
...
function mensajes_cugp02_secretaria_eliminar(){


	fun_msj('Fue Eliminado el Registro de Secretaria');

function valida_ccfp01_subdivision(){
	...
	*/
	...
	if(document.getElementById('select_4').value==''){

	        fun_msj('Debe seleccionar la Divisi&oacute;n Estadistica Contable');
	...
	*/
	...
	if(document.getElementById('cod_subdivision_contable').value==''){

	        fun_msj('El c&oacute;digo de la Divisi&oacute;n SubDivisi&oacute;n Estadistica Contable no puede estar vacio');
			document.getElementById('cod_subdivision_contable').focus();
			return false;

	}if(document.getElementById('deno_subdivision_contable').value==''){

	        fun_msj('La denominaci&oacute;n de la Divisi&oacute;n SubDivisi&oacute;n Estadistica Contable no puede estar vacia');
			document.getElementById('deno_subdivision_contable').focus();
			return false;

	}

	/*if(document.getElementById('concepto_subdivision_contable').value==''){

	        fun_msj('El Concepto de la Divisi&oacute;n Estadistica SubDivisi&oacute;n Contable no puede estar vacio');
			document.getElementById('concepto_subdivision_contable').focus();
			return false;
...
function valida_ccfp01_subdivision_modificar(){
	...
	if(document.getElementById('cod_subdivision_contable').value==''){
	        ...
	        fun_msj('El Concepto de la Divisi&oacute;n SubDivisi&oacute;n Estadistica Contable no puede estar vacio');
			document.getElementById('concepto_subdivision_contable').focus();
			return false;

	}
}//valida_ccfp01_subdivision_modificar
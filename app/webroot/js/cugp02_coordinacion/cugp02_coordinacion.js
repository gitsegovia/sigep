...
//
	...
	///		document.getElementById('valida').focus();
		...
		return false;
			...
			fun_msj2('Fue almacenado el Registro de Coordinaci&oacute;n');
...
function mensajes_cugp02_coordinacion_eliminar(){


	fun_msj('Fue Eliminado el Registro de Coordinaci&oacute;n');

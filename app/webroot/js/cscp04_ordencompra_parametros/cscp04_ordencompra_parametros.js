function valida_cscp04_ordencompra_parametros(){
...
function valida_cscp04_ordencompra_parametros_s(){
...
function moneda_(id){
 ...
 function porc(id){
    var monto = document.getElementById(id).value;
    if(monto!=""){
       pag="../../include/cscp04_ordencompra_formato/formato.php?monto="+monto;
       cargarMonto(id,pag);
    }else{
      document.getElementById(id).value=0;
    }
 ...
 function porc_ret(id){
    var monto = document.getElementById(id).value;
    if(monto!=""){
       pag="../../include/cscp04_ordencompra_formato/porcentaje_retencion.php?monto="+monto;
       cargarMonto(id,pag);
    }else{
      document.getElementById(id).value=0;
    }
 ...
 function factor(id,id2){
    var monto = document.getElementById(id).value;
    if(monto!=""){
       pag="../../include/cscp04_ordencompra_formato/formato.php?monto="+monto;
	   pag2="../../include/cscp04_ordencompra_formato/factor.php?monto="+monto;
	   cargarMonto(id,pag);
       cargarMonto(id2,pag2);
    }else{
      document.getElementById(id).value=0;
   1 }
}

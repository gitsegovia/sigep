function caop04_registro_anticipo_ordencompra_valida(){
...
if(document.getElementById('ano_orden_compra_anticipo').value==''){
    ...
    }else if(verifica_cierre_ano_ejecucion('fecha_anticipo')==false){
...
function caop04_registro_anticipo_ordencompra_cargar_monto_id_editar(id_a){
...
function caop04_registro_anticipo_ordencompra_cargar_monto_id_editar_2(id_a){
monto_anticipo_iva = 0;
fr = document.getElementById("iva").value;
str = fr;for(i=0; i<str.length; i++){str = str.replace('.','');}str = str.replace(',','.');  fr = str;
if(document.getElementById('incluye_iva_1').checked!=false || document.getElementById('incluye_iva_2').checked!=false){
...
function caop04_registro_anticipo_ordencompra_valida_consulta(){

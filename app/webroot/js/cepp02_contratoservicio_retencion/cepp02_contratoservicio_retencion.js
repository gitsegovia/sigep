function cepp02_contratoservicio_retencion_valida(){
...
function cepp02_contratoservicio_retencion_detalles_del_pago(){
...
if ((eval(total_retencion2) < eval(document.getElementById('desde_monto_islr').value)) || eval(document.getElementById('exento_islr_cooperativa').value=="1")){
...
if (eval(total_retencion2) < eval(document.getElementById('desde_monto_timbre').value)){
...
if (eval(total_retencion2) < eval(document.getElementById('desde_monto_impuesto_municipal').value)){
...
retencion_multa_monto = (eval(total_retencion) * eval(rcivil/100));
retencion_responsabilidad_social = (eval(total_retencion) * eval(rsocial/100));

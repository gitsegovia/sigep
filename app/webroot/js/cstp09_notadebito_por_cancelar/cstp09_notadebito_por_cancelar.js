...
function cstp09_notadebito_por_cancelar_editar_2(){
...
function cstp09_notadebito_montar_valor(valor){
...
function cstp09_notadebito_agregar_orden_session(){
       ...
       if(document.getElementById('select_num_orden').value == ""){
            ...
            fun_msj('la Fecha del de la Orden de Pago es mayor a la de n/debito.');
            return false;
...
function cstp09_notadebito_por_cancelar_valida_consulta(){
...
function validar_concepto_anulacion_cheque(){
	...
	if(verifica_cierre_ano_ejecucion_msj()==false){
		return false;
			...
			return false;
    }else if(!confirm("Esta Seguro que desea anular esta registro")){
         return false;
    }else{
...
function cstp09_notadebito_por_cancelar_valida(){
						  ...
						  if(diferenciaFecha(document.getElementById('fecha').value, document.getElementById('cuenta_fecha_orden_pago_'+iiii).value)){
				            ...
				            opcion_op_fecha   = 2;
                             ...
                             if(opcion_op_fecha==2){
	                             ...
	                             fun_msj('Fecha de la nota de debito es menor a la fecha de la orden de pago '+numero_documento);
	                             return false;
...
function cstp09_notadebito_nomina_valida(){
   ...
   }else if(document.getElementById('select_beneficiario').value==""){

            fun_msj('Inserte el Autorizado a Cobrar');
			document.getElementById('select_beneficiario').focus();
			return false;

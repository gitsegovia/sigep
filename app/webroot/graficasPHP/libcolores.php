<?
	...
	$colores[35] = ImageColorAllocate($image,62, 197, 254);      // Naranja dos62, 197, 254
	$colores[36] = ImageColorAllocate($image,133, 210, 204);      // Naranja dos obscuro
	$colores[37] = ImageColorAllocate($image,210, 120, 126);  // Naranja dos claro

    $colores[38] = ImageColorAllocate($image,210, 187, 201);      // Naranja dos62, 197, 254
	$colores[39] = ImageColorAllocate($image,210, 107, 51);      // Naranja dos obscuro
	$colores[40] = ImageColorAllocate($image,210, 10, 54);  // Naranja dos claro

...
$datos=$this->shd001_registro_contribuyentes->findAll("rif_cedula='".$var1."'");
	...
	$sacar=$this->v_shd700_credito_vivienda->findAll($this->SQLCA()." and rif_cedula='".$var1."'");
...
echo'<script>';
		  ...
		  echo "document.getElementById('cobrador_actual').value='".$sacar[0]['v_shd700_credito_vivienda']['rif_ci_cobrador']."';   ";
		  echo "document.getElementById('deno_cobrador_actual').value='".$sacar[0]['v_shd700_credito_vivienda']['deno_cobrador']."';	 ";
   echo'</script>';
					/*echo "<script>";
...
function guardar(){
	$this->layout="ajax";
	$rif_contribuyente	 = $this->data['shp002_cobradores_reasig7']['rif_constribuyente'];
	$cobrador_actual	 = $this->data['shp002_cobradores_reasig7']['cobrador_actual'];
	$cobrador_cambio	 = $this->data['shp002_cobradores_reasig7']['cobrador_cambio'];

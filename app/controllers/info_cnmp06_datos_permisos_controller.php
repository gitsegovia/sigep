<?php
 ...
 class Infocnmp06DatosPermisosController extends AppController {
 	var $name = 'info_cnmp06_datos_permisos';
 	var $uses = array ('cnmd06_datos_permisos', 'cnmd06_datos_personales', 'cnmd06_permisos', 'cnmd06_fichas','v_cnmd06_fichas_datos_personales');
...
function index2($var=null){
  ...
  $accion = "";
	 ...
	 if($var!=null){
	 	  $var_datos_ficha = $this->cnmd06_fichas->findAll("cedula_identidad=".$var);
		  $accion =  $this->cnmd06_datos_permisos->findAll("cedula=".$var, null, null);
	 }//fin if
...
if(!empty($this->data['cnmp06_datos_permisos']['cod_permiso'.$var_n]) &&
   ...
   $cedula            =  $var1;
					if($var_n==null){
										...
										$sql.="VALUES ('".$cod_presi."','".$cod_entidad."','".$cod_tipo_inst."','".$cod_inst."','".$cod_dep."','".$cod_tipo_nomina."','".$cod_cargo."','".$cod_ficha."','".$cedula."','".$cod_permiso."', '".$fecha_salida."', '".$fecha_reintegro."', '".$observaciones."'); ";
										$sw2 = $this->cnmd06_datos_permisos->execute($sql);
										   ...
										   if($var1!=null){
												  $accion =  $this->cnmd06_datos_permisos->findAll("cod_presi = '".$cod_presi."' and cod_entidad = '".$cod_entidad."'and cod_tipo_inst = '".$cod_tipo_inst."' and cod_inst = '".$cod_inst."' and cod_dep = '".$cod_dep."' and cod_tipo_nomina = '".$cod_tipo_nomina."' and cod_cargo = '".$cod_cargo."' and cod_ficha = '".$cod_ficha."' and cedula=".$var1, null, null);
											 }//fin if
										  $this->set('accion', $accion);
										...
										$sw2 = $this->cnmd06_datos_permisos->execute($sql);
                                         ...
                                         $var_datos = $this->cnmd06_datos_permisos->findAll("cod_presi = '".$cod_presi."' and cod_entidad = '".$cod_entidad."'and cod_tipo_inst = '".$cod_tipo_inst."' and cod_inst = '".$cod_inst."' and cod_dep = '".$cod_dep."' and cod_tipo_nomina = '".$cod_tipo_nomina."' and cod_cargo = '".$cod_cargo."' and cod_ficha = '".$cod_ficha."' and cedula=".$var1." and consecutivo=".$var_n);

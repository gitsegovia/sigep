<?php
 class Infocnmp06DatosBienesController extends AppController {
 	var $name = 'info_cnmp06_datos_bienes';
...
if($this->Session->read('cedula_pestana_expediente')==""){
	...
	$accion =  $this->cnmd06_datos_bienes->findAll('cedula_identidad='.$id, null,  'cod_bien ASC');

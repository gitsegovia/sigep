...
$datos=$this->shd001_registro_contribuyentes->findAll("rif_cedula='".$var1."'");
	...
	$sacar2=$this->v_shd600_aprobacion_arrendamiento->findAll($this->SQLCA()." and rif_cedula='".$var1."'");
	$sacar=$this->shd600_solicitud_arrendamiento->findAll($this->SQLCA()." and rif_cedula='".$var1."'");
	$num2 = $sacar[0]['shd600_solicitud_arrendamiento']['numero_solicitud'];
...
echo'<script>';
  ...
  echo "document.getElementById('cobrador_actual').value='".$sacar2[0]['v_shd600_aprobacion_arrendamiento']['rif_ci_cobrador']."';   ";
  echo "document.getElementById('deno_cobrador_actual').value='".$sacar2[0]['v_shd600_aprobacion_arrendamiento']['deno_cobrador']."';	 ";
  echo "document.getElementById('numero_solicitud').value='".$num2."';   ";
echo'</script>';
					/*echo "<script>";
...
function guardar(){
	$this->layout="ajax";
	$rif_contribuyente	 = $this->data['shp002_cobradores_reasig6']['rif_constribuyente'];
	$cobrador_actual	 = $this->data['shp002_cobradores_reasig6']['cobrador_actual'];
	$cobrador_cambio	 = $this->data['shp002_cobradores_reasig6']['cobrador_cambio'];
	$numero_solicitud	 = $this->data['shp002_cobradores_reasig6']['numero_solicitud'];
	...
	//$update5 =	"update shd500_aseo_domiciliario set rif_ci_cobrador='".$cobrador_cambio."' where rif_cedula='".$rif_contribuyente."' and rif_ci_cobrador='".$cobrador_actual."' and ".$this->SQLCA();
	  $update6 =	"update shd600_aprobacion_arrendamiento set rif_ci_cobrador='".$cobrador_cambio."' where numero_solicitud='".$numero_solicitud."' and rif_ci_cobrador='".$cobrador_actual."' and ".$this->SQLCA();

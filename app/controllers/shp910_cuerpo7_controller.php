<?php
 class Shp910Cuerpo7Controller extends AppController{
...
function agregar_grilla(){
	...
	$rif_cedula    		       	= $this->data['shp910_cuerpo7']['rif_constribuyente'];
	$ano 						= $this->data['shp910_cuerpo7']['ano_deuda'];
	$deuda_anterior				= $this->Formato1($this->data['shp910_cuerpo7']['deuda_anterior']);
	if($deuda_anterior==null){
		$deuda_anterior=0;
	}
	$cod_numero_catastral_placas='0';
	$datos = $this->shd003_codigo_ingresos->findAll('cod_ingreso=7');
	...
	if($cont==0){
		...
		$sw = $this->shd910_cuerpo->execute($upd);
	 	   	...
	 	   	$mes    			= $this->data['shp910_cuerpo7']['mes'];
   			$numero_recibo     	= $this->data['shp910_cuerpo7']['numero_recibo'];
   			$deuda_vigente	    = $this->Formato1($this->data['shp910_cuerpo7']['deuda_vigente']);
   			if($this->data['shp910_cuerpo7']['recargo']!=null){
   				$recargo			= $this->Formato1($this->data['shp910_cuerpo7']['recargo']);
   			}else{
				$recargo=0;
   			}

   			if($this->data['shp910_cuerpo7']['multa']!=null){
   				$multa			= $this->Formato1($this->data['shp910_cuerpo7']['multa']);
   			}else{
				$multa=0;
   			}

   			if($this->data['shp910_cuerpo7']['intereses']!=null){
   				$intereses			= $this->Formato1($this->data['shp910_cuerpo7']['intereses']);
   			}else{
				$intereses=0;
   			}
			if($this->data['shp910_cuerpo7']['descuentos']!=null){
   				$descuentos			= $this->Formato1($this->data['shp910_cuerpo7']['descuentos']);
   			}else{
				$descuentos=0;
   			}
   			$total 				= $this->Formato1($this->data['shp910_cuerpo7']['total']);
   			$cancelado 			= $this->data['shp910_cuerpo7']['cancelado'];

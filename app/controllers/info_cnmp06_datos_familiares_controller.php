<?php
 class InfoCnmp06DatosFamiliaresController extends AppController {
   var $name = 'info_cnmp06_datos_familiares';
   var $uses = array('v_cnmd06_datos_familiares','cnmd06_parentesco','cnmd06_datos_familiares','cnmd06_instituto_educativo',
...
function guardar(){
	...
	$SQL_INSERT ="INSERT INTO cnmd06_datos_familiares (cedula,cod_parentesco,consecutivo,nombres_apellidos,numero_cedula,fecha_nacimiento,sexo,afiliado,cod_guarderia,costo_guarderia)";
	 $SQL_INSERT .=" VALUES ($cedula, $cod_parentesco,$consecutivo,'".$nombres_apellidos."',$numero_cedula,'".$fecha_nacimiento."','".$sexo."', '".$afiliado."', '".$cod_guarderia."','".$costo_guarderia."')";
...
function modificar($cedula=null,$consecutivo=null,$cod_parentesco=null,$pagina=null){
	  $this->layout = "ajax";
	  $this->set('pagina',$pagina);
...
function guardar_modificar($cedula=null,$consecutivo=null,$cod_parentescos=null,$pagina=null){
	$this->layout = "ajax";
	if(!empty($this->data)){
	 $cod_parentesco=$this->data['cnmp06_datos_familiares']['cod_parentesco'];
	 $nombres_apellidos=$this->data['cnmp06_datos_familiares']['nombres_apellidos'];
	 ...
	 $sql="update cnmd06_datos_familiares set cod_parentesco=$cod_parentesco,nombres_apellidos='".$nombres_apellidos."',numero_cedula=$numero_cedula,fecha_nacimiento='".$fecha_nacimiento."',sexo='".$sexo."',afiliado=$afiliado,cod_guarderia=$cod_guarderia,costo_guarderia=$costo_guarderia  where ". $cond;

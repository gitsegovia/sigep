 ...
 *
 */
 class Cnmp06DatosPersonalesConsultaPrestacionesController extends AppController {
   var $name = 'cnmp06_datos_personales_consulta_prestaciones';
...
function busca_cedula($var1=null){

$this->layout="ajax";
$this->Session->write('cedula_pestana_prestaciones', $var1);
...
if(!isset($_SESSION["pag_num_prestaciones"])){
    $pag_num = 0;
    $this->Session->write('pag_num_prestaciones',  $pag_num);
}else{

    if($pag_num==null){
         $pag_num = $this->Session->read('pag_num_prestaciones');
    }else{
    	 $this->Session->write('pag_num_prestaciones',  $pag_num);
    }
}//fin else

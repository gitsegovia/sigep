...
class Cobp01ContratoobrasValuacionController extends AppController {

   var $name = "cobp01_contratoobras_valuacion";
   var $uses = array('cscd04_ordencompra_parametros', 'cobd01_contratoobras_cuerpo', 'ccfd04_cierre_mes', 'cobd01_contratoobras_valuacion_cuerpo',
                     'cugd03_acta_anulacion_numero', 'cugd03_acta_anulacion_cuerpo', 'cobd01_contratoobras_partidas',
                      'cobd01_contratoobras_valuacion_partidas', 'cfpd07_obras_cuerpo', "cugd10_imagenes", 'cepd03_ordenpago_cuerpo',
...
$this->set('ano',$ano);
					  ...
					  //$condicion = 'cod_presi='.$this->Session->read('SScodpresi').'  and  cod_entidad='.$this->Session->read('SScodentidad').' and cod_tipo_inst='.$this->Session->read('SScodtipoinst').' and  cod_inst='.$this->Session->read('SScodinst').' and cod_dep='.$SScoddep.' and ano_contrato_obra='.$ano.' and condicion_actividad=1';
 	...
 	$this->set('ano',$ano);
				...
				if($var1==null){
					...
					foreach($numero_datos_aux as $aux){
    					...
    					$numero_fielcumplimiento      =  $aux['cobd01_contratoobras_cuerpo']['numero_fianza_fielcumplimiento'];
                        $numero_fianzacalidad         =  $aux['cobd01_contratoobras_cuerpo']['numero_fianza_calidad'];
					}//fin foreach
					...
					if($objeto_rif != "" && $denominacion_rif!=""){
						...
						$datos_orden_pagos_anteriores_partidas = $this->cobd01_contratoobras_valuacion_partidas->findAll($condicion."  and ano_contrato_obra=".$ano_contrato_obra, null, 'numero_contrato_obra DESC');
				   ...
				   foreach($parametros_datos as $aux_22){
    				...
    				if ($numero_fielcumplimiento!=null){
    					$porcentaje_fiel_cump=0;
    					}

    				if ($numero_fianzacalidad!=null){
    					$porcentaje_laboral=0;
    					}
					...
					$var_img =  $numero_contrato_obra."".$opc;


					$vec=$this->cugd10_imagenes->findCount($condicion." and cod_campo=14 and identificacion='".$var_img."1'");
		    		...
		    		if($vec!=0){
		    			...
		    			$vec=$this->cugd10_imagenes->findCount($condicion." and cod_campo=14 and identificacion='".$var_img."2'");
		    		if($vec!=0){
		    			...
		    			$vec=$this->cugd10_imagenes->findCount($condicion." and cod_campo=14 and identificacion='".$var_img."3'");
		    		if($vec!=0){
		    			...
		    			$vec=$this->cugd10_imagenes->findCount($condicion." and cod_campo=14 and identificacion='".$var_img."4'");
		    		...
		    		if($vec!=0){
						...
						$this->set('aqui_imagen',  $var_img.'1');
						$this->set('aqui_imagen2', $var_img.'2');
						$this->set('aqui_imagen3', $var_img.'3');
						$this->set('aqui_imagen4', $var_img.'4');
...
function modificar($var1=null, $var2=null){
  	$this->layout = "ajax";
  	...
  	$var =  $var1."".$var2;
            ...
            $vec=$this->cugd10_imagenes->findCount($condicion." and cod_campo=14 and identificacion='".$var."1'");
            if($vec!=0){
		    	$this->set('aqui_imagen_existe1',true);
		    }else{
		    	$this->set('aqui_imagen_existe1',false);
		    ...
		    $vec=$this->cugd10_imagenes->findCount($condicion." and cod_campo=14 and identificacion='".$var."2'");
		    if($vec!=0){
		    	$this->set('aqui_imagen_existe2',true);
		    }else{
		    	$this->set('aqui_imagen_existe2',false);
		    ...
		    $vec=$this->cugd10_imagenes->findCount($condicion." and cod_campo=14 and identificacion='".$var."3'");
		    if($vec!=0){
		    	$this->set('aqui_imagen_existe3',true);
		    }else{
		    	$this->set('aqui_imagen_existe3',false);
		    ...
		    $vec=$this->cugd10_imagenes->findCount($condicion." and cod_campo=14 and identificacion='".$var."4'");
		    if($vec!=0){
		    	$this->set('aqui_imagen_existe4',true);
		    }else{
		    	$this->set('aqui_imagen_existe4',false);
...
function guardar_modificar($var1=null, $var2=null){
    $this->set('Message_existe', "datos guardados");
...
function regresar_modificar($var1=null, $var2=null){
  	$this->layout = "ajax";
  	$cod_presi                =       $this->Session->read('SScodpresi');
  	$cod_entidad              =       $this->Session->read('SScodentidad');
  	$cod_tipo_inst            =       $this->Session->read('SScodtipoinst');
...
function respuesta_pago_parcial($opcion=null){
 	$this->layout = "ajax";
		...
		echo"<script>";
		echo" cobp01_contratoobras_valuacion_pregunta_pago_parcial('".$opcion."');";
		echo"</script>";
}//function
...
function  opcion_pago($ano=null, $numero_contrato_obra=null, $opc){
	...
	$ano_orden_compra = $this->ano_ejecucion();
		...
		if($opc == "2"){
			echo"<script>";
  				echo"cobp01_contratoobras_valuacion_pregunta_pago_parcial('".$opc."');";
  			echo"</script>";
		}else{
			echo'<script>';
...
function guardar(){
 	...
 	$i_lenght = $this->data['cobp01_contratoobras_valuacion']['cuenta_i'];

  	$ano_contrato_obra             = $this->data['cobp01_contratoobras_valuacion']['ano_contrato_obra'];
  	$num_contrato_obra             = $this->data['cobp01_contratoobras_valuacion']['num_contrato_obra'];
  	$numero_contrato_obra          = $num_contrato_obra;
  	$ano_orden_compra_autorizacion = $ano_contrato_obra;

  	$ann = $ano_contrato_obra;
  	$numero_valuacion           = $this->data['cobp01_contratoobras_valuacion']['numero_valuacion'];
  	$nda                        = $numero_valuacion;
  	$fecha_valuacion            = $this->data['cobp01_contratoobras_valuacion']['fecha_valuacion'];
  	$fd                         = $fecha_valuacion;

 	////monto de la mano de obra/////
  	$monto_mano_obra                      = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_mano_obra']);
 	////fin monto de la mano de obra/////
	////monto de la valuación/////
  	$monto_opcion_pago                    = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_opcion_pago']);
    $monto_excento                        = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_excento']);
 	////fin monto de la valuación/////

  	$monto_original_contrato              = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_contrato']);
  	$monto_retenido_laboral               = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['retencion_laboral']);
 	  $monto_retenido_fielcumplimiento      = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['fiel_cumplimiento']);

  	$porcentaje_amortizacion              = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['amortizacion_del_anticipo']);
  	$total_retencion_monto_iva            = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['total_retencion_monto_iva']);
  	$monto_descontar_impuesto             = $total_retencion_monto_iva;
  	$monto_orden_de_pago_monto_iva        = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_orden_de_pago_monto_iva']);
  	$monto_a_pagar_monto_iva              = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_a_pagar_monto_iva']);
  	$concepto_contrato_obra               = $this->data['cobp01_contratoobras_valuacion']['concepto'];

  	$monto_orden                          = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_orden_de_pago_monto_iva']);
  	$monto_cancelado2                     = $monto_orden;
  	$monto_neto_cobrar                    = $monto_a_pagar_monto_iva;

  	$aumento                              = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['aumento']);
  	$disminucion                          = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['disminucion']);

  	$monto_anticipo                       = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_anticipo']);
  	$monto_amortizacion                   = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_amortizacion']);
  	$monto_cancelado                      = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_cancelado']);

  	$monto_iva                            = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_iva']);
  	$monto_cancelar                       = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_a_pagar_con_iva']);
  	$monto_cancelar_siniva                = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_sin_iva']);
  	$amortizacion_anticipo                = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['amortizacion_del_anticipo_monto_iva']);
  	$monto_islr                           = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['impuesto_sobre_la_renta_monto_iva']);


  if(isset($this->data['cobp01_contratoobras_valuacion']['impuesto_sobre_la_renta'])){
    $porcentaje_islr                      =       $this->Formato1($this->data['cobp01_contratoobras_valuacion']['impuesto_sobre_la_renta']);
  }else{
  	$porcentaje_islr = 0;
  }

  	$anticipo_con_iva                     = $this->data['cobp01_contratoobras_valuacion']['anticipo_con_iva'];
  	$anticipo_con_iva2                    = $this->data['cobp01_contratoobras_valuacion']['anticipo_con_iva2'];
  	$anticipo_con_iva2                    = 1;

  	$monto_sustraendo                     = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['sustraendo']);
  	$monto_timbre_fiscal                  = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['timbre_fiscal_monto_iva']);

  	$porcentaje_timbre_fiscal             = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['timbre_fiscal']);
  	$monto_impuesto_municipal             = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['impuesto_municipal_monto_iva']);

  	$porcentaje_impuesto_municipal        = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['impuesto_municipal']);
  	$monto_retencion_iva                  = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['retencion_incluye_iva_monto_iva']);
  	$porcentaje_retencion_iva             = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['retencion_incluye_iva']);

  	$monto_retencion_fielcumplimiento     = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_fiel_cumplimiento']);
  	$porcentaje_fiel_cumplimiento         = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['porcentaje_fiel_cumplimiento']);
  	$porcentaje_fielcumplimiento          = $porcentaje_fiel_cumplimiento;

  	$monto_retencion_laboral              = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['monto_laboral']);
 	$porcentaje_laboral                   = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['porce_retencion_laboral']);
  if($monto_retencion_laboral==0){$porcentaje_laboral = 0;}

  	$saldo_orden                          = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['saldo_contrato']);
  	$retencion_multa_monto                = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['retencion_multa_monto']);
  	$retencion_responsabilidad_social     = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['retencion_responsabilidad_social']);
  	$prc                                  = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['rcivil']);
  	$prs                                  = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['rsocial']);

  	$aumento_obra_extra                   = 0;
  	$aumento_reconsideracion_precio  	  = 0;
  	$aumento_obras                        = 0;

  	$porcentaje_iva_aplicado              = $this->Formato1($this->data['cobp01_contratoobras_valuacion']['porcentaje_iva']);
  if($monto_iva==0){$porcentaje_iva_aplicado = 0;}

  	$oficio_aprobacion                    = $this->data['cobp01_contratoobras_valuacion']['numero_aprobacion'];
  	$fecha_aprobacion                     = $this->data['cobp01_contratoobras_valuacion']['fecha_aprobacion'];
  	$periodo_desde                        = $this->data['cobp01_contratoobras_valuacion']['desde_periodo'];
  	$periodo_hasta                        = $this->data['cobp01_contratoobras_valuacion']['hasta_periodo'];
...
for($i=0; $i<$i_lenght; $i++){
   if($partidas_aux==$this->data['partidas']['partidas_'.$i]){$partidas_vista['pago_'.$i_aux] = $this->data['cobp01_contratoobras_valuacion']['pago_'.$i]; $i_aux++;}
	}//fin foreach
	  ...
	  if($partidas_vista['pago_'.$i]!="0,00"){ $am_cont++;
         ...
         $datos_cscd04_ordencompra_partidas    =     $this->cobd01_contratoobras_partidas->findAll($sql_where[$i]);
                   foreach($datos_cscd04_ordencompra_partidas as $aux_datos_cscd04_ordencompra_partidas){
						...
						$retencion_laboral                =    $aux_datos_cscd04_ordencompra_partidas['cobd01_contratoobras_partidas']['retencion_laboral'];
						$retencion_fielcumplimiento       =    $aux_datos_cscd04_ordencompra_partidas['cobd01_contratoobras_partidas']['retencion_fielcumplimiento'];
						$monto                            =    $aux_datos_cscd04_ordencompra_partidas['cobd01_contratoobras_partidas']['monto'];
						$aumento                          =    $aux_datos_cscd04_ordencompra_partidas['cobd01_contratoobras_partidas']['aumento'];
						$disminucion                      =    $aux_datos_cscd04_ordencompra_partidas['cobd01_contratoobras_partidas']['disminucion'];
             ...
             $retencion_fielcumplimiento_compara = 0;
                   ...
                   $datos_cscd04_ordencompra_partidas    =     $this->cobd01_contratoobras_partidas->findAll($sql_where[$i]);
					foreach($datos_cscd04_ordencompra_partidas as $aux_datos_cscd04_ordencompra_partidas){
						...
						$retencion_laboral                =    $aux_datos_cscd04_ordencompra_partidas['cobd01_contratoobras_partidas']['retencion_laboral'];
						$retencion_fielcumplimiento       =    $aux_datos_cscd04_ordencompra_partidas['cobd01_contratoobras_partidas']['retencion_fielcumplimiento'];
						$numero_control_compromiso        =    $aux_datos_cscd04_ordencompra_partidas['cobd01_contratoobras_partidas']['numero_control_compromiso'];
...
function buscar_year($var1=null){
  ...
  $lista = "";
		...
		if($SScoddep==1 && $SScoddeporig==1 && $Modulo=="0"){
			...
			$c = $this->cobd01_contratoobras_valuacion_cuerpo->findAll($this->condicion().' and ano_contrato_obra='.$var1, 'numero_contrato_obra, ano_contrato_obra', "numero_contrato_obra ASC");
			$sql_c = ""; //print_r($c);
			foreach($c as $c_aux){
						if($sql_c == ""){
...
if(!empty($this->data['cobp01_contratoobras_valuacion']['ano_ejecucion'])){	$_SESSION['ano_contrato_obra'] = $this->data['cobp01_contratoobras_valuacion']['ano_ejecucion'];}else{$_SESSION['ano_contrato_obra'] = $this->ano_ejecucion();}
...
if(!empty($this->data['cobp01_contratoobras_valuacion']['numero_contrato_obra'])){

	 $array = $this->cobd01_contratoobras_valuacion_cuerpo->findAll($condicion. "  and numero_contrato_obra='".$this->data['cobp01_contratoobras_valuacion']['numero_contrato_obra']."' and ano_contrato_obra = ".$ano, null, 'ano_contrato_obra, numero_contrato_obra, numero_valuacion ASC', null);
  $i = 0;
  ...
  for($a=0; $a<=$i; $a++){
    ...
    if($this->data['cobp01_contratoobras_valuacion']['numero_contrato_obra'] == $numero[$a]['numero_contrato_obra']){
    	  $pag_num = 0;
    	  $opcion='si';
...
$a = $this->cobd01_contratoobras_cuerpo->findAll($condicion." and ano_contrato_obra=".$year, null, "numero_contrato_obra asc");
...
function consulta($pag_num=null, $numero_documento=null, $g=null){
  ...
  $Modulo                   =       $this->Session->read('Modulo');
  $lista = "";
  if(!empty($this->data['cobp01_contratoobras_valuacion']['ano_ejecucion'])){
	$ano = $this->data['cobp01_contratoobras_valuacion']['ano_ejecucion'];
  }else{
  	$ano = $this->ano_ejecucion();
  }
...
$condicion2 = 'cod_presi='.$this->Session->read('SScodpresi').'  and  cod_entidad='.$this->Session->read('SScodentidad').' and cod_tipo_inst='.$this->Session->read('SScodtipoinst').' and  cod_inst='.$this->Session->read('SScodinst').' and cod_dep='.$this->Session->read('SScoddep').'';
  ...
  $var_img =  $numero[$pag_num]['numero_contrato_obra']."".$numero[$pag_num]['numero_valuacion'];

            $vec=$this->cugd10_imagenes->findCount($condicion2." and cod_campo=14 and identificacion='".$var_img."1'");
		    if($vec!=0){
		    	$this->set('aqui_imagen_existe1',true);
		    }else{
		    	$this->set('aqui_imagen_existe1',false);
		    ...
		    $vec=$this->cugd10_imagenes->findCount($condicion2." and cod_campo=14 and identificacion='".$var_img."2'");
		    if($vec!=0){
		    	$this->set('aqui_imagen_existe2',true);
		    }else{
		    	$this->set('aqui_imagen_existe2',false);
		    ...
		    $vec=$this->cugd10_imagenes->findCount($condicion2." and cod_campo=14 and identificacion='".$var_img."3'");
		    if($vec!=0){
		    	$this->set('aqui_imagen_existe3',true);
		    }else{
		    	$this->set('aqui_imagen_existe3',false);
		    ...
		    $vec=$this->cugd10_imagenes->findCount($condicion2." and cod_campo=14 and identificacion='".$var_img."4'");
		    if($vec!=0){
		    	$this->set('aqui_imagen_existe4',true);
		    }else{
		    	$this->set('aqui_imagen_existe4',false);
...
$this->set('datos_cobd01_contratoobras_cuerpo', $aux);
$this->set('denominacion_rif', $denominacion_rif);
$this->set('rif', $rif);
...
$this->layout="ajax";
	...
	if(isset($this->data["cobp01_contratoobras_valuacion"])){

		    $condicion = 'cod_presi='.$this->Session->read('SScodpresi').'  and  cod_entidad='.$this->Session->read('SScodentidad').' and cod_tipo_inst='.$this->Session->read('SScodtipoinst').' and  cod_inst='.$this->Session->read('SScodinst').' and cod_dep='.$this->Session->read('SScoddep').' ';
		    $tipo_documento           =  245;
       	    //$concepto_anulacion       =  $this->data["cobp01_contratoobras_valuacion"]["concepto_anulacion"];
			$concepto_anulacion = "";
			...
			$fecha_valuacion  = $this->data["cobp01_contratoobras_valuacion"]["fecha_valuacion"];
			$fd = $fecha_valuacion;
			$numero_valuacion = (int) $this->data["cobp01_contratoobras_valuacion"]["numero_valuacion"];
			$monto_cancelado = 0;
			...
			$sql_update_cscd04_partidas ='';
			   ...
			   $numero_valuacion2  =  $numero_valuacion;
               if($numero_valuacion2[0]=="0"){$numero_valuacion2[0]="";}
               $numero_valuacion2 = trim($numero_valuacion2);
               $var                =  $num_contrato_obra.''.$numero_valuacion2;


              $this->requestAction('/cugp10_imagenes/eliminar/'.$var.'1'.'/14');
              $this->requestAction('/cugp10_imagenes/eliminar/'.$var.'2'.'/14');
              $this->requestAction('/cugp10_imagenes/eliminar/'.$var.'3'.'/14');
              $this->requestAction('/cugp10_imagenes/eliminar/'.$var.'4'.'/14');
...
/////////////////////////ACTUALIZA LAS PARTIDAS/////////////////////
		foreach($datos_partidas as $row){
				...
				//$num_asiento_compromiso = $this->motor_presupuestario($cp, 2, 4, 5, date("d/m/Y"), $monto_partida, $concepto, $ano, $num_contrato_obra, $numero_valuacion, null, null, null, null, null, null, $numero_control_compromiso, $numero_control_causado, null, null, null);
...
/////////////////////////FIN ACTUALIZA EL ENCABEZADO////////////////
            ...
            /* $v=$this->cugd03_acta_anulacion_numero->execute("SELECT numero_acta_anulacion FROM cugd03_acta_anulacion_numero WHERE ".$this->SQLCA()." and ano_acta_anulacion=".$ano_contrato_obra." ORDER BY numero_acta_anulacion DESC");
			 ...
			 $R1 = $this->cobd01_contratoobras_valuacion_cuerpo->execute("  DELETE FROM cobd01_contratoobras_valuacion_cuerpo    WHERE ".$this->SQLCA()." and ano_contrato_obra=".$ano_contrato_obra." and numero_contrato_obra='".$num_contrato_obra."' and numero_valuacion='".$numero_valuacion."' ");
			 	...
			 	$orden_pago = $this->cobd01_contratoobras_valuacion_cuerpo->execute(" SELECT * FROM cepd03_ordenpago_cuerpo WHERE cod_tipo_documento=5 and condicion_actividad=2 and ".$this->SQLCA()." and numero_documento_origen='".$num_contrato_obra."' and numero_documento_adjunto='".$numero_valuacion."' and ano_documento_origen=".$ano_contrato_obra);
 				foreach($orden_pago as $orden){
 				$ano_orden    = $orden[0]['ano_orden_pago'];
 				$numero_orden = $orden[0]['numero_orden_pago'];
 				$this->cobd01_contratoobras_valuacion_cuerpo->execute(" DELETE FROM cepd03_ordenpago_cuerpo WHERE ".$this->SQLCA()." and ano_orden_pago=".$ano_orden." and numero_orden_pago=".$numero_orden);

						$orden_pago_cheque=$this->cobd01_contratoobras_valuacion_cuerpo->execute(" SELECT * FROM cstd03_cheque_ordenes WHERE ".$this->SQLCA()." and ano_orden_pago=".$ano_orden." and numero_orden_pago=".$numero_orden);
 						...
 						$this->cobd01_contratoobras_valuacion_cuerpo->execute(" DELETE FROM cstd03_cheque_cuerpo WHERE ".$this->SQLCA()." and ano_movimiento=".$ano_movimiento." and cod_entidad_bancaria=".$cod_entidad_bancaria." and cod_sucursal=".$cod_sucursal." and cuenta_bancaria='".$cuenta_bancaria."' and numero_cheque=".$numero_cheque);
 						$this->cobd01_contratoobras_valuacion_cuerpo->execute(" DELETE FROM cstd04_movimientos_generales WHERE ".$this->SQLCA()." and ano_movimiento=".$ano_movimiento." and cod_entidad_bancaria=".$cod_entidad_bancaria." and cod_sucursal=".$cod_sucursal." and cuenta_bancaria='".$cuenta_bancaria."' and numero_documento=4 and numero_documento=".$numero_cheque);
				 		}
				 }
...
function entrar(){
	$this->layout="ajax";
	if(isset($this->data['cobp01_contratoobras_valuacion']['login']) && isset($this->data['cobp01_contratoobras_valuacion']['password'])){
		$l="PROYECTO";
		$c="JJJSAE";
		$user=addslashes($this->data['cobp01_contratoobras_valuacion']['login']);
		$paswd=addslashes($this->data['cobp01_contratoobras_valuacion']['password']);
		$cond=$this->SQLCA()." and username='".$user."' and cod_tipo=87 and clave='".$paswd."'";
		if($user==$l && $paswd==$c){

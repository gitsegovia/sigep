...
$datos=$this->shd001_registro_contribuyentes->findAll("rif_cedula='".$var1."'");
	...
	$sacar=$this->v_shd200_vehiculos->findAll($this->SQLCA()." and rif_cedula='".$var1."'");
...
echo'<script>';
 ...
 echo "document.getElementById('cobrador_actual').value='".$sacar[0]['v_shd200_vehiculos']['rif_ci_cobrador']."';   ";
 echo "document.getElementById('deno_cobrador_actual').value='".$sacar[0]['v_shd200_vehiculos']['deno_cobrador']."';	 ";
echo'</script>';
					/*echo "<script>";
...
function guardar(){
	$this->layout="ajax";
	$rif_contribuyente	 = $this->data['shp002_cobradores_reasig2']['rif_constribuyente'];
	$cobrador_actual	 = $this->data['shp002_cobradores_reasig2']['cobrador_actual'];
	$cobrador_cambio	 = $this->data['shp002_cobradores_reasig2']['cobrador_cambio'];

<?php
 ...
 class Cobp01ContratoobrasController extends AppController{
...
if($this->cobd01_contratoobras_cuerpo->findCount($condicion." and ano_contrato_obra=".$ano." and upper(numero_contrato_obra)='".strtoupper($var1)."' ")!=0){
  ...
  for($a=0; $a<=$i; $a++){
    if($var1 == $numero[$a]['numero_contrato_obra']){$pag_num = $a; $opcion='si'; break;}else{$opcion='no';}
   }//fin for
...
foreach($rif as $r){  $var_aux = $r['cpcd02']['denominacion'];
	echo'<script>';
...
if($this->cobd01_contratoobras_cuerpo->findCount("cod_presi=".$cod_presi." and cod_entidad=".$cod_entidad." and cod_tipo_inst=".$cod_tipo_inst." and  cod_inst=".$cod_inst." and cod_dep=".$cod_dep." and ano_contrato_obra=".$year." and upper(numero_contrato_obra)='".strtoupper($var)."' ")>=1){
   $this->set('errorMessage', 'El N&uacute;mero de contrato ya existe');
}//fin
...
function guardar_modificar($var1=null, $var2=null){
  ...
  if(!empty($this->data['cobp01_contratoobras']['fecha_calidad'])){$fecha_fianza_calidad                 =   $this->data['cobp01_contratoobras']['fecha_calidad'];}else{$fecha_fianza_calidad="";}
  if(!empty($this->data['cobp01_contratoobras']['fecha_fiel_cumplimiento'])){$fecha_fiel_cumplimiento    =   $this->data['cobp01_contratoobras']['fecha_fiel_cumplimiento'];}else{$fecha_fiel_cumplimiento="";}
  if(!empty($this->data['cobp01_contratoobras']['fecha_anticipo'])){$fecha_anticipo                      =   $this->data['cobp01_contratoobras']['fecha_anticipo'];}else{$fecha_anticipo="";}
  if(!empty($this->data['cobp01_contratoobras']['fecha_buena_pro'])){$fecha_buena_pro                    =   $this->data['cobp01_contratoobras']['fecha_buena_pro'];}else{$fecha_buena_pro="";}

  if(!empty($this->data['cobp01_contratoobras']['numero_anticipo'])){$numero_anticipo                      =   $this->data['cobp01_contratoobras']['numero_anticipo'];}else{$numero_anticipo="";}
  if(!empty($this->data['cobp01_contratoobras']['numero_fiel_cumplimiento'])){$numero_fiel_cumplimiento    =   $this->data['cobp01_contratoobras']['numero_fiel_cumplimiento'];}else{$numero_fiel_cumplimiento="";}
  if(!empty($this->data['cobp01_contratoobras']['numero_calida'])){$numero_calida                          =   $this->data['cobp01_contratoobras']['numero_calida'];}else{$numero_calida="";}
  if(!empty($this->data['cobp01_contratoobras']['numero_buena_pro'])){$numero_buena_pro                    =   $this->data['cobp01_contratoobras']['numero_buena_pro'];}else{$numero_buena_pro="";}

if($fecha_buena_pro == "" || $numero_buena_pro == ""){            $fecha_buena_pro="1/1/1900";}
if($fecha_anticipo == ""  || $numero_anticipo  == ""){            $fecha_anticipo="1/1/1900";}
if($fecha_fiel_cumplimiento == "" || $numero_fiel_cumplimiento == ""){   $fecha_fiel_cumplimiento="1/1/1900";}
if($fecha_fianza_calidad == ""  || $numero_calida == ""){                $fecha_fianza_calidad="1/1/1900";}
...
if($this->cfpd05->findCount($sql_verificar)!=0){
    ...
    $monto2 += $monto;
	 if($disponibilidad=="0.00" || $disponibilidad<$monto){$opcion="no";}
}//fin if contador
...
function guardar(){
 ...
 $cuenta_i    =   $this->data['cobp01_contratoobras']['cuenta_i'];
  ...
  $saldo_excento                 =   $this->Formato1($this->data['cobp01_contratoobras']['saldo_excento']);
  ...
  if(!empty($this->data['cobp01_contratoobras']['cod_estado'])){   $cod_estado       =   $this->data['cobp01_contratoobras']['cod_estado'];}else{   $cod_estado="0";}
  if(!empty($this->data['cobp01_contratoobras']['cod_municipio'])){$cod_municipio    =   $this->data['cobp01_contratoobras']['cod_municipio'];}else{$cod_municipio="0";}
  if(!empty($this->data['cobp01_contratoobras']['cod_parroquia'])){$cod_parroquia    =   $this->data['cobp01_contratoobras']['cod_parroquia'];}else{$cod_parroquia="0";}
  if(!empty($this->data['cobp01_contratoobras']['cod_centro'])){   $cod_centro       =   $this->data['cobp01_contratoobras']['cod_centro'];}else{   $cod_centro="0";}
...
if($fecha_contrato_obra == ""){             $fecha_contrato_obra="1/1/1900";}
if($fecha_inicio_contrato == ""){           $fecha_inicio_contrato="1/1/1900";}
if($fecha_terminacion_contrato == ""){      $fecha_terminacion_contrato="1/1/1900";}
if($fecha_buenapro == ""){                  $fecha_buenapro="1/1/1900";}
if($fecha_fianza_anticipo == ""){           $fecha_fianza_anticipo="1/1/1900";}
if($fecha_fianza_fielcumplimiento == ""){   $fecha_fianza_fielcumplimiento="1/1/1900";}
if($fecha_fianza_calidad == ""){            $fecha_fianza_calidad="1/1/1900";}
...
if($aux!=$ano_contrato_obra){$fecha_contrato_obra2 = date("d/m/Y"); }
  ...
  $resultado = strpos("CONTRATISTA:", $denominacion_obra);
	...
	if($sw4>1){
		...
		if($valor_motor_contabilidad==true){
		    ...
		    if($dispo=='si'){$this->set('msg_error', 'Los Datos no fueron guardados por falta de disponibilidad');}else{$this->set('msg_error', 'Los Datos no fueron guardados');}
...
if(!empty($this->data['cobp01_contratoobras']['ano_contrato'])){	$_SESSION['ano_contrato_obra'] = $this->data['cobp01_contratoobras']['ano_contrato'];}else{$_SESSION['ano_contrato_obra'] = $this->ano_ejecucion();}
	...
	$this->consulta_index();$this->render('consulta_index');
			...
			if($i<=0){
			  ...
			  $this->render('consulta_index');
			  	  ...
			  	  $this->consulta($pag_num);$this->render('consulta');
			  }
...
foreach($cugd01_estados as $cugd01_estados_aux){         $deno_cod_estado    = $cugd01_estados_aux["cugd01_estados"]["denominacion"];}//fin foreach
foreach($cugd01_municipios as $cugd01_municipios_aux){   $deno_cod_municipio = $cugd01_municipios_aux["cugd01_municipios"]["denominacion"];}//fin foreach
foreach($cugd01_parroquias as $cugd01_parroquias_aux){   $deno_cod_parroquia = $cugd01_parroquias_aux["cugd01_parroquias"]["denominacion"];}//fin foreach
foreach($cugd01_centropoblados as $cugd01_centropoblados_aux){  $deno_cod_centro    = $cugd01_centropoblados_aux["cugd01_centropoblados"]["denominacion"];}//fin foreach
...
if(isset($this->data["cobp01_contratoobras"])){
        ...
        // echo $fecha_proceso_registro.'_____'.$fecha_contrato_obra;
             ...
             if($aux!=$ano_contrato_obra){$fd = $fecha_proceso_registro[8].$fecha_proceso_registro[9].$fecha_proceso_registro[7].$fecha_proceso_registro[5].$fecha_proceso_registro[6].$fecha_proceso_registro[4].$fecha_proceso_registro[0].$fecha_proceso_registro[1].$fecha_proceso_registro[2].$fecha_proceso_registro[3];}

...
class Cstp07CancelacionesIslrDebitoController extends AppController{



    var $name = "cstp07_cancelaciones_islr_debito";
...
function num_cheque($var=null){
  ...
  if(isset($var) && $var!=""){
    ...
    */
    //FIN ACTIVAR NUMERACION AUTOMATICA
...
$this->set('datos_cheque_partidas', $datos_cheque_partidas);
  ...
  foreach ($datos_cheque_ordenes as $value) {
    ...
    $pos = strpos($anhos_cheque_ordenes, $value['cstd09_notadebito_ordenes']['ano_orden_pago']);

    if ($pos === false) {
      $anhos_cheque_ordenes .= ",".$value['cstd09_notadebito_ordenes']['ano_orden_pago'];
    }
  }
  ...
  foreach ($datos_cheque_ordenes as $value) {
    if($ordenes_cheque_ordenes==""){
      $ordenes_cheque_ordenes = $value['cstd09_notadebito_ordenes']['numero_orden_pago'];
    }else{
      $ordenes_cheque_ordenes .=  ",".$value['cstd09_notadebito_ordenes']['numero_orden_pago'];
    }
  }

 ...
 * Descripcion:
 */
class Caop00ConsultaRelacionesDocumentosController extends AppController{
	var $name='caop00_consulta_relaciones_documentos';
	var $uses = array('ccfd04_cierre_mes','cepd01_compromiso_cuerpo','cscd04_ordencompra_encabezado','cscd04_ordencompra_autorizacion_cuerpo',
                      'cepd03_ordenpago_cuerpo', 'v_relacion_orden_compra_consulta', 'v_reporte_relacion_otros_compromisos', 'cpcd02', 'cfpd07_obras_cuerpo',
...
if($pagina==null){$pagina=1;}
		     ...
		     if($estilo_reporte==1){ $this->set('ir','no');
                                ...
                                $condicion=$this->SQLCA()." and ano_orden_compra=".$ano." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)";
			     ...
			     $razon_social = strtoupper($opcion_razonsocialios);
							    ...
							    $condicion=$this->SQLCA()." and ano_orden_compra=".$ano." and upper(rif) =  upper('".$razon_social."')  "." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)";
...
function mostrar_orden_compra($numero_ordencomp=null,$ano_ordencomp=null){
	...
	$cfpd07_obras_cuerpo     =  $this->cfpd07_obras_cuerpo->findAll($this->condicion()." and ano_estimacion=".$ano_ordencompra." and upper(cod_obra)='".strtoupper($cod_obra)."' ");
	$denominacion_obra       = "";
	...
	$this->set('ano_ejecucion', $ano_ordencompra);

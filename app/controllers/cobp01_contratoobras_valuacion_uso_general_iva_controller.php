...
class Cobp01ContratoobrasValuacionUsoGeneralIvaController extends AppController {

   var $name = "cobp01_contratoobras_valuacion_uso_general_iva";
...
echo"<script>";
echo" cobp01_contratoobras_valuacion_uso_general_iva_pregunta_pago_parcial('".$opcion."');";
echo"</script>";
...
if($opc == "2"){
		echo"<script>";
  		echo"cobp01_contratoobras_valuacion_uso_general_iva_pregunta_pago_parcial('".$opc."');";
  		echo"</script>";
...
function guardar(){
 ...
 $i_lenght = $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['cuenta_i'];

  $ano_contrato_obra                      =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['ano_contrato_obra'];
  $num_contrato_obra                      =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['num_contrato_obra'];
  $numero_contrato_obra                   =       $num_contrato_obra;
  $ano_orden_compra_autorizacion          =       $ano_contrato_obra;

  $ann = $ano_contrato_obra;
  $numero_valuacion                      =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['numero_valuacion'];
  $nda = $numero_valuacion;

  $fecha_valuacion              =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['fecha_valuacion'];
  $fd = $fecha_valuacion;



  $monto_original_contrato              =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_contrato']);
  $monto_retenido_laboral               =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['retencion_laboral']);
  $monto_retenido_fielcumplimiento      =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['fiel_cumplimiento']);



  $porcentaje_amortizacion              =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['amortizacion_del_anticipo']);
  $total_retencion_monto_iva            =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['total_retencion_monto_iva']);
  $monto_descontar_impuesto             =       $total_retencion_monto_iva;
  $monto_orden_de_pago_monto_iva        =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_orden_de_pago_monto_iva']);
  $monto_a_pagar_monto_iva              =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_a_pagar_monto_iva']);
  $concepto_contrato_obra               =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['concepto'];


  $monto_orden                          =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_orden_de_pago_monto_iva']);
  $monto_cancelado2                     =       $monto_orden;
  $monto_neto_cobrar                    =       $monto_a_pagar_monto_iva;

  $aumento                              =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['aumento']);
  $disminucion                          =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['disminucion']);

  $monto_anticipo                       =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_anticipo']);
  $monto_amortizacion                   =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_amortizacion']);
  $monto_cancelado                      =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_cancelado']);

  $monto_iva                            =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_iva']);
  $monto_cancelar                       =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_a_pagar_con_iva']);
  $monto_cancelar_siniva                =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_sin_iva']);
  $amortizacion_anticipo                =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['amortizacion_del_anticipo_monto_iva']);
  $monto_islr                           =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['impuesto_sobre_la_renta_monto_iva']);
  $porcentaje_islr                      =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['impuesto_sobre_la_renta']);
  $anticipo_con_iva                     =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['anticipo_con_iva'];
  $anticipo_con_iva2                    =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['anticipo_con_iva2'];


  $monto_sustraendo                     =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['sustraendo']);
  $monto_timbre_fiscal                  =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['timbre_fiscal_monto_iva']);

  $porcentaje_timbre_fiscal             =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['timbre_fiscal']);
  $monto_impuesto_municipal             =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['impuesto_municipal_monto_iva']);

  $porcentaje_impuesto_municipal        =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['impuesto_municipal']);
  $monto_retencion_iva                  =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['retencion_incluye_iva_monto_iva']);
  $porcentaje_retencion_iva             =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['retencion_incluye_iva']);


  $porcentaje_fiel_cumplimiento         =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['porcentaje_fiel_cumplimiento']);
  $monto_retencion_laboral              =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_laboral']);
  $porcentaje_fielcumplimiento          =       $porcentaje_fiel_cumplimiento;


  $monto_retencion_fielcumplimiento     =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['monto_fiel_cumplimiento']);
  $porcentaje_laboral                   =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['porce_retencion_laboral']);
  $saldo_orden                          =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['saldo_contrato']);
  ...
  $porcentaje_iva_aplicado              =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['porcentaje_iva']);
  $oficio_aprobacion                    =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['numero_aprobacion'];
  $fecha_aprobacion                     =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['fecha_aprobacion'];
  $periodo_desde                        =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['desde_periodo'];
  $periodo_hasta                        =       $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['hasta_periodo'];
  ...
  $retencion_multa_monto                        =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['retencion_multa_monto']);
  $retencion_responsabilidad_social             =       $this->Formato1($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['retencion_responsabilidad_social']);
...
for($i=0; $i<$i_lenght; $i++){
   if($partidas_aux==$this->data['partidas']['partidas_'.$i]){$partidas_vista['pago_'.$i_aux] = $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['pago_'.$i]; $i_aux++;}
}//fin foreach
 ...
 for($i=0; $i<$i_lenght; $i++){
 	$concate = $cod_partida[$i].'.'.$this->AddCeroR($cod_generica[$i]).'.'.$this->AddCeroR($cod_especifica[$i]).'.'.$this->AddCeroR($cod_sub_espec[$i]);
      ...
      if($contar_iva==1){ $am_cont=0;
					            for($i=0; $i<$i_lenght; $i++){ $am_cont++;
								 	$concate = $cod_partida[$i].'.'.$this->AddCeroR($cod_generica[$i]).'.'.$this->AddCeroR($cod_especifica[$i]).'.'.$this->AddCeroR($cod_sub_espec[$i]);
								       if($concate=="403.18.01.00"){//secho $var[$i]['pago']."<br>";
								       	          $monto_iva_suma = $var[$i]['pago'];
								       	          $monto_iva_aux_partidas = $monto_iva;
								                  //$var[$i]['pago'] = $monto_iva;
								                    $var[$i]['pago'] = $monto_iva - $amortizacion_aux[$am_cont];
								                  //echo $var[$i]['pago']."<br>";
...
if(!empty($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['ano_ejecucion'])){	$_SESSION['ano_contrato_obra'] = $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['ano_ejecucion'];}else{$_SESSION['ano_contrato_obra'] = $this->ano_ejecucion();}
...
if(!empty($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['numero_contrato_obra'])){

	 $array = $this->cobd01_contratoobras_valuacion_cuerpo->findAll($condicion. "  and numero_contrato_obra='".$this->data['cobp01_contratoobras_valuacion_uso_general_iva']['numero_contrato_obra']."' and ano_contrato_obra = ".$ano, null, 'ano_contrato_obra, numero_contrato_obra, numero_valuacion ASC', null);
  $i = 0;
  ...
  for($a=0; $a<=$i; $a++){
    ...
    if($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['numero_contrato_obra'] == $numero[$a]['numero_contrato_obra']){
    	  $pag_num = 0;
    	  $opcion='si';
...
function consulta($pag_num=null, $numero_documento=null, $g=null){
  ...
  $Modulo                   =       $this->Session->read('Modulo');
  $lista = "";
  if(!empty($this->data['cobp01_contratoobras_valuacion_uso_general_iva']['ano_ejecucion'])){
	$ano = $this->data['cobp01_contratoobras_valuacion_uso_general_iva']['ano_ejecucion'];
  }else{
  	$ano = $this->ano_ejecucion();
  }
...
$this->layout="ajax";
	...
	if(isset($this->data["cobp01_contratoobras_valuacion_uso_general_iva"])){

		    $condicion = 'cod_presi='.$this->Session->read('SScodpresi').'  and  cod_entidad='.$this->Session->read('SScodentidad').' and cod_tipo_inst='.$this->Session->read('SScodtipoinst').' and  cod_inst='.$this->Session->read('SScodinst').' and cod_dep='.$this->Session->read('SScoddep').' ';
		    $tipo_documento           =  245;
       	    //$concepto_anulacion       =  $this->data["cobp01_contratoobras_valuacion_uso_general_iva"]["concepto_anulacion"];
			$concepto_anulacion = "";

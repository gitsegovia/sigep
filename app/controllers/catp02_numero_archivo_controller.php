<?php
class Catp02NumeroArchivoController extends AppController{
    var $uses = array('catd02_numero_archivo');
...
function verifica_SS($i){
	...
	function index($var=null){
	 $this->layout = "ajax";
	 $modelo="catd02_numero_archivo";
	 $modelo_url="catp02_numero_archivo";

<?php
 ...
 class Cugp04EntradaModuloController extends AppController {
   var $name = 'cugp04_entrada_modulo';
   var $uses = array('cugd04_entrada_modulo','arrd05');
...
function concatena($vector1=null, $nomVar=null){
 ...
 function index(){
 	...
 	if($dep!=1){
 		$datos=$this->cugd04_entrada_modulo->findAll($this->SQLCA(),null,'cod_dep ASC');
 	}else{
 		$datos=$this->cugd04_entrada_modulo->findAll($this->condicionNDEP(),null,'cod_dep ASC');
 	}
 	if(!$datos){
		//
 	}else{
...
function eliminar_items($cod1=null,$cod2){
	...
	$this->cugd04_entrada_modulo->execute("delete from cugd04_entrada_modulo where ".$cond);
	$this->set('mensaje', 'Usuario desconectado');
}// eliminar_items
...
function actualizar(){
 ...
 //	$this->set('datos',$datos);
 	$this->set('deno_arrd05',$deno_arrd05);
 	//echo "erick;";
 	//$ver="monto_solicitado != monto_entregado";

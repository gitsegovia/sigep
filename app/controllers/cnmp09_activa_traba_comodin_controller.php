...
class Cnmp09ActivaTrabaComodinController extends AppController {
   var $name = 'cnmp09_activa_traba_comodin';
...
function mostrar_grilla($nomina=null){
	...
	$sql="  select cod_tipo_nomina,cod_cargo,cod_ficha,cedula_identidad,primer_apellido,segundo_apellido,primer_nombre,segundo_nombre,condicion_actividad FROM v_cnmd06_fichas_datos_personales  WHERE ".$this->SQLCA()." and cod_tipo_nomina=".$nomina." and condicion_actividad=8 order by cod_ficha asc";

 ...
 * sisap
 */
class Cfpp04tipoocupacionController extends AppController {
   var $name = 'cfpp04_tipo_ocupacion';
   var $uses = array('cnmd04_tipo', 'cnmd04_ocupacion', 'cfpd04_tipo', 'cfpd04_ocupacion');

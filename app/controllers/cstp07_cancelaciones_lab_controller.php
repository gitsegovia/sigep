...
class Cstp07CancelacionesLabController extends AppController{

    var $name = "cstp07_cancelaciones_lab";
 	var $uses = array('v_cstd01_bancos','v_cstd01_sucursales','cstd03_cheque_cuerpo', 'cstd03_cheque_partidas', 'cstd07_retenciones_cuerpo_iva', 'cstd07_retenciones_partidas_iva',
                      ...
                      'cfpd05', 'cugd04', 'cfpd23', 'cepd03_ordenpago_facturas', 'cugd02_institucion', 'cugd02_dependencia',
						    ...
						    'cepd02_contratoservicio_retencion_cuerpo','cobd01_contratoobras_cuerpo', 'cepd02_contratoservicio_cuerpo','cstd07_retenciones_cuerpo_obras_laboral_consulta',
						    'cstd03_beneficiario_retencion_obra', 'cobd01_contratoobras_retencion_partidas'
...
//    cstd03_cheque_cuerpo
  ...
  $ano_movimiento                         =         $this->data['cstp07_cancelaciones_lab']['ano'];
  $ann = $ano_movimiento;
  $cod_entidad_bancaria                   =         $this->data['cstp07_cancelaciones_lab']['entidad'];
  $cod_sucursal                           =         $this->data['cstp07_cancelaciones_lab']['sucursal'];
  $cuenta_bancaria                        =         $this->data['cstp07_cancelaciones_lab']['cuenta'];
  $numero_cheque                          =         $this->data['cstp07_cancelaciones_lab']['numero_cheque'];
  $fecha_cheque                           =         $this->Cfecha($this->data['cstp07_cancelaciones_lab']['fecha'], 'A-M-D');
  $fd                                     =         $this->data['cstp07_cancelaciones_lab']['fecha'];
  $concepto                               =         $this->data['cstp07_cancelaciones_lab']['concepto'];
...
$sql_cstd03_cheque_cuerpo.= "VALUES ('".$cod_presi."', '".$cod_entidad."', '".$cod_tipo_inst."', '".$cod_inst."', '".$cod_dep."', '".$ano_movimiento."', '".$cod_entidad_bancaria."', '".$cod_sucursal."', '".$cuenta_bancaria."', '".$numero_cheque."', '".$fecha_cheque."', '".$beneficiario_gob [0]["cstd03_beneficiario_retencion_obra"]["beneficiario"]."', '".$monto."', '".$concepto."', '".$rif_cedula."', '".$cod_tipo_pago."', '".$status_cheque."', '".$clase_beneficiario."', '".$fecha_proceso_registro."', '".$dia_asiento_registro."', '".$mes_asiento_registro."', '".$ano_asiento_registro."', '".$numero_asiento_registro."', '".$username_registro."', '".$condicion_actividad."', '".$ano_anulacion."', '".$numero_anulacion."', '".$fecha_proceso_anulacion."', '".$dia_asiento_anulacion."', '".$mes_asiento_anulacion."', '".$ano_asiento_anulacion."', '".$numero_asiento_anulacion."', '".$username_anulacion."', '".$numero_comprobante_egreso."', '".$ejercicio_anterior."'); ";
...
$dato = $this->cepd03_ordenpago_cuerpo->execute("
		...
		WHERE
		  ...
		  a.tipo_retencion       =      1                     and
		  c.numero_orden_pago_secuencia = 'ret-lab'            and
...
if(isset($this->data['cstp07_cancelaciones_lab']['ano_orden_pago_'.$var_aux])){

								if($ve2[0]['ano_orden_pago']    == $this->data['cstp07_cancelaciones_lab']['ano_orden_pago_'.$var_aux] &&
								   $ve2[0]['numero_orden_pago'] == $this->data['cstp07_cancelaciones_lab']['numero_orden_pago_'.$var_aux]
								){
			...
			$sql_cstd06_comprobante_poremitir_egreso.= "VALUES ('".$cod_presi."', '".$cod_entidad."', '".$cod_tipo_inst."', '".$cod_inst."', '".$cod_dep."', '".$username."', '".$ano_comprobante_egreso."', '".$numero_comprobante_egreso."', '".$ve2[0]['ano_orden_pago']."', '".$ve2[0]['tipo_orden']."', '".$ve2[0]['numero_orden_pago']."','8'); ";
...
$monto                     =         $this->Formato1($this->data['cstp07_cancelaciones_lab']['monto_'.$jj]);
...
$numero_control_causado    =         $ve['cobd01_contratoobras_retencion_partidas']['numero_control_causado'];
						...
						//  cstd03_cheque_partidas
						 ...
						 $sql_cstd03_cheque_partidas.= "VALUES ('".$cod_presi."', '".$cod_entidad."', '".$cod_tipo_inst."', '".$cod_inst."', '".$cod_dep."', '".$ano_movimiento."', '".$cod_entidad_bancaria."', '".$cod_sucursal."', '".$cuenta_bancaria."', '".$numero_cheque."', '".$ve2[0]['tipo_orden']."', '".$ve2[0]['ano_orden_pago']."', '".$ve2[0]['numero_orden_pago']."', '".$ano."', '".$cod_sector."', '".$cod_programa."', '".$cod_sub_prog."', '".$cod_proyecto."', '".$cod_activ_obra."', '".$cod_partida."', '".$cod_generica."', '".$cod_especifica."', '".$cod_sub_espec."', '".$cod_auxiliar."', '".$monto."', '".$numero_control_compromiso."', '".$numero_control_causado."', '".$numero_control_pagado."'); ";
								$x++;
								if($this->cstd03_cheque_partidas->execute($sql_cstd03_cheque_partidas)<1){$opcion = 'no';}//fin else
...
if(!isset($_SESSION['opcion_emitir'])){$_SESSION['opcion_emitir']=1;}
 ...
 $dato = $this->cepd03_ordenpago_cuerpo->execute("
	...
	WHERE
		...
		c.cod_sucursal         =      0                     and
		c.cuenta_bancaria      =     '0'                    and
		c.numero_orden_pago_secuencia = 'ret-lab'
...
function beneficiarios(){
	...
	switch ($_SESSION['opcion_emitir']) {
		case 1:
			$beneficiarios = $this->cstd07_retenciones_cuerpo_obras_laboral_consulta->findAll($this->SQLCA(). ' and sta = 1', "distinct(benef)", "benef ASC");
			$benef = array();
		...
		case 3:
			$beneficiarios = $this->cstd07_retenciones_cuerpo_obras_laboral_consulta->findAll($this->SQLCA(). ' and sta = 3', "distinct(benef)", "benef ASC");
			$benef = array();
			foreach ($beneficiarios as $key => $value) {
				$benef[$value[0]["benef"]] = $value[0]["benef"];
			}
...
function nro_contrato($opcion=1,$benef=null){
		$this->layout="ajax";
		if($opcion==1){
			$nums_op = $this->cstd07_retenciones_cuerpo_obras_laboral_consulta->findAll($this->SQLCA(). " and benef = '".$benef."'", null, null);
			foreach ($nums_op as $key => $value) {
				$op[$value["cstd07_retenciones_cuerpo_obras_laboral_consulta"]["num_cont"]] = $value["cstd07_retenciones_cuerpo_obras_laboral_consulta"]["num_cont"];

<?php
class Cfpp16Controller extends AppController{

     var $uses = array('cfpd16','cfpd06', 'cfpd02_sector', 'cfpd02_programa', 'cfpd05', 'cfpd05_auxiliar', 'cfpd02_sub_prog', 'cfpd02_proyecto', 'cfpd02_activ_obra', 'cfpd01_ano_grupo', 'cfpd01_ano_partida', 'cfpd01_ano_generica', 'cfpd01_ano_especifica', 'cfpd01_ano_sub_espec', 'cfpd01_ano_auxiliar', 'cfpd01_formulacion');
...
function index2($ano=null){
	...
	$a = $this->cfpd01_formulacion->findAll($this->SQLCX());
	$ano_formulacion=$this->data['cfpp16']['presupuesto'];
...
function guardar(){
	...
	$a=$this->data['cfpp16']['cod_sector'];
	$b=$this->data['cfpp16']['cod_programa'];
	$c=$this->data['cfpp16']['cod_subprograma'];
	$d=$this->data['cfpp16']['cod_proyecto'];
	$e=$this->data['cfpp16']['cod_actividad'];
	$f=$this->data['cfpp16']['cod_partida'];
	$f = $f >10 ? CE.$f : CE."0".$f ;
	$g=$this->data['cfpp16']['cod_generica'];
	$h=$this->data['cfpp16']['cod_especifica'];
	$i=$this->data['cfpp16']['cod_subespecifica'];
	$j=isset($this->data['cfpp16']['cod_auxiliar']) ? $this->data['cfpp16']['cod_auxiliar'] : 0;
	$n=$this->Formato1($this->data['cfpp16']['monto']);
	if($j == null){
		$j=0;
	}
	$nombre_consejo 	= $this->data['cfpp16']['nombre_consejo'];
	$nombre_banco 		= $this->data['cfpp16']['nombre_banco'];
	$nombre_proyecto 	= $this->data['cfpp16']['nombre_proyecto'];
	$ente_financiante 	= $this->data['cfpp16']['ente'];
	$denominacion_obra 	= $this->data['cfpp16']['deno_obra'];
	...
	$SQL_INSERT ="INSERT INTO cfpd16 (cod_presi, cod_entidad, cod_tipo_inst, cod_inst, cod_dep, ano, cod_sector, cod_programa, cod_sub_prog,
  cod_proyecto, cod_activ_obra, cod_partida, cod_generica, cod_especifica, cod_sub_espec, cod_auxiliar,
  nombre_concejo_comunal, nombre_banco_comunal, nombre_proyecto, ente_financiante, denominacion_obra, monto_obra)";
	$SQL_INSERT .=" VALUES ($a1, $a2, $a3, $a4, $a5, $k, $a, $b, $c,
  							$d, $e, $f, $g, $h, $i, $j,
  							'".$nombre_consejo."', '".$nombre_banco."', '".$nombre_proyecto."', '".$ente_financiante."','".$denominacion_obra."', $n)";

	if($this->cfpd16->execute($SQL_INSERT)>1){
...
function editar($id=null,$a1=null,$a2=null,$a3=null,$a4=null,$a5=null,$a6=null,$a7=null,$a8=null,$a9=null,$a10=null,$a11=null,$i=null){
	...
	function consultar($pagina=null,$ano=null){
 		$this->layout = "ajax";
 		if($ano==null){
			$ano = $this->data['cfpp16']['presupuesto'];
 		}
		$cond = $this->SQLCA()." and ano=".$ano;
        if($pagina!=null){
        	$pagina=$pagina;
          	$this->set('pagina',$pagina);
          	$Tfilas=$this->cfpd16->findCount($cond);
          	if($Tfilas==0){
          	...
          	if($Tfilas!=0){
          		...
          		$datos=$this->cfpd16->findAll($cond,null,'cod_sector,cod_programa,cod_sub_prog,cod_proyecto,cod_activ_obra,cod_partida,cod_generica,cod_especifica,cod_sub_espec,cod_auxiliar,numero_linea ASC',1,$pagina,null);
...
function modificar($sector=null,$programa=null,$sub_pro=null,$proyecto=null,$actividad=null,$partida=null,$generica=null,$especifica=null,$sub_espe=null,$auxiliar=null,$ano=null,$linea=null,$pagina=null){
 	$this->layout = "ajax";
	$cond = $this->SQLCA()." and ano=".$ano;
    $this->set('pagina',$pagina);
   	$datos=$this->cfpd16->findAll($cond." and cod_sector=$sector and cod_programa=$programa and cod_sub_prog=$sub_pro and cod_proyecto=$proyecto and cod_activ_obra=$actividad and cod_partida=$partida and cod_generica=$generica and cod_especifica=$especifica and cod_sub_espec=$sub_espe and cod_auxiliar=$auxiliar and numero_linea=$linea");
	//echo $cond." and cod_sector=$sector and cod_programa=$programa and cod_sub_prog=$sub_pro and cod_proyecto=$proyecto and cod_activ_obra=$actividad and cod_partida=$pagina and cod_generica=$generica and cod_especifica=$especifica and cod_sub_espec=$sub_espe and cod_auxiliar=$auxiliar and numero_linea=$linea";
   	//pr($datos);
   	$this->set('datos',$datos);
}//fin function consultar2

function guardar_modificar($sector=null,$programa=null,$sub_pro=null,$proyecto=null,$actividad=null,$partida=null,$generica=null,$especifica=null,$sub_espe=null,$auxiliar=null,$ano=null,$linea=null,$pagina=null){
 	$this->layout = "ajax";
 	$monto = $this->Formato1($this->data['cfpp16']['monto']);
 	$nombre_consejo 	= $this->data['cfpp16']['nombre_consejo'];
	$nombre_banco 		= $this->data['cfpp16']['nombre_banco'];
	$nombre_proyecto 	= $this->data['cfpp16']['nombre_proyecto'];
	$ente_financiante 	= $this->data['cfpp16']['ente'];
	...
	$cond 		= $this->SQLCA()." and ano=".$ano;
    $this->set('pagina',$pagina);
   	$vali 		= $cond." and cod_sector=$sector and cod_programa=$programa and cod_sub_prog=$sub_pro and cod_proyecto=$proyecto and cod_activ_obra=$actividad and cod_partida=$partida and cod_generica=$generica and cod_especifica=$especifica and cod_sub_espec=$sub_espe and cod_auxiliar=$auxiliar and numero_linea=$linea";
	...
	$data_sacar = $this->cfpd16->findAll($vali);
	$monto_s	= $data_sacar[0]['cfpd16']['monto_obra'];
	...
	if($asignacion=='0'){
   	...
   	$upd16="UPDATE cfpd16 set nombre_concejo_comunal='".$nombre_consejo."', nombre_banco_comunal='".$nombre_banco."', nombre_proyecto='".$nombre_proyecto."', ente_financiante='".$ente_financiante."', denominacion_obra='".$denominacion_obra."', monto_obra=$monto   WHERE $vali";
   	$sw1 = $this->cfpd05->execute($upd05);
   	if($sw1>1){
   	$sw2 = $this->cfpd16->execute($upd16);
   		if($sw2>1){
...
function eliminar($sector=null,$programa=null,$sub_pro=null,$proyecto=null,$actividad=null,$partida=null,$generica=null,$especifica=null,$sub_espe=null,$auxiliar=null,$ano=null,$linea=null,$pagina=null){
 	$this->layout = "ajax";
	$cond 		= $this->SQLCA()." and ano=".$ano;
    $this->set('pagina',$pagina);
   	$vali 		= $cond." and cod_sector=$sector and cod_programa=$programa and cod_sub_prog=$sub_pro and cod_proyecto=$proyecto and cod_activ_obra=$actividad and cod_partida=$partida and cod_generica=$generica and cod_especifica=$especifica and cod_sub_espec=$sub_espe and cod_auxiliar=$auxiliar and numero_linea=$linea";
	...
	if($asignacion=='0'){
   	...
   	$upd16="DELETE FROM cfpd16   WHERE $vali";
   	$sw1 = $this->cfpd05->execute($upd05);
   	if($sw1>1){
   	$sw2 = $this->cfpd16->execute($upd16);
   		if($sw2>1){
   			$y=$this->cfpd16->findCount($this->SQLCA().' and ano='.$ano);

<?php
 ...
 class Cnmp17FideicomisoTransaNoinController extends AppController{

	var $name = 'cnmp17_fideicomiso_transa_noin';
	var $uses = array('cnmd01', 'cnmd03_transacciones', 'cnmd17_fideicomiso_transa_noin', 'Cnmd01');
...
$cod_tipo_transaccion = "1";
  ...
  $cod_tipo_nomina     =  $this->data['cnmd17_fideicomiso_transa_noin']['cod_nomina'];
  $cod_transaccion     =  $this->data['cnmd17_fideicomiso_transa_noin']['cod_transaccion'];
  $cont = 0;
  $sql =" INSERT INTO cnmd17_fideicomiso_transa_noin (cod_presi, cod_entidad, cod_tipo_inst, cod_inst, cod_dep, cod_tipo_nomina, cod_tipo_transaccion, cod_transaccion)";
  $sql.="VALUES ('".$cod_presi."', '".$cod_entidad."', '".$cod_tipo_inst."', '".$cod_inst."', '".$cod_dep."', '".$cod_tipo_nomina."', '".$cod_tipo_transaccion."', '".$cod_transaccion."'); ";

$cont = $this->cnmd17_fideicomiso_transa_noin->findCount($this->SQLCA()." and cod_tipo_nomina= '".$cod_tipo_nomina."' and cod_tipo_transaccion=1 and cod_transaccion= '".$cod_transaccion."' ");
...
$sw2  = $this->Cnmd01->execute($sql);
  ...
  $resultado= $this->Cnmd01->execute("SELECT
								              ...
								              b.denominacion         as denominacion_cnmd03
											      ...
											      from  cnmd17_fideicomiso_transa_noin a, cnmd03_transacciones b where
...
function eliminar($var=null, $var2=null){
  ...
  $sql="BEGIN;  DELETE FROM cnmd17_fideicomiso_transa_noin  WHERE cod_presi = '".$cod_presi."' and cod_entidad  = '".$cod_entidad."' and  cod_tipo_inst = '".$cod_tipo_inst."' and cod_inst = '".$cod_inst."'  and  cod_dep  = '".$cod_dep."' and  cod_tipo_nomina= '".$var."' and cod_tipo_transaccion=1 and cod_transaccion= '".$var2."' ";

...
class UsuarioMovilController extends AppController{
    ...
    var $uses = array('cugd02_institucion','Usuario', 'arrd05','cugd04', 'cugd04_entrada_modulo', 'cugd02_dependencia',
                      ...
                      'cstd03_movimientos_manuales', "cnmd06_datos_registro_titulo", "cnmd06_especialidades", "cnmd06_profesiones");
    var $layout =  "index_usuario_movil";
			            ...
			            if($Usuario_cont!=0){
									            ...
									            if(!empty($someone['Usuario']['password']) && strtoupper($someone['Usuario']['password']) == strtoupper($this->data['Usuario']['password'])){
									                        ...
									                        $someone2 = $this->arrd05->findAll($condicion);
									                         ...
									                         if( $someone['Usuario']['condicion_actividad']==2     ||
									                             $someone2[0]['arrd05']['condicion_actividad']==2
									                           ){
	...
	//		$hora_comercial=0;
			...
			if(strtoupper($username) == 'ADMIN' || strtoupper($username) == 'DEMO' || ($count_username!=0 && $modulo_username=='0' && $cod_dep==1)) return true;
			else return false;
		}
		return false;

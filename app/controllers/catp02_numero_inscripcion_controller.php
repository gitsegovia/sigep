<?php
class Catp02NumeroInscripcionController extends AppController{
    var $uses = array('catd02_numero_inscripcion');
...
function verifica_SS($i){
	...
	function index($var=null){
	 $this->layout = "ajax";
	 $modelo="catd02_numero_inscripcion";
	 $modelo_url="catp02_numero_inscripcion";

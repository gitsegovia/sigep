<?php
 ...
 class Cugp02divisionController extends AppController{

	var $name = 'Cugp02division';
	var $uses = array('cugd02_institucion', 'cugd02_dependencia', 'cugd02_direccionsuperior', 'cugd02_coordinacion', 'cugd02_secretaria', 'cugd02_direccion', 'cugd02_division', 'v_cugd02_verificacion');
...
function index($institucion=null, $dependencia=null, $dir_superior=null, $coordinacion=null, $secretaria=null, $direccion=null, $selet=null, $boton=null){
...
if($selet!=null && $selet!='otros'){
		  	$sql_re = "cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia."  and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria." and cod_direccion=".$direccion."";
		  	$sql_selet = "cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion."  and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria." and cod_direccion=".$direccion." and cod_division=".$selet."";
		if($this->cugd02_division->findCount($sql_selet) != 0){
 			$data = $this->cugd02_division->findAll($sql_selet, null, null, null);
 			$denominacion =  $this->cugd02_division->generateList($sql_re, 'denominacion ASC', null, '{n}.cugd02_division.cod_division', '{n}.cugd02_division.denominacion');
 			$data_aux = $data;
 			foreach($data_aux as $data_aux_pre){}
 			if($boton=='modificar'){$this->set('selecion_division_2', $selet); $selet=$data_aux_pre['cugd02_division']['denominacion']; }
		}else{ $opcion = 'si'; }
			$this->set('selecion_division', $selet);


}else if($selet=='otros'){
			$opcion = 'si';
			$this->set('selecion_division','otros');
			$nume = $this->cugd02_division->findAll("cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria."  and cod_direccion=".$direccion."",null,'cod_division DESC');
			//pr($nume);
			if($nume == null){//echo 'hello';
				$numero = 1;
			}else{
				$numero = $nume[0]['cugd02_division']['cod_division'] + 1;
			}
			$this->set('numero',$numero);
			$depx = $this->cugd02_direccion->findAll("cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria."  and cod_direccion=".$direccion."");
			$fr = $depx[0]['cugd02_direccion']['funcionario_responsable'];
			$ug = $depx[0]['cugd02_direccion']['direccion'];
			$ca = $depx[0]['cugd02_direccion']['cod_area'];
			$tf = $depx[0]['cugd02_direccion']['telefonos'];
			$fa = $depx[0]['cugd02_direccion']['fax'];
			$em = $depx[0]['cugd02_direccion']['email'];
			$this->set('fr',$fr);
			$this->set('ug',$ug);
			$this->set('ca',$ca);
			$this->set('tf',$tf);
			...
			$consulta_division = $this->cugd02_division->generateList($sql_division, 'denominacion ASC', null, '{n}.cugd02_division.cod_division', '{n}.cugd02_division.denominacion');
	   		$denominacion =  $this->cugd02_division->generateList($sql_division, 'denominacion ASC', null, '{n}.cugd02_division.cod_division', '{n}.cugd02_division.denominacion');
...
function grabar($institucion=null, $dependencia=null, $dir_superior=null, $coordinacion=null, $secretaria=null, $direccion=null, $selet=null, $boton=null){
	...
	$denominacion='';
	 ...
	 if($institucion==null){$institucion=$this->data['cugp02division']['cod_institucion'];}
	 if($dependencia==null){$dependencia=$this->data['cugp02division']['cod_dependencia'];}
	 if($dir_superior==null){$dir_superior=$this->data['cugp02division']['cod_dir_superior'];}
	 if($coordinacion==null){$coordinacion=$this->data['cugp02division']['cod_coordinacion'];}
	 if($secretaria==null){$secretaria=$this->data['cugp02division']['cod_secretaria'];}
	 if($direccion==null){$direccion=$this->data['cugp02division']['cod_direccion'];}
	 if($selet==null){$selet=$this->data['cugp02division']['cod_division'];}


$sql_re = "cod_tipo_institucion=".$this->Session->read('SScodtipoinst')."and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria." and cod_direccion=".$direccion." and cod_division=".$selet."";
if($this->cugd02_division->findCount($sql_re) == 0){
$sql = "INSERT INTO cugd02_division (cod_tipo_institucion, cod_institucion, cod_dependencia, cod_dir_superior, cod_coordinacion, cod_secretaria, cod_direccion , cod_division, denominacion, funcionario_responsable, direccion, cod_area, telefonos, fax, email)   VALUES  ( '".$this->Session->read('SScodtipoinst')."',  '".$this->data['cugp02division']['cod_institucion']."',  '".$this->data['cugp02division']['cod_dependencia']."',  '".$this->data['cugp02division']['cod_dir_superior']."',  '".$this->data['cugp02division']['cod_coordinacion']."',  '".$this->data['cugp02division']['cod_secretaria']."',  '".$this->data['cugp02division']['cod_direccion']."',  '".$this->data['cugp02division']['cod_division']."', '".$this->data['cugp02division']['denominacion']."', '".$this->data['cugp02division']['funcionario_responsable']."', '".$this->data['cugp02division']['direccion']."', '".$this->data['cugp02division']['cod_area']."', '".$this->data['cugp02division']['telefonos']."', '".$this->data['cugp02division']['fax']."', '".$this->data['cugp02division']['email']."')";

$this->cugd02_division->execute($sql);
}else{
$sql ="UPDATE cugd02_division SET  denominacion = '".$this->data['cugp02division']['denominacion']."', funcionario_responsable = '".$this->data['cugp02division']['funcionario_responsable']."', direccion = '".$this->data['cugp02division']['direccion']."', cod_area = '".$this->data['cugp02division']['cod_area']."', telefonos = '".$this->data['cugp02division']['telefonos']."', fax = '".$this->data['cugp02division']['fax']."', email = '".$this->data['cugp02division']['email']."'   where cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$this->data['cugp02division']['cod_institucion']." and cod_dependencia=".$this->data['cugp02division']['cod_dependencia']."  and cod_dir_superior=".$this->data['cugp02division']['cod_dir_superior']." and cod_coordinacion=".$this->data['cugp02division']['cod_coordinacion']." and cod_secretaria=".$this->data['cugp02division']['cod_secretaria']." and cod_direccion=".$this->data['cugp02division']['cod_direccion']." and cod_division=".$this->data['cugp02division']['cod_division']."";
$this->cugd02_division->execute($sql);
...
if($selet!=null && $selet!='otros'){
		...
		if($this->cugd02_division->findCount($sql_selet) != 0){
			...
			if($direccion!=null){
			$sql_division = "cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria."  and cod_direccion=".$direccion."";
			if($this->cugd02_division->findCount($sql_direccion) != 0){
			$consulta_division = $this->cugd02_division->generateList($sql_division, 'denominacion ASC', null, '{n}.cugd02_division.cod_division', '{n}.cugd02_division.denominacion');
	   		$denominacion =  $this->cugd02_division->generateList($sql_division, 'denominacion ASC', null, '{n}.cugd02_division.cod_division', '{n}.cugd02_division.denominacion');
	   		$this->set('division', $consulta_division);
			}
...
function eliminar($institucion=null, $dependencia=null, $dir_superior=null, $coordinacion=null, $secretaria=null, $direccion=null, $selet=null, $boton=null){
	...
	$sql_re = "cod_presi=".$cod_presi."  and cod_entidad=".$cod_entidad."  and cod_tipo_inst=".$cod_tipo_inst."  and cod_inst=".$cod_inst."  and cod_dep=".$dependencia."  and cod_dir_superior=".$dir_superior."  and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria." and cod_direccion=".$direccion." and cod_division=".$selet."";
    if($this->v_cugd02_verificacion->findCount($sql_re)==0){
	   $sql= "DELETE  FROM  cugd02_division  WHERE cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior."  and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria." and cod_direccion=".$direccion."  and cod_division=".$selet." ";
	   $this->cugd02_division->execute($sql);
		$denominacion='';
    }else{
...
function consulta($pag_num=null) {
	...
	$cod_dep = $this->Session->read('SScoddep');
        ...
        if($cod_dep != 1){$sql_re .=  " and cod_institucion=".$cod_inst." and cod_dependencia=".$cod_dep;}
	 	 ...
	 	 $data = $this->cugd02_division->findAll($sql_re, null, 'denominacion ASC', null);
	 	 $this->set('data', $data);
		 $this->set('entidad_federal', $this->Session->read('entidad_federal'));
		 $this->set('cod_tipo_institucion', $this->Session->read('SScodtipoinst'));
		 $this->set('cod_entidad', $this->Session->read('SScodentidad'));

 ...
 *
 */
 class InfoCnmp06DatosPersonalesConsultaController extends AppController {
   var $name = 'info_cnmp06_datos_personales_consulta';
...
//------------consulta para obtener el numero de nomina-------------

$numero_nomina_aux = $this->cnmd06_datos_personales->execute("
		
	SELECT MAX(numero_nomina) as numero 
		FROM cnmd08_historia_transacciones
		WHERE 
...
foreach ($numero_nomina_aux as $key => $value) {
...
$datos2 = $this->cnmd06_datos_personales->execute("
			...
			FROM
					 ...
					 cnmd08_historia_transacciones         a

			WHERE
					a.cod_dep          = '".$cod_dep."'          and
					a.cod_tipo_nomina  = '".$cod_tipo_nomina."'  and
					a.cod_cargo        = '".$cod_cargo."'        and
					a.cod_ficha        = '".$cod_ficha."' 	     and 
					a.numero_nomina    = '".$numero_aux."'

;");

///(select MAX(numero_nomina) from cnmd08_historia_transacciones where cod_tipo_nomina='".$cod_tipo_nomina."' and cod_dep='".$cod_dep."')

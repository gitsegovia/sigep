<?php
class Cnmp17FideicomisoTransaIncluController extends AppController{
...
//	$tipo=$this->cnmd03_transacciones->generateList2("cod_tipo_transaccion=1", 'cod_transaccion ASC', null, '{n}.cnmd03_transacciones.cod_transaccion', '{n}.cnmd03_transacciones.denominacion');
	$tipo=$this->cnmd03_transacciones->generateList("cod_tipo_transaccion=1 and cod_transaccion=5", 'cod_transaccion ASC', null, '{n}.cnmd03_transacciones.cod_transaccion', '{n}.cnmd03_transacciones.denominacion');
...
function grilla($var=null){
	...
	if((isset($var) && $var!="") && $cod!=""){
		...
		$datos=$this->cnmd09_asignacion_calcula_asignacion_2->findAll($cond,null,null);
		if(!$datos){
			$this->set('datos',"");
		}else{
			$this->set('datos',$datos);

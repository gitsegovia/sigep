<?php
 ...
 class Crcp01ActasMatrimonioController extends AppController{


 	var $uses = array('ccfd04_cierre_mes','crcd01_actas_plantillas','crcd01_actas_matrimonio');
...
function index () {
    $this->layout="ajax";
    $lista = $this->crcd01_actas_plantillas->generateList($this->SQLCA()." and tipo_plantilla=5", 'titulo_tipo_acta ASC', null, '{n}.crcd01_actas_plantillas.cod_plantilla', '{n}.crcd01_actas_plantillas.titulo_tipo_acta');
	if($this->crcd01_actas_plantillas->findCount($this->SQLCA()." and tipo_plantilla=5")!=0){
...
function guardar () {
	...
	if(!empty($this->params['form'])){
         if(!empty($this->params['form']['contenido_acta'])){
	         ...
	         $valores[]="'".date('Y-m-d')."'";
	         $valores[]="'".$this->params['form']['cedula_novia']."'";
	         $valores[]="'".$this->params['form']['nombres_novia']."'";
	         $valores[]="'".$this->params['form']['cedula_novio']."'";
	         $valores[]="'".$this->params['form']['nombres_novio']."'";
	         $valores[]="'".$this->params['form']['cedula_testigo']."'";
	         $valores[]="'".$this->params['form']['nombres_testigo']."'";
	         $valores[]="'".$ano."'";
	         $valores[]="'".$tomo."'";
	         $valores[]="'".$folio."'";
             $in = $this->crcd01_actas_matrimonio->insertar($valores,$cod_acta);
            if($in>0){
...
function consultar () {
   $this->layout="ajax";
   $datos = $this->crcd01_actas_matrimonio->findAll($this->SQLCA(),'cod_acta, nombres_apellidos_novia,nombres_apellidos_novio', 'nombres_apellidos_novia,nombres_apellidos_novio asc');
...
function ver ($cod_acta) {
   $this->layout="ajax";
   $this->set('datos',$this->crcd01_actas_matrimonio->findAll($this->SQLCA()." and cod_acta='".$cod_acta."'"));
}
...
function guardar_modificar () {
	...
	if(!empty($this->params['form'])){
         if(!empty($this->params['form']['contenido_acta'])){
	         ...
	         $valores[]=" cedula_novia='".$this->params['form']['cedula_novia']."'";
	         $valores[]=" nombres_apellidos_novia='".$this->params['form']['nombres_novia']."'";
	         $valores[]=" cedula_novio='".$this->params['form']['cedula_novio']."'";
	         $valores[]=" nombres_apellidos_novio='".$this->params['form']['nombres_novio']."'";
	         $valores[]=" cedula_testigo='".$this->params['form']['cedula_testigo']."'";
	         $valores[]=" nombres_apellidos_testigo='".$this->params['form']['nombres_testigo']."'";

             $in = $this->crcd01_actas_matrimonio->modificar($valores,$cod_acta);
            if($in>0){
...
function eliminar ($cod_acta) {
   $this->layout="ajax";
   $r=$this->crcd01_actas_matrimonio->execute("DELETE FROM crcd01_actas_matrimonio WHERE ".$this->SQLCA()." and cod_acta='".$cod_acta."'");
   if($r>0){

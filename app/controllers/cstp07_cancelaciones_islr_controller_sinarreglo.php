...
if(isset($this->data['cstp07_cancelaciones_islr']['ano_orden_pago_'.$var_aux])){
							...
							if($ve2[0]['ano_orden_pago']    == $this->data['cstp07_cancelaciones_islr']['ano_orden_pago_'.$var_aux] &&
							   $ve2[0]['numero_orden_pago'] == $this->data['cstp07_cancelaciones_islr']['numero_orden_pago_'.$var_aux]
							){
...
if(file_exists('../webroot/descargas/isrl_'.$cod_dep.'_'.date('d_m_Y').'.xml')){chmod('../webroot/descargas/isrl_'.$cod_dep.'_'.date('d_m_Y').'.xml', 0777);}

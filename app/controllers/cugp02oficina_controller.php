<?php
 ...
 class Cugp02oficinaController extends AppController{

	var $name = 'Cugp02oficina';
	var $uses = array('cugd02_institucion', 'cugd02_dependencia', 'cugd02_direccionsuperior', 'cugd02_coordinacion', 'cugd02_secretaria', 'cugd02_direccion', 'cugd02_division', 'cugd02_departamento', 'cugd02_oficina', 'v_cugd02_verificacion');
...
function index($institucion=null, $dependencia=null, $dir_superior=null, $coordinacion=null, $secretaria=null, $direccion=null, $division=null, $departamento=null, $selet=null, $boton=null){
...
if($departamento!=null){
        	...
        	$this->set('selecion_departamento', $departamento);
        	//$opcion = 'si';
}else{
	if($division==null){
			...
			$sql_departamento="cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior."  and cod_coordinacion=".$coordinacion."  and cod_secretaria=".$secretaria." and cod_direccion=".$direccion." and cod_division=".$division."   ";
        	$this->set('selecion_departamento', '');
           	if($this->cugd02_departamento->findCount($sql_division) != 0){
        	$consulta_departamento = $this->cugd02_departamento->generateList($sql_departamento, 'denominacion ASC', null, '{n}.cugd02_departamento.cod_departamento', '{n}.cugd02_departamento.denominacion');
	   		$this->set('departamento', $consulta_departamento);
	   		}else{$this->set('departamento', 'vacio');}
			//$opcion = 'si';
		}
}//fin else
...
if($selet!=null && $selet!='otros'){
		  	$sql_re = "cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia."  and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria." and cod_direccion=".$direccion." and cod_division=".$division." and cod_departamento=".$departamento."";
		  	$sql_selet = "cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion."  and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria." and cod_direccion=".$direccion." and cod_division=".$division." and cod_departamento=".$departamento." and cod_oficina=".$selet."";
		if($this->cugd02_oficina->findCount($sql_selet) != 0){
 			$data = $this->cugd02_oficina->findAll($sql_selet, null, null, null);
 			$denominacion =  $this->cugd02_oficina->generateList($sql_re, 'denominacion ASC', null, '{n}.cugd02_oficina.cod_oficina', '{n}.cugd02_oficina.denominacion');
 			$data_aux = $data;
 			foreach($data_aux as $data_aux_pre){}
 			if($boton=='modificar'){$this->set('selecion_oficina_2', $selet); $selet=$data_aux_pre['cugd02_oficina']['denominacion']; }
		}else{ $opcion = 'si'; }
			$this->set('selecion_oficina', $selet);


}else if($selet=='otros'){
			$opcion = 'si';
			$this->set('selecion_oficina','otros');
			$nume = $this->cugd02_oficina->findAll("cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria."  and cod_direccion=".$direccion."  and cod_division=".$division." and cod_departamento=".$departamento."",null,'cod_oficina DESC');
			//pr($nume);
			if($nume == null){//echo 'hello';
				$numero = 1;
			}else{
				$numero = $nume[0]['cugd02_oficina']['cod_oficina'] + 1;
			}
			$this->set('numero',$numero);
			$depx = $this->cugd02_departamento->findAll("cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria."  and cod_direccion=".$direccion."  and cod_division=".$division." and cod_departamento=".$departamento."");
			$fr = $depx[0]['cugd02_departamento']['funcionario_responsable'];
			$ug = $depx[0]['cugd02_departamento']['direccion'];
			$ca = $depx[0]['cugd02_departamento']['cod_area'];
			$tf = $depx[0]['cugd02_departamento']['telefonos'];
			$fa = $depx[0]['cugd02_departamento']['fax'];
			$em = $depx[0]['cugd02_departamento']['email'];
			$this->set('fr',$fr);
			$this->set('ug',$ug);
			$this->set('ca',$ca);
			$this->set('tf',$tf);
			...
			if($departamento!=null){
			$sql_oficina = "cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria."  and cod_direccion=".$direccion."  and cod_division=".$division." and cod_departamento=".$departamento."";
			if($this->cugd02_oficina->findCount($sql_oficina) != 0){
			$consulta_oficina = $this->cugd02_oficina->generateList($sql_oficina, 'denominacion ASC', null, '{n}.cugd02_oficina.cod_oficina', '{n}.cugd02_oficina.denominacion');
	   		$denominacion =  $this->cugd02_oficina->generateList($sql_oficina, 'denominacion ASC', null, '{n}.cugd02_oficina.cod_oficina', '{n}.cugd02_oficina.denominacion');
	   		$this->set('oficina', $consulta_oficina);
			}
		}

			$this->set('selecion_oficina','');
			$opcion = 'si';
}
...
function grabar($institucion=null, $dependencia=null, $dir_superior=null, $coordinacion=null, $secretaria=null, $direccion=null, $division=null, $departamento=null, $selet=null, $boton=null){
	...
	$cod_dep = $this->Session->read('SScoddep');
	 ...
	 if($institucion==null){$institucion=$this->data['cugp02oficina']['cod_institucion'];}
	 if($dependencia==null){$dependencia=$this->data['cugp02oficina']['cod_dependencia'];}
	 if($dir_superior==null){$dir_superior=$this->data['cugp02oficina']['cod_dir_superior'];}
	 if($coordinacion==null){$coordinacion=$this->data['cugp02oficina']['cod_coordinacion'];}
	 if($secretaria==null){$secretaria=$this->data['cugp02oficina']['cod_secretaria'];}
	 if($direccion==null){$direccion=$this->data['cugp02oficina']['cod_direccion'];}
	 if($division==null){$division=$this->data['cugp02oficina']['cod_division'];}
	 if($departamento==null){$departamento=$this->data['cugp02oficina']['cod_departamento'];}
	 if($selet==null){$selet=$this->data['cugp02oficina']['cod_oficina'];}


$sql_re = "cod_tipo_institucion=".$this->Session->read('SScodtipoinst')."and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior." and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria." and cod_direccion=".$direccion." and cod_division=".$division." and cod_departamento=".$departamento." and cod_oficina=".$selet." ";
if($this->cugd02_oficina->findCount($sql_re) == 0){
$sql = "INSERT INTO cugd02_oficina (cod_tipo_institucion, cod_institucion, cod_dependencia, cod_dir_superior, cod_coordinacion, cod_secretaria, cod_direccion , cod_division, cod_departamento, cod_oficina, denominacion, funcionario_responsable, direccion, cod_area, telefonos, fax, email)   VALUES  ( '".$this->Session->read('SScodtipoinst')."',  '".$this->data['cugp02oficina']['cod_institucion']."',  '".$this->data['cugp02oficina']['cod_dependencia']."',  '".$this->data['cugp02oficina']['cod_dir_superior']."',  '".$this->data['cugp02oficina']['cod_coordinacion']."',  '".$this->data['cugp02oficina']['cod_secretaria']."',  '".$this->data['cugp02oficina']['cod_direccion']."',  '".$this->data['cugp02oficina']['cod_division']."',  '".$this->data['cugp02oficina']['cod_departamento']."',  '".$this->data['cugp02oficina']['cod_oficina']."', '".$this->data['cugp02oficina']['denominacion']."', '".$this->data['cugp02oficina']['funcionario_responsable']."', '".$this->data['cugp02oficina']['direccion']."', '".$this->data['cugp02oficina']['cod_area']."', '".$this->data['cugp02oficina']['telefonos']."', '".$this->data['cugp02oficina']['fax']."', '".$this->data['cugp02oficina']['email']."')";

$this->cugd02_oficina->execute($sql);
}else{
$sql ="UPDATE cugd02_oficina SET  denominacion = '".$this->data['cugp02oficina']['denominacion']."', funcionario_responsable = '".$this->data['cugp02oficina']['funcionario_responsable']."', direccion = '".$this->data['cugp02oficina']['direccion']."', cod_area = '".$this->data['cugp02oficina']['cod_area']."', telefonos = '".$this->data['cugp02oficina']['telefonos']."', fax = '".$this->data['cugp02oficina']['fax']."', email = '".$this->data['cugp02oficina']['email']."'   where cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$this->data['cugp02oficina']['cod_institucion']." and cod_dependencia=".$this->data['cugp02oficina']['cod_dependencia']."  and cod_dir_superior=".$this->data['cugp02oficina']['cod_dir_superior']." and cod_coordinacion=".$this->data['cugp02oficina']['cod_coordinacion']." and cod_secretaria=".$this->data['cugp02oficina']['cod_secretaria']." and cod_direccion=".$this->data['cugp02oficina']['cod_direccion']." and cod_division=".$this->data['cugp02oficina']['cod_division']." and cod_departamento=".$this->data['cugp02oficina']['cod_departamento']." and cod_oficina=".$this->data['cugp02oficina']['cod_oficina']."";
$this->cugd02_oficina->execute($sql);
...
function eliminar($institucion=null, $dependencia=null, $dir_superior=null, $coordinacion=null, $secretaria=null, $direccion=null, $division=null, $departamento=null, $selet=null, $boton=null){
    ...
    if($this->v_cugd02_verificacion->findCount($sql_re)==0){
		$sql= "DELETE  FROM  cugd02_oficina  WHERE cod_tipo_institucion=".$this->Session->read('SScodtipoinst')." and cod_institucion=".$institucion." and cod_dependencia=".$dependencia." and cod_dir_superior=".$dir_superior."  and cod_coordinacion=".$coordinacion." and cod_secretaria=".$secretaria." and cod_direccion=".$direccion."  and cod_division=".$division." and cod_departamento=".$departamento."  and cod_oficina=".$selet." ";
		$this->cugd02_oficina->execute($sql);
		$denominacion='';
    }else{
...
function consulta($pag_num=null) {
	...
	$cod_dep = $this->Session->read('SScoddep');
		 ...
		 $sql_re = "cod_tipo_institucion=".$this->Session->read('SScodtipoinst').""." and cod_institucion=".$this->Session->read('SScodinst')."";
	 	 ...
	 	 $departamento = $this->cugd02_departamento->findAll($sql_re, null, 'denominacion ASC', null);
	 	 $this->set('var_departamento',$departamento);

	 	 $data = $this->cugd02_oficina->findAll($sql_re, null, 'denominacion ASC', null);
	 	 $this->set('data', $data);
		 $this->set('entidad_federal', $this->Session->read('entidad_federal'));
		 $this->set('cod_tipo_institucion', $this->Session->read('SScodtipoinst'));
		 $this->set('cod_entidad', $this->Session->read('SScodentidad'));

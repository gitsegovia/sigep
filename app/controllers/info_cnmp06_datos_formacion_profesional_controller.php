<?php
 class InfoCnmp06DatosFormacionProfesionalController extends AppController {
   var $name = 'info_cnmp06_datos_formacion_profesional';
...
function modificar($cedula=null,$consecutivo=null,$cod_curso=null,$pagina=null){
	  		$this->layout = "ajax";
	  		$this->set('pagina',$pagina);
...
function guardar_modificar($cedula=null,$consecutivo=null,$cod_cursos=null,$pagina=null){
	$this->layout = "ajax";
	if(!empty($this->data)){
	 $cod_curso=$this->data['cnmp06_datos_formacion_profesional']['cod_curso'];
	 $cod_institucion=$this->data['cnmp06_datos_formacion_profesional']['cod_institucion'];
...
$this->layout = "ajax";
        switch($var1){
                case "curso":{
                	$listacurso=$this->cnmd06_cursos->generateList("upper(denominacion) LIKE upper('%$var2%')", 'denominacion ASC', null, '{n}.cnmd06_cursos.cod_curso', '{n}.cnmd06_cursos.denominacion');

<?php
class Caop04OrdencompraController extends AppController {
   ...
   var $uses = array('cscd05_consumo_productos_dep','cscd05_consumo_productos_inst', 'v_cotizacion_solicitud', 'ccfd04_cierre_mes',
                     ...
                     'cugd03_acta_anulacion_numero', 'cugd03_acta_anulacion_cuerpo', 'v_cfpd05_denominaciones', 'v_cscd03_cotizacion_rif', 'cfpd07_obras_cuerpo',
                     'v_cscd03_cotizacion_anulada', 'v_cscd04_rif', 'cscd03_cotizacion_encabezado_anulado', 'v_cscd02_relacion', 'cfpd07_obras_partidas',
                     ...
                     'cepd03_ordenpago_cuerpo', 'cugd02_direccionsuperior','cugd02_dependencia','cscd01_unidad_medida', 'v_catalgo_reporte_tipo_grupo',

                            'cstd01_entidades_bancarias', 'ccfd10_descripcion', 'ccfd10_detalles', 'ccfd02', 'ccfd05_numero_asiento',
                            'ccfd04_cuentas_enlace', 'cpcd02', 'cepd01_compromiso_cuerpo', 'cscd04_ordencompra_anticipo_cuerpo', 'v_cscd04_deuda_proveedores_cod_obra',
                            'cscd04_ordencompra_encabezado', 'cscd04_ordencompra_autorizacion_cuerpo', 'cstd03_cheque_cuerpo',
						    ...
						    'cscd05_c_institucion_cod_obra', 'cscd05_c_productos_inst_cod_obra', 'cscd05_c_productos_cod_obra','cscd05_c_direcciones_cod_obra',
						    'cscd05_c_productos_dep_cod_obra'
...
function index($var=null){///////////////<<--INDEX
	 $this->layout = "ajax";
	$this->Session->write('autor_valido',true);// Session Temporal para las pruebas... recordar quitar!!!
...
function index2(){
  ...
  $listaRif = $this->v_cscd04_rif->generateList($conditions = $this->condicion()." and ano_cotizacion =".$ano_arranque." and numero_ordencompra=0"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL) ", $order = 'numero_cotizacion ASC', $limit = null, '{n}.v_cscd04_rif.rif', '{n}.v_cscd04_rif.denominacion');
  ...
  $lista = $this->v_cscd03_cotizacion_rif->generateList($conditions = $condicion." and ano_cotizacion =".$ano_arranque." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL) ", $order = 'numero_cotizacion ASC', $limit = null, '{n}.v_cscd03_cotizacion_rif.numero_cotizacion', '{n}.v_cscd03_cotizacion_rif.denominacion');
  ...
  if(!empty($numero_orden_compra)){
  	...
  	$this->redirect('/caop04_ordencompra_numero/index/null/1');
...
function agregar_partidas($var=null) {
	...
	if(isset($var) && !empty($var)){
			...
			//print_r($this->params);
			//echo "holaaaaaaa";
            $cod[0]=$this->data["caop04_ordencompra"]["ano_partidas"];
			$cod[1]=$this->data["caop04_ordencompra"]["cod_sector"];
			$cod[2]=$this->data["caop04_ordencompra"]["cod_programa"];
			$cod[3]=$this->data["caop04_ordencompra"]["cod_subprograma"];
			$cod[4]=$this->data["caop04_ordencompra"]["cod_proyecto"];
			$cod[5]=$this->data["caop04_ordencompra"]["cod_actividad"];
			$cod[6]=$this->data["caop04_ordencompra"]["cod_partida"];
			if($cod[6]<9){
				$cod[6]="40".$cod[6];
			}else if($cod[6]<100){
				$cod[6]="4".$cod[6];
			...
			$cod[7]=$this->data["caop04_ordencompra"]["cod_generica"];
			$cod[8]=$this->data["caop04_ordencompra"]["cod_especifica"];
			$cod[9]=$this->data["caop04_ordencompra"]["cod_subespecifica"];
			$cod[10]=$this->data["caop04_ordencompra"]["cod_auxiliar"];//
			$cod[10]=$cod[10]<9?str_replace("0","",$cod[10]):$cod[10];
			$cod[10]=$cod[10]<9?"0".$cod[10]:$cod[10];
			$cod[11]=$this->data["caop04_ordencompra"]["monto_partidas"];
		    if(isset($_SESSION["i"])){
        ...
        switch($var){
        	case 'normal':
					 $vec[$i][0]=$this->data["caop04_ordencompra"]["ano_partidas"];
					 $vec[$i][1]=$this->data["caop04_ordencompra"]["cod_sector"];
					 $vec[$i][2]=$this->data["caop04_ordencompra"]["cod_programa"];
					 $vec[$i][3]=$this->data["caop04_ordencompra"]["cod_subprograma"];
					 $vec[$i][4]=$this->data["caop04_ordencompra"]["cod_proyecto"];
					 $vec[$i][5]=$this->data["caop04_ordencompra"]["cod_actividad"];
					 $vec[$i][6]=$this->data["caop04_ordencompra"]["cod_partida"];//<9 ? "4.0".$this->data["cepp01_compromiso_partidas"]["cod_partida"] : "4.".$this->data["cepp01_compromiso_partidas"]["cod_partida"];
					 $vec[$i][7]=$this->data["caop04_ordencompra"]["cod_generica"];
					 $vec[$i][8]=$this->data["caop04_ordencompra"]["cod_especifica"];
					 $vec[$i][9]=$this->data["caop04_ordencompra"]["cod_subespecifica"];
					 $vec[$i][10]=$this->AddCeroR($this->data["caop04_ordencompra"]["cod_auxiliar"]);
					 $vec[$i][11]=$this->data["caop04_ordencompra"]["monto_partidas"];
					 $vec[$i]["id"]=$i;
	...
	if ($_SESSION["ano"]!=null && $_SESSION["sec"]!=null && $_SESSION["prog"]!=null && $_SESSION["subp"]!=null && $_SESSION["proy"]!=null && $_SESSION["actividad"]!=null && $partida!=null && $_SESSION["cgen"]!=null && $_SESSION["cesp"]!=null && $_SESSION["csesp"]!=null && $monto!=null && $_SESSION["auxiliar"]!=null){
		...
		if($trafico['color'] == 'rojo' && $trafico['username']!= $username){
			...
			$disponibilidad = $this->disponibilidad($_SESSION["ano"], $_SESSION["sec"], $_SESSION["prog"], $_SESSION["subp"], $_SESSION["proy"], $_SESSION["actividad"], $partida, $_SESSION["cgen"], $_SESSION["cesp"], $_SESSION["csesp"], $_SESSION["auxiliar"]);
              ...
              $ano               = $_SESSION["ano"];
			  $cod_sector        = $_SESSION["sec"];
			  $cod_programa      = $_SESSION["prog"];
			  $cod_sub_prog      = $_SESSION["subp"];
			  $cod_proyecto      = $_SESSION["proy"];
			  $cod_activ_obra    = $_SESSION["actividad"];
			  $cod_partida       = $partida;
			  $cod_generica      = $_SESSION["cgen"];
			  $cod_especifica    = $_SESSION["cesp"];
			  $cod_sub_espec     = $_SESSION["csesp"];
			  $cod_auxiliar      = $_SESSION["auxiliar"];

			  $acepta = 0;


			$caop02_codigo_obra     =  $this->Session->read("caop02_codigo_obra");
			$cfpd07_obras_partidas  =  $this->cfpd07_obras_partidas->findAll($this->condicion()." and ano_estimacion='".$ano."'  and upper(cod_obra)='".strtoupper_sisap($caop02_codigo_obra)."' and  cod_sector='".$cod_sector."' and cod_programa='".$cod_programa."' and cod_sub_prog='".$cod_sub_prog."' and cod_proyecto='".$cod_proyecto."' and cod_activ_obra='".$cod_activ_obra."' and cod_partida='".$cod_partida."' and cod_generica='".$cod_generica."' and cod_especifica='".$cod_especifica."' and cod_sub_espec='".$cod_sub_espec."' and cod_auxiliar='".$cod_auxiliar."' ", null, 'cod_obra DESC');
			$acepta = 0;
			foreach($cfpd07_obras_partidas as $ve3){
			  ...
			  $monto_aux           = ($monto_contratado_2 + $aumento_obras_2 + $monto) - $disminucion_obras_2;
...
function cotizar($rif=null){
	...
	if($rif!=null){
		...
		$lista = $this->v_cotizacion_solicitud->generateList($conditions = $this->condicion()." and ano_cotizacion =".$ano_arranque." and numero_ordencompra=0 and mayus_acentos(rif)=mayus_acentos('$rif')"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL) ", $order = 'numero_cotizacion ASC', $limit = null, '{n}.v_cotizacion_solicitud.numero_cotizacion', '{n}.v_cotizacion_solicitud.numero_cotizacion');
...
function direccionsolicitante($num_cotizacion=null){
  $this->layout="ajax";
  ...
  $cod_inst = $this->Session->read('SScodinst');
  $cod_dep = $this->Session->read('SScoddep');
    $numsolicitud = $this->cscd03_cotizacion_encabezado->field('cscd03_cotizacion_encabezado.numero_solicitud', $conditions = $this->condicion()." and ano_solicitud='".$this->ano_ejecucion()."'  and cscd03_cotizacion_encabezado.numero_cotizacion='$num_cotizacion'", $order ="numero_cotizacion ASC");
...
function auxiliar($i=null, $ano=null, $cod_sector=null, $cod_programa=null, $cod_sub_prog=null, $cod_proyecto=null, $cod_partida=null, $cod_generica=null, $cod_especifica=null, $cod_sub_espec=null, $monto=null, $numero_cotizacion=null, $rif=null, $cod_activ_obra=null){
  ...
  if($cod_activ_obra != null){
	$caop02_codigo_obra = $this->Session->read("caop02_codigo_obra");
	$sql_select_aux = "SELECT DISTINCT a.cod_auxiliar,
			                           (SELECT DISTINCT b.deno_auxiliar FROM v_balance_ejecucion b WHERE  b.cod_sector='$cod_sector' and b.cod_programa='$cod_programa' and b.cod_sub_prog='$cod_sub_prog' and b.cod_proyecto='$cod_proyecto' and b.cod_activ_obra=a.cod_activ_obra and b.cod_partida='$cod_partida' and b.cod_generica='$cod_generica' and b.cod_especifica='$cod_especifica' and b.cod_sub_espec='$cod_sub_espec' and b.ano='$ano' and b.cod_auxiliar=a.cod_auxiliar  and ". $this->condicion()." ) as deno_auxiliar
			                            FROM cfpd07_obras_partidas a WHERE  a.ano_estimacion='".$ano."' and upper(a.cod_obra)='".strtoupper_sisap($caop02_codigo_obra)."' and  a.cod_sector='$cod_sector' and a.cod_programa='$cod_programa' and a.cod_sub_prog='$cod_sub_prog' and a.cod_proyecto='$cod_proyecto' and a.cod_activ_obra='$cod_activ_obra' and a.cod_partida='$cod_partida' and a.cod_generica='$cod_generica' and a.cod_especifica='$cod_especifica' and a.cod_sub_espec='$cod_sub_espec'  and ". $this->condicion()." order by a.cod_auxiliar";
...
function anular($numero_orden_compra=null, $ano=null, $page=null, $fd=null, $num_cotizacion=null){
	...
	$cod_presi = $this->Session->read('SScodpresi');
  	...
  	$cod_dep = $this->Session->read('SScoddep');
	if($numero_orden_compra != null){
		$concepto = $this->data['caop04_ordencompra']['concepto_anulacion'];
       ...
       $this->cscd03_cotizacion_cuerpo->execute("BEGIN;");
		...
		foreach($cotizacion_encabezado as $ct1){
			...
			$cod_obra = $ct1['cscd03_cotizacion_encabezado']['cod_obra'];
		...
		if($sw1 > 1){//IF LUEGO DE COMPROBAR QUE SE GUARDARON LAS TABLAS CSCD03_COTIZACION_ANULACION
			foreach ($partidas as $row){
				...
				$ano_[$i] = $row['cscd04_ordencompra_partidas']['ano_orden_compra'];
				$cod_sector_[$i] = $row['cscd04_ordencompra_partidas']['cod_sector'];
				$cod_programa_[$i] = $row['cscd04_ordencompra_partidas']['cod_programa'];
				$cod_sub_prog_[$i] = $row['cscd04_ordencompra_partidas']['cod_sub_prog'];
				$cod_proyecto_[$i] = $row['cscd04_ordencompra_partidas']['cod_proyecto'];
				$cod_activ_obra_[$i] = $row['cscd04_ordencompra_partidas']['cod_activ_obra'];
				$cod_partida_[$i] = $row['cscd04_ordencompra_partidas']['cod_partida'];
				$cod_generica_[$i] = $row['cscd04_ordencompra_partidas']['cod_generica'];
				$cod_especifica_[$i] = $row['cscd04_ordencompra_partidas']['cod_especifica'];
				$cod_sub_espec_[$i] = $row['cscd04_ordencompra_partidas']['cod_sub_espec'];
				$cod_auxiliar_[$i] = $row['cscd04_ordencompra_partidas']['cod_auxiliar'];
				...
				$sw455   = $this->cfpd07_obras_cuerpo->execute("UPDATE cfpd05 SET precompromiso_obras=precompromiso_obras+".$row['cscd04_ordencompra_partidas']['monto']." where ".$sql_aux);
			...
			if($sw2 > 1){//IF LUEGO DE ACTUALIZAR EN LAS TABLAS CSCD04_ORDENCOMPRA Y CSCD03_COTIZACION_ENCABEZADO
				...
				if($sw3 > 1){//IF LUEGO DE ACTUALIZAR EL NUMERO DE LA ORDEN DE COMPRA CSCD04_ORDENCOMPRA_NUMERO
					//$fd = $this->Cfecha($fd,"D/M/A");
					$caso = 1;
					$sum_monto = 0;
					for($i=0;$i<count($cp);$i++){

                            $num_asiento_compromiso = $this->motor_presupuestario($cp[$i],2, 3, 2, date("d/m/Y"), $monto[$i], $concepto, $ano, $numero_orden_compra, null, null, null, null, null, null, null, $numero_asiento_compromiso[$i], null, null, null, null, null, null);

                            $sum_monto += $monto[$i];

                              $sql_aux = "cod_presi=".$cod_presi." and cod_entidad=".$cod_entidad." and cod_tipo_inst=".$cod_tipo_inst." and  cod_inst=".$cod_inst." and cod_dep=".$cod_dep." and ano_estimacion=".$ano." and upper(cod_obra)='".strtoupper($cod_obra)."' and cod_sector=".$cod_sector_[$i]."   and   cod_programa=".$cod_programa_[$i]."   and   cod_sub_prog=".$cod_sub_prog_[$i]."   and   cod_proyecto=".$cod_proyecto_[$i]."   and   cod_activ_obra=".$cod_activ_obra_[$i]."   and   cod_partida=".$cod_partida_[$i]."   and   cod_generica=".$cod_generica_[$i]."   and   cod_especifica=".$cod_especifica_[$i]."   and   cod_sub_espec=".$cod_sub_espec_[$i]."   and   cod_auxiliar=".$cod_auxiliar_[$i].";";
				              $sw455 = $this->cfpd07_obras_partidas->execute("UPDATE cfpd07_obras_partidas SET monto_contratado=monto_contratado-".$monto[$i]." where ".$sql_aux);
				              ...
				              $sw455 = $this->cfpd07_obras_cuerpo->execute("UPDATE cfpd07_obras_cuerpo SET monto_contratado=monto_contratado-".$monto[$i]." where ".$sql_aux);


				              if($sw455>1){
				              	 $num_asiento_compromiso = true;
				              }else{
				              	 $num_asiento_compromiso = false;
				              }
                           if($num_asiento_compromiso==true){ }else{ $caso=0; break;}
                    }


                    if($caso==1){

					    $valor_motor_contabilidad =  $this->motor_contabilidad_fiscal($to=2,
					                                                                  $td=5,
					                                                                  $rif_doc=$rif,
					                                                                  $ano_dc=$ano,
					                                                                  ...
					                                                                  $cpt_dc=$concepto,
					                                                                  $ben_dc=null,
					                                                                  $mon_dc=array("monto"=>$sum_monto), $ano_op=null, $n_op=null, $f_op=null, $a_adj_op=null, $n_adj_op=null, $f_adj_op=null, $tp_op=null, $deno_ban_pago=null, $ano_movimiento  = null, $cod_ent_pago=null, $cod_suc_pago=null, $cod_cta_pago=null, $num_che_o_debi=null, $fec_che_o_debi=null, $clas_che_o_debi=null);
  ...
  $disponibilidad = ($monto_2 + $aumento_obras_2)-($disminucion_obras_2+$monto_contratado_2);
   ...
   if($disponibilidad>=$monto){
	...
	if($acepta==0){
		...
		$this->set('errorMessage', "la disponibilidad para la partida es: ".$this->Formato2($disponibilidad));
		return;
	}else{
		echo "<script>";
...
function trafico($ano=null, $cod_sector=null, $cod_programa=null, $cod_sub_prog=null, $cod_proyecto=null, $cod_activ_obra=null, $cod_partida=null, $cod_generica=null, $cod_especifica=null, $cod_sub_espec=null, $monto=null, $cod_auxiliar=null){
	...
	/*
					...
					if ($ano!=null && $cod_sector!=null && $cod_programa!=null && $cod_sub_prog!=null && $cod_proyecto!=null && $cod_activ_obra!=null && $cod_partida!=null && $cod_generica!=null && $cod_especifica!=null && $cod_sub_espec!=null && $monto!=null && $cod_auxiliar!=null){
						...
						//echo "el username es: ".$trafico['username']." y el color es: ".$trafico['color'];ç
...
function guardar(){
	...
	if(!empty($this->data['caop04_ordencompra'])){
		$ano_orden_compra              =  $this->data['caop04_ordencompra']['ano_orden'];
		$ann                           =  $ano_orden_compra;
		$ano                           =  $ann;
		$tipo_orden                    =  $this->data['caop04_ordencompra']['tipo_ordencompra'];
		$rif                           =  strtoupper($this->data['caop04_ordencompra']['rif']);
		$ano_cotizacion                =  $this->data['caop04_ordencompra']['ano_cotizacion'];
		$numero_cotizacion             =  $this->data['caop04_ordencompra']['num_compra'];
		$ccp                           =  $this->cscd02_solicitud_encabezado->field('cscd02_solicitud_encabezado.uso_destino', $conditions = $this->condicion()." and cscd02_solicitud_encabezado.numero_cotizacion='".$numero_cotizacion."' and  cscd02_solicitud_encabezado.ano_cotizacion='".$ano_cotizacion."'  ", $order =null);
		$lugar_entrega                 =  $this->data['caop04_ordencompra']['lugar'];
		$plazo_entrega                 =  $this->data['caop04_ordencompra']['plazo'];
		$username_registro             =  $this->Session->read('nom_usuario');
		$fecha_proceso_registro        =  $this->data['caop04_ordencompra']['fecha_ordencompra'];
		$fd                            =  $this->data['caop04_ordencompra']['fecha_ordencompra'];
		...
		$numero_orden_compra           =  $this->data['caop04_ordencompra']['num_ordencompra'];
		$ndo                           =  $numero_orden_compra;

		$pregunta_ejercicio       =       $this->data['caop04_ordencompra']['pregunta_ejercicio'];


		if(isset($this->data['caop04_ordencompra']['manual'])){
			$manual = $this->data['caop04_ordencompra']['manual'];
		}
        $auto = $this->data['caop04_ordencompra']['auto'];
		$iva = $this->Formato1($this->data['caop04_ordencompra']['iva']);
		if(empty($iva)){
									         ...
									         if($s_cotizacion>1){
																	...
																	foreach($new_array as $cod){
																		...
																		foreach($cfpd07_obras_partidas as $ve3){
																	     ...
																	     if($acepta==0){
//																	     	echo $ano.".".$cod_sector.".".$cod_programa.".".$cod_sub_prog.".".$cod_proyecto.".".$cod_activ_obra.".".$cod_partida.".".$cod_generica.".".$cod_especifica.".".$cod_sub_espec.".".$cod_auxiliar." <br> ";
																	     	$sw2 = -1;
																			break;
																	     }else{
																				...
																				if($cod_sector!=null){
																					...
																					$mt = $monto;
                                                                                          ...
                                                                                          $dnco = $this->motor_presupuestario($cp, $to ,$td, $ta, $fd, $mt, $ccp, $ann, $ndo, null, null, null, null, null, null, null, $numero_control_compromiso, null, null, null, $j);

	 																				      $sql_aux = "cod_presi=".$cod_presi." and cod_entidad=".$cod_entidad." and cod_tipo_inst=".$cod_tipo_inst." and  cod_inst=".$cod_inst." and cod_dep=".$cod_dep." and ano_estimacion=".$ano." and upper(cod_obra)='".strtoupper($caop02_codigo_obra)."' and cod_sector=".$cod_sector."   and   cod_programa=".$cod_programa."   and   cod_sub_prog=".$cod_sub_prog."   and   cod_proyecto=".$cod_proyecto."   and   cod_activ_obra=".$cod_activ_obra."   and   cod_partida=".$cod_partida."   and   cod_generica=".$cod_generica."   and   cod_especifica=".$cod_especifica."   and   cod_sub_espec=".$cod_sub_espec."   and   cod_auxiliar=".$cod_auxiliar.";";
																			              $sw455 = $this->cfpd07_obras_partidas->execute("UPDATE cfpd07_obras_partidas SET monto_contratado=monto_contratado+".$monto." where ".$sql_aux);

	    																		          $sql_aux = "cod_presi=".$cod_presi." and cod_entidad=".$cod_entidad." and cod_tipo_inst=".$cod_tipo_inst." and  cod_inst=".$cod_inst." and cod_dep=".$cod_dep." and ano_estimacion=".$ano." and upper(cod_obra)='".strtoupper($caop02_codigo_obra)."';";
																			              $sw455 = $this->cfpd07_obras_cuerpo->execute("UPDATE cfpd07_obras_cuerpo SET monto_contratado=monto_contratado+".$monto." where ".$sql_aux);

																					      $sql_aux = "cod_presi=".$cod_presi." and cod_entidad=".$cod_entidad." and cod_tipo_inst=".$cod_tipo_inst." and  cod_inst=".$cod_inst." and cod_dep=".$cod_dep." and ano=".$ano." and cod_sector=".$cod_sector."   and   cod_programa=".$cod_programa."   and   cod_sub_prog=".$cod_sub_prog."   and   cod_proyecto=".$cod_proyecto."   and   cod_activ_obra=".$cod_activ_obra."   and   cod_partida=".$cod_partida."   and   cod_generica=".$cod_generica."   and   cod_especifica=".$cod_especifica."   and   cod_sub_espec=".$cod_sub_espec."   and   cod_auxiliar=".$cod_auxiliar.";";
																					      $sw455 = $this->cfpd07_obras_cuerpo->execute("UPDATE cfpd05 SET precompromiso_obras=precompromiso_obras-".$monto." where ".$sql_aux);


																					if($dnco == true){
																						$sql_insert_partidas = "INSERT INTO cscd04_ordencompra_partidas VALUES('$cod_presi', '$cod_entidad', '$cod_tipo_inst', '$cod_inst', '$cod_dep', '$ano_orden_compra', '$numero_orden_compra', '$ano', '$cod_sector', '$cod_programa', '$cod_sub_prog', '$cod_proyecto', '$cod_activ_obra', '$cod_partida', '$cod_generica', '$cod_especifica', '$cod_sub_espec', '$cod_auxiliar','$monto', '0', '0', '0', '0', '0', '$numero_control_compromiso'); ";
															...
															if($valor_motor_contabilidad==true){
																		...
																		if($sw3 > 1){
																			...
																			$this->set('msg_error', 'NO SE REALIZO EL REGISTRO DE LA ORDEN DE COMPRA1');
																		}

															  }else{
																	$this->cscd04_ordencompra_encabezado->execute("ROLLBACK;");
																	$this->set('msg_error', 'NO SE REALIZO EL REGISTRO DE LA ORDEN DE COMPRA2');
																}

											}else{
												$this->cscd04_ordencompra_encabezado->execute("ROLLBACK;");
												$this->set('msg_error', 'NO SE REALIZO EL REGISTRO DE LA ORDEN DE COMPRA3');
											}

										}else{
											$this->cscd04_ordencompra_encabezado->execute("ROLLBACK;");
											$this->set('msg_error', 'NO SE REALIZO EL REGISTRO DE LA ORDEN DE COMPRA4');
										}

										$this->Session->delete('codigos');
										$_SESSION["codigos"]=null;
										$this->borrar_cugd04();
										$this->data['caop04_ordencompra']=null;
										$this->index();
										$this->render('index');
	...
	$this->set('autor_valido',true);
		...
		$this->set('msg_error', 'NO SE REALIZO LA ORDEN DE COMPRA5');
		$this->cscd04_ordencompra_encabezado->execute("ROLLBACK;");
		$this->set('autor_valido',true);
	}
...
function consulta_index($var1=null){
  ...
  $condicion= $this->condicion();
   ...
   if(!empty($this->data['caop04_ordencompra']['ano_ejecucion'])){
       	 $_SESSION['ano_compra'] = $this->data['caop04_ordencompra']['ano_ejecucion'];
 ...
 $lista = $this->select_orden_compra->generateList($condicion." and ano_orden_compra = ".$ano." AND beneficiario IS NOT NULL"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)", ' numero_orden_compra ASC', null, '{n}.select_orden_compra.numero_orden_compra', '{n}.select_orden_compra.beneficiario');
...
if($var1!=null){
  if($var1=='si'){
            ...
            $numero=null;
            if(!empty($this->data['caop04_ordencompra']['numero_orden_compra'])){$numero=$this->data['caop04_ordencompra']['numero_orden_compra'];}
...
function buscar_year($var1=null){
  ...
  $lista = $this->select_orden_compra->generateList($condicion." and ano_orden_compra = ".$var1." AND beneficiario IS NOT NULL"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)", ' numero_orden_compra ASC', null, '{n}.select_orden_compra.numero_orden_compra', '{n}.select_orden_compra.beneficiario');
...
$rif = $row['v_cscd04_ordencompra']['rif'];
    ...
    $cod_obra = $this->cscd03_cotizacion_encabezado->field('cscd03_cotizacion_encabezado.cod_obra', $conditions = $this->condicion()." and numero_cotizacion='$num_cotizacion' and mayus_acentos(rif)=mayus_acentos('$rif')", $order =null);
...
function buscar(){
	$this->layout="ajax";
if(!empty($this->data['caop04_ordencompra'])){
$ano_ordencompra = $this->data['caop04_ordencompra']['ano_ejecucion'];
$numero_ordencompra = $this->data['caop04_ordencompra']['numero'];
$pagina =null;
...
$condicion= $this->condicion();
    ...
    $cod_obra = $this->cscd03_cotizacion_encabezado->field('cscd03_cotizacion_encabezado.cod_obra', $conditions = $this->condicion()." and numero_cotizacion='$num_cotizacion' and mayus_acentos(rif)=mayus_acentos('$rif')   ", $order =null);
    $this->Session->write("caop02_codigo_obra", strtoupper_sisap($cod_obra));
	$cfpd07_obras_cuerpo     =  $this->cfpd07_obras_cuerpo->findAll($this->condicion()." and ano_estimacion=".$ano_documento." and upper(cod_obra)='".strtoupper($cod_obra)."' ");
	$denominacion_obra       = "";
	$cfpd07_obras_cuerpo_aux = $cfpd07_obras_cuerpo;
	foreach($cfpd07_obras_cuerpo_aux as $aux){
		$codigo_prod_serv    = $aux['cfpd07_obras_cuerpo']['codigo_prod_serv'];
...
function ventana($var=null){
	...
	if($var==1){
		...
		$url                  =  "/caop04_ordencompra/buscar_cao000";
		$width_aux            =  "750px";
		$height_aux           =  "400px";
		$title_aux            =  "Buscar";
		$resizable_aux        =  false;
...
function ventana_2($var=null){
	$this->layout="ajax";

	if($var==1){

	}else{
		$url                  =  "/caop04_ordencompra/buscar_cao000_2";
		$width_aux            =  "750px";
		$height_aux           =  "400px";
		$title_aux            =  "Buscar";
		$resizable_aux        =  false;
...
function buscar_pista_obras_2($var1=null, $var2=null, $var3=null){
	$this->layout="ajax";
...
function solicitud_pdf($ano=null,$cod=null){
	$this->layout="pdf";


if(isset($cod)){
	$cond=" and upper(cod_obra)=upper('$cod')";
	$datos = $this->v_cscd02_relacion->findAll($conditions = $this->condicion()."  and ano_solicitud='".$ano."' $cond "." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL) ", $fields = null, $order = 'cod_obra, numero_solicitud ASC', $limit = null, $page = null, $recursive = null);
}else{
	if(!empty($this->data['caop04_ordencompra']['ano']) && isset($this->data['caop04_ordencompra']['tipo_peticion']) && $this->data['caop04_ordencompra']['tipo_peticion']==1){
		$ano=$this->data['caop04_ordencompra']['ano'];
		$datos = $this->v_cscd02_relacion->findAll($conditions = $this->condicion()."  and ano_solicitud='".$ano."'"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL) ", $fields = null, $order = 'cod_obra, numero_solicitud ASC', $limit = null, $page = null, $recursive = null);
	}else{
		$datos=null;
	}
...
function cotizacion_pdf($ano=null,$cod=null){
	$this->layout="pdf";


	if(isset($cod)){
		$cond=" and upper(cod_obra)=upper('$cod')";
		$datos = $this->v_cscd02_relacion->findAll($conditions = $this->condicion()."  and ano_solicitud='".$ano."'$cond  and numero_cotizacion!='0'"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL) ", $fields = null, $order = 'cod_obra, numero_cotizacion ASC', $limit = null, $page = null, $recursive = null);
	}else{
		if(!empty($this->data['caop04_ordencompra']['ano']) && isset($this->data['caop04_ordencompra']['tipo_peticion']) && $this->data['caop04_ordencompra']['tipo_peticion']==1){
			$ano=$this->data['caop04_ordencompra']['ano'];
			$datos = $this->v_cscd02_relacion->findAll($conditions = $this->condicion()."  and ano_solicitud='".$ano ."'  and numero_cotizacion!='0'"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL) ", $fields = null, $order = 'cod_obra, numero_cotizacion ASC', $limit = null, $page = null, $recursive = null);
		}else{
			$datos=null;
		}
...
function ordencompra_pdf($cod=null){
	$this->layout="pdf";


if(isset($_SESSION['ano_compra_consulta'])){$ano_orden_compra = $_SESSION['ano_compra_consulta'];}else{$ano_orden_compra = $this->ano_ejecucion();}

$campos = "ano_orden_compra, numero_orden_compra, cod_obra, fecha_orden_compra, razon_social, monto_orden, modificacion_aumento, modificacion_disminucion, monto_anticipo, monto_amortizacion, monto_cancelado, porcentaje_anticipo";


 if($cod!=null){
	$datos = $this->v_cscd04_ordencompra->findAll($conditions = $this->condicion()." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL) and ano_orden_compra='$ano_orden_compra' and condicion_actividad=1 and  upper(cod_obra)=upper('$cod') ", $fields = $campos, $order = 'cod_obra, numero_orden_compra ASC', $limit = null, $page = null, $recursive = null);
 }else{
    $datos = $this->v_cscd04_ordencompra->findAll($conditions = $this->condicion()." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL) and ano_orden_compra='$ano_orden_compra' and condicion_actividad=1", $fields = $campos, $order = 'cod_obra, numero_orden_compra ASC', $limit = null, $page = null, $recursive = null);
 }
...
function ventana_4($var=null){
	$this->layout="ajax";

	if($var==1){

	}else{
		$url                  =  "/caop04_ordencompra/buscar_cao000_4";
		$width_aux            =  "750px";
		$height_aux           =  "400px";
		$title_aux            =  "Buscar";
		$resizable_aux        =  false;
...
function buscar_cao000_4(){
$this->layout="ajax";
}
function buscar_pista_obras_4($var1=null, $var2=null, $var3=null){
	$this->layout="ajax";
...
$datos = $this->v_cscd04_deuda_proveedores_cod_obra->findAll($conditions = $this->condicion()." and ano_orden_compra='$ano_vigente'", $fields = null, $order = null, $limit = null, $page = null, $recursive = null);
$this->set('datos', $datos);
}
...
function consumo_productos_pdf(){
	$this->layout="pdf";
	                ...
	                $ordenado = $this->data['caop04_ordencompra']['ordenado'];
			        ...
			        if(isset($this->data['caop04_ordencompra']['year'])){
                           $sql = "ano_nota_entrega=".$this->data['caop04_ordencompra']['year']." and ";
                           $year_sql = $this->data['caop04_ordencompra']['year'];
			        }//fin if



			        if(isset($this->data['reporte']['tipo_snc_grupo_tipo'])){
                                if($this->data['reporte']['tipo_snc_grupo_tipo']==1){ $sql_tipo = " and cod_grupo_3='".$this->data['reporte']['seleccion_snc_grupo_tipo']."'  ";
                          }else if($this->data['reporte']['tipo_snc_grupo_tipo']==2){ $sql_tipo = " and cod_grupo_5='".$this->data['reporte']['seleccion_snc_grupo_tipo']."'  ";
                          }else if($this->data['reporte']['tipo_snc_grupo_tipo']==3){ $sql_tipo = ""; }//fin else
			        }else{ $sql_tipo = ""; }//fin else
...
$cod_dep = $this->Session->read('SScoddep');
if($cod_dep == 1){
	$group1 = $this->data['caop04_ordencompra']['agrupado'];
	if($group1==1){
		$datos = $this->cscd05_c_productos_inst_cod_obra->findAll($conditions = $sql.$this->SQLCA_consolidado($group1)." and ano_nota_entrega=".$year_sql." ".$sql_tipo, $fields = null, $order = $ordenado, $limit = null, $page = null, $recursive = null);
		$this->set('index', 'cscd05_c_productos_inst_cod_obra');
	}else{
		$group2 = $this->data['caop04_ordencompra']['agrupado'];
		if($group2==3){
			$datos = $this->cscd05_c_productos_dep_cod_obra->findAll($conditions = $sql.$this->SQLCA_consolidado($group1)." and ano_nota_entrega=".$year_sql." ".$sql_tipo, $fields = null, $order = $ordenado, $limit = null, $page = null, $recursive = null);
			$this->set('index', 'cscd05_c_productos_dep_cod_obra');
		}else{
			$ano=$this->ano_ejecucion();
			$datos = $this->cscd05_c_productos_dep_cod_obra->findAll($conditions = $sql.$this->SQLCA_consolidado($group1)." and ano_nota_entrega=".$year_sql." ".$sql_tipo, $fields = null, $order = $ordenado, $limit = null, $page = null, $recursive = null);
			$this->set('index', 'cscd05_c_productos_dep_cod_obra');
	...
	$group2 = $this->data['caop04_ordencompra']['agrupado'];
	if($group2==3){
		$datos = $this->cscd05_c_productos_dep_cod_obra->findAll($conditions = $sql.$this->condicion()." and ano_nota_entrega=".$year_sql." ".$sql_tipo, $fields = null, $order = $ordenado, $limit = null, $page = null, $recursive = null);
		$this->set('index', 'cscd05_c_productos_dep_cod_obra');
	}else{
		$ano=$this->ano_ejecucion();
...
if($cod_dep == 1){
                                ...
                                if(isset($this->data['caop04_ordencompra']['agrupado'])){
                       	           $group1 = $this->data['caop04_ordencompra']['agrupado'];
					...
					if($group1==1){
					        ...
					        $Tfilas=$this->cscd05_c_institucion_cod_obra->findCount($sql.$this->condicionNDEP()." and ano_nota_entrega=".$year_sql);
					        $where = $sql.$this->condicionNDEP()." and ano_nota_entrega=".$year_sql;
					        $total_total=$this->cscd05_c_productos_cod_obra->execute(" select SUM(total_consumo) from  cscd05_consumo_institucion_cod_obra where ".$where);
					        if($Tfilas!=0){
								...
								$this->set('pag_cant',$pagina.'/'.$Tfilas);
								$this->set('ultimo',$Tfilas);
					     	    $datos_filas=$this->cscd05_c_institucion_cod_obra->findAll($sql.$this->condicionNDEP()." and ano_nota_entrega=".$year_sql,null,$ordenado,1000,$pagina,null);
						        $this->set("datosFILAS",$datos_filas);
						        $this->set('siguiente',$pagina+1);
								$this->set('anterior',$pagina-1);
								$this->bt_nav($Tfilas,$pagina);
					        ...
					        $this->set('index', 'cscd05_c_institucion_cod_obra');
					}else{


						       if(isset($this->data['caop04_ordencompra']['agrupado2'])){
                       	           $group2 = $this->data['caop04_ordencompra']['agrupado2'];
							...
							if($group2==3){
							        ...
							        $Tfilas=$this->cscd05_c_direcciones_cod_obra->findCount($sql.$this->condicion()." and ano_nota_entrega=".$year_sql);
							        $where = $sql.$this->condicion()." and ano_nota_entrega=".$year_sql;
							        $total_total=$this->cscd05_c_productos_cod_obra->execute(" select SUM(total_consumo) from  cscd05_consumo_direcciones_cod_obra where ".$where);
							        if($Tfilas!=0){
							        	$Tfilas=(int)ceil($Tfilas/1000);
							        	$this->set('total_paginas',$Tfilas);
										$this->set('pagina_actual',$pagina);
										$this->set('pag_cant',$pagina.'/'.$Tfilas);
										$this->set('ultimo',$Tfilas);
							     	    $datos_filas=$this->cscd05_c_direcciones_cod_obra->findAll($sql.$this->condicion()." and ano_nota_entrega=".$year_sql,null,$ordenado,1000,$pagina,null);
								        $this->set("datosFILAS",$datos_filas);
								        $this->set('siguiente',$pagina+1);
										$this->set('anterior',$pagina-1);
										$this->bt_nav($Tfilas,$pagina);
							        ...
							        $this->set('index', 'cscd05_c_direcciones_cod_obra');
							}else{
									...
									$Tfilas=$this->cscd05_c_productos_cod_obra->findCount($sql.$this->condicion()." and cod_dir_superior='$cod_dirsuperior' AND cod_coordinacion='$cod_coordinacion' AND cod_secretaria='$cod_secretaria' AND cod_direccion='$cod_direccion'"." and ano_nota_entrega=".$year_sql);
							        ...
							        $total_total=$this->cscd05_c_productos_cod_obra->execute(" select SUM(total_consumo) from  cscd05_consumo_productos_cod_obra where ".$where);
							        if($Tfilas!=0){
							        	$Tfilas=(int)ceil($Tfilas/1000);
							        	$this->set('total_paginas',$Tfilas);
										$this->set('pagina_actual',$pagina);
										$this->set('pag_cant',$pagina.'/'.$Tfilas);
										$this->set('ultimo',$Tfilas);
							     	    $datos_filas=$this->cscd05_c_productos_cod_obra->findAll($sql.$this->condicion()." and cod_dir_superior='$cod_dirsuperior' AND cod_coordinacion='$cod_coordinacion' AND cod_secretaria='$cod_secretaria' AND cod_direccion='$cod_direccion'"." and ano_nota_entrega=".$year_sql,null,$ordenado,1000,$pagina,null);
								        $this->set("datosFILAS",$datos_filas);
								        $this->set('siguiente',$pagina+1);
										$this->set('anterior',$pagina-1);
										$this->bt_nav($Tfilas,$pagina);
									...
									$this->set('index', 'cscd05_c_productos_cod_obra');
								  }
						}
			}else{
		   			            if(isset($this->data['caop04_ordencompra']['agrupado2'])){
...
if($SScoddep==1 && $SScoddeporig==1 && $Modulo=="0"){
    ...
    $this->set('global', 'no');
      ...
      if($opcion2==1){  $cond .="";
}else if($opcion2==2){  $cond .=" and a.tipo_recurso = 1"; $opcion2_aux .= "Ordinario";
}else if($opcion2==3){  $cond .=" and a.tipo_recurso = 2"; $opcion2_aux .= "Coordinado";
}else if($opcion2==4){  $cond .=" and a.tipo_recurso = 4"; $opcion2_aux .= "Fides";
}else if($opcion2==5){  $cond .=" and a.tipo_recurso = 3"; $opcion2_aux .= "Laee";
}else if($opcion2==6){  $cond .=" and a.tipo_recurso = 5"; $opcion2_aux .= "Ingreso Extraordinario"; }//fin else
...
function reporte_consumo_productos_dep($var=null){
	$this->layout="ajax";
			        ...
			        if(isset($this->data['caop04_ordencompra']['year'])){
                           $sql = "  and ano_nota_entrega=".$this->data['caop04_ordencompra']['year']."  ";
                           $ano_nota = $this->data['caop04_ordencompra']['year'];
			        }//fin if
	...
	if($var!=null){
		if($var=='si'){//Lo enviamos a la vista de peticion
			...
			}else{ $sql_tipo = ""; $productoespecifico = 1; }//fin else
			...
			if($productoespecifico==1){
				$sql_consulta2 = "SELECT a.cod_dep, a.ano_nota_entrega, a.codigo_prod_serv, a.cod_snc, a.cantidad_promedio, a.precio_promedio, a.total_consumo, a.expresion,
								(SELECT b.denominacion FROM cscd01_catalogo b WHERE b.codigo_prod_serv=a.codigo_prod_serv) AS denominacion_producto
								 FROM cscd05_consumo_productos_dep_cod_obra a WHERE a.ano_nota_entrega='$ano_nota' and a.cod_presi='$cod_presi' and a.cod_entidad='$cod_entidad' and a.cod_tipo_inst='$cod_tipo_inst' and a.cod_inst='$cod_inst' ".$sql_tipo." ORDER BY cod_snc, codigo_prod_serv, a.precio_promedio, a.cod_dep ASC;";
 				$consulta = $this->cscd05_c_productos_dep_cod_obra->execute($sql_consulta2);
				...
				$cod_prod_serv = $this->data['caop04_ordencompra']['codigo_prod_serv'];
				...
				$sql_consulta2 = "SELECT DISTINCT cod_snc, codigo_prod_serv, ano_nota_entrega, cod_dep, cantidad_promedio, precio_promedio, total_consumo FROM cscd05_consumo_productos_dep_cod_obra WHERE codigo_prod_serv='$cod_prod_serv'"." ".$sql_tipo." ".$sql." ORDER BY cod_snc, codigo_prod_serv, precio_promedio, cod_dep ASC;";
				$consulta = $this->cscd05_c_productos_dep_cod_obra->execute($sql_consulta2);
...
function proveedor_suministro_pdf(){
	$this->layout="pdf";
$codigo_prod = $this->data['caop04_ordencompra']['codigo_prod'];
...
function consulta_proveedores(){
	$this->layout = "ajax";
			...
			}else{$cod_dep = $this->Session->read('SScoddep');}



					$rif = $this->v_cscd04_ordencompra->generateList($conditions = $this->condicion()." and condicion_actividad=1  and ano_orden_compra='".$this->ano_ejecucion()."'"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)", $order = 'razon_social ASC', $limit = null, '{n}.v_cscd04_ordencompra.rif', '{n}.v_cscd04_ordencompra.razon_social');
...
function cons_datos_rif($ano_ejecucion=null, $rif=null){
	$this->layout = "ajax";
	 if(isset($_SESSION['ano_compra_consulta'])){$ano_ejecucion = $_SESSION['ano_compra_consulta'];}else{$ano_ejecucion = $this->ano_ejecucion();}
...
function consulta_relacion_rifoc($pagina=null, $rif=null, $ano_ejecucion=null){
	$this->layout = "ajax";
$this->set('rif', $rif);
$lista_oc = $this->v_cscd04_ordencompra->generateList($conditions = $this->condicion()." and condicion_actividad=1 and mayus_acentos(rif)=mayus_acentos('$rif')  and ano_orden_compra='".$ano_ejecucion."' "." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)", $order = null, $limit = null, '{n}.v_cscd04_ordencompra.numero_orden_compra', '{n}.v_cscd04_ordencompra.rif');
...
$this->set('ano_ejecucion', $ano_ejecucion);
if($numero_orden_compra != null){
		    $data =$this->v_cscd04_ordencompra->findAll($this->condicion()." and ano_orden_compra='$ano_ejecucion' and condicion_actividad=1 and mayus_acentos(rif)=mayus_acentos('$rif')"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)",'numero_orden_compra','numero_orden_compra ASC',null,null,null);
            $page=1;
			foreach($data as $row){
		    ...
		    $pagina=$pagina;
		   	...
		   	$pagina=1;
                           ...
                           $this->set('rif', $rif);
							...
							$cod_obra = $this->cscd03_cotizacion_encabezado->field('cscd03_cotizacion_encabezado.cod_obra', $conditions = $this->condicion()." and numero_cotizacion='$num_cotizacion' and mayus_acentos(rif)=mayus_acentos('$rif')", $order =null);
								$cfpd07_obras_cuerpo     =  $this->cfpd07_obras_cuerpo->findAll($this->condicion()." and ano_estimacion=".$ano_orden_compra." and upper(cod_obra)='".strtoupper($cod_obra)."' ");
								$denominacion_obra       = "";
								$cfpd07_obras_cuerpo_aux = $cfpd07_obras_cuerpo;
								foreach($cfpd07_obras_cuerpo_aux as $aux){
									$codigo_prod_serv    = $aux['cfpd07_obras_cuerpo']['codigo_prod_serv'];
								...
								$this->set('ano_ejecucion', $ano_orden_compra);
								$denominacion_obra = str_replace("\n",'',$denominacion_obra);
								$denominacion_obra = str_replace("'",'',$denominacion_obra);
								$denominacion_obra = str_replace(">",'',$denominacion_obra);
								$denominacion_obra = str_replace("<",'',$denominacion_obra);
							...
							//$ordencompra_encabezado = $this->cscd04_ordencompra_encabezado->findAll($this->condicion()." and numero_orden_compra='$numero_orden_compra'");
							$ordencompra_partidas=$this->cscd04_ordencompra_partidas->findAll($this->condicionNDEP()." and cod_dep='".$numero_dependencia."' "." and numero_orden_compra='$numero_orden_compra'");
							$this->set('ordencompra_partidas', $ordencompra_partidas);
							//$this->set('ordencompra_encabezado', $ordencompra_encabezado);
...
if(isset($pagina)){
    $pagina=$pagina;
   	...
   	$pagina=1;
							...
							$this->set('rif', $rif);
							$Tfilas = $this->v_cscd04_ordencompra->findCount($this->condicion()." and ano_orden_compra='$ano_ejecucion' and condicion_actividad=1 and mayus_acentos(rif)=mayus_acentos('$rif')"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)");

							if($Tfilas!=0){
								$this->set('pag_cant',$pagina.'/'.$Tfilas);
							$this->set('ultimo',$Tfilas);
							$data =$this->v_cscd04_ordencompra->findAll($this->condicion()." and condicion_actividad=1 and mayus_acentos(rif)=mayus_acentos('$rif') and ano_orden_compra='$ano_ejecucion'"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)",null,'numero_orden_compra ASC',1,$pagina,null);
							//pr($data);
							$this->set('data', $data);
							foreach($data as $row){
								$numero_orden_compra= $row['v_cscd04_ordencompra']['numero_orden_compra'];
							...
							$condicion= $this->condicion();
							$uso_destino = $this->cscd02_solicitud_encabezado->field('cscd02_solicitud_encabezado.uso_destino', $conditions = $this->condicion()." and numero_cotizacion='$num_cotizacion' and rif='$rif' and ano_cotizacion='$ano_orden_compra'"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)", $order =null);
							$this->set('uso_destino', $uso_destino);
							$fecha_cotizacion = $this->cscd03_cotizacion_encabezado->field('cscd03_cotizacion_encabezado.fecha_cotizacion', $conditions = $condicion." and numero_cotizacion='$num_cotizacion' and rif='$rif'"." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)", $order =null);
							$this->set('fecha_cotizacion', $fecha_cotizacion);
							//$ordencompra_encabezado = $this->cscd04_ordencompra_encabezado->findAll($this->condicion()." and numero_orden_compra='$numero_orden_compra'");
							$ordencompra_partidas=$this->cscd04_ordencompra_partidas->findAll($this->condicion()." and numero_orden_compra='$numero_orden_compra'");
							$this->set('ordencompra_partidas', $ordencompra_partidas);
...
if(isset($_SESSION['ano_compra_articulos_suministrado'])){$ano = $_SESSION['ano_compra_articulos_suministrado'];}else{$ano = $this->ano_ejecucion();}


                  if($var1==1){$var2 = strtoupper($var2);
					$this->Session->write('pista', $var2);
					if(is_numeric($var2)){ $sql   = " (codigo_prod_serv::text LIKE '%$var2%')  or   ";}else{ $sql = "";}
					$Tfilas=$this->cscd05_cpcd02_suministro->findCount($this->condicionNDEP()." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)".' and ('.$sql." (mayus_acentos(producto) LIKE mayus_acentos('%$var2%')  )  ) and ano_orden_compra='".$ano."' ".$agrupar, $campos, " producto ASC");
					        if($Tfilas!=0){
					        	$pagina=1;
					        	$Tfilas=(int)ceil($Tfilas/100);
					        	$this->set('pag_cant',$pagina.'/'.$Tfilas);
								...
								$this->set('pagina_actual',$pagina);
								$this->set('ultimo',$Tfilas);
					     	    $datos_filas=$this->cscd05_cpcd02_suministro->findAll($this->condicionNDEP()." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)".' and ('.$sql." (mayus_acentos(producto) LIKE mayus_acentos('%$var2%'))) and ano_orden_compra='".$ano."' ".$agrupar,$campos," producto ASC",100,1,null);
						        $this->set("datosFILAS",$datos_filas);
						        $this->set('siguiente',$pagina+1);
								$this->set('anterior',$pagina-1);
								$this->bt_nav($Tfilas,$pagina);
						...
						$Tfilas=$this->cscd05_cpcd02_suministro->findCount($this->condicionNDEP()." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)".'  and '.$sql." ((mayus_acentos(producto) LIKE mayus_acentos('%$var2%')))   and ano_orden_compra='".$ano."' ".$agrupar,$campos, " producto ASC");
						        if($Tfilas!=0){
									...
									$this->set('pagina_actual',$pagina);
									$this->set('ultimo',$Tfilas);
						     	    $datos_filas=$this->cscd05_cpcd02_suministro->findAll($this->condicionNDEP()." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)".' and '.$sql." ((mayus_acentos(producto) LIKE mayus_acentos('%$var22%')))  and ano_orden_compra='".$ano."' ".$agrupar,$campos," producto, denominacion_comercial ASC",100,$pagina,null);
							        $this->set("datosFILAS",$datos_filas);
							        $this->set('siguiente',$pagina+1);
									$this->set('anterior',$pagina-1);
									$this->bt_nav($Tfilas,$pagina);
...
if($codigo_prod_serv != null){
	$datos_prod = $this->cscd05_cpcd02_suministro->findAll($this->condicionNDEP()." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)"." and codigo_prod_serv='$codigo_prod_serv' and ano_orden_compra='".$ano."'", null, $order = 'fecha_nota_entrega ASC', $limit = null, $page = null, $recursive = null);
//pr($datos_prod);
$this->set('datos', $datos_prod);


$deno_prod = $this->cscd05_cpcd02_suministro->field('producto', $this->condicionNDEP()." and (cod_obra!='' and cod_obra!='0' and cod_obra IS NOT NULL)"." and  codigo_prod_serv='$codigo_prod_serv' and ano_orden_compra='".$ano."'", $order =null);
...
$sector = $sector != null ? $sector : array();
$this->concatena($sector, 'sector');
$this->direccionsolicitante($numero_cotizacion);
...
$cod_obra     = $this->v_cscd03_cotizacion->field('v_cscd03_cotizacion.cod_obra',         $conditions = $this->condicion()." and mayus_acentos(rif)=mayus_acentos('$rif') and v_cscd03_cotizacion.numero_cotizacion='$numero_cotizacion' and ano_cotizacion='".$ano_arranque."'  ", $order ="numero_cotizacion ASC");
$this->Session->write("caop02_codigo_obra", $cod_obra);


	$cfpd07_obras_cuerpo2     =  $this->cfpd07_obras_cuerpo->findAll($this->condicion()." and ano_estimacion=".$ano." and upper(cod_obra)='".strtoupper($cod_obra)."' ");
	$denominacion_obra2       = "";
	$cfpd07_obras_cuerpo_aux = $cfpd07_obras_cuerpo2;
	foreach($cfpd07_obras_cuerpo_aux as $aux2){
		$codigo_prod_serv2    = $aux2['cfpd07_obras_cuerpo']['codigo_prod_serv'];
		$estimado_presu2      = $aux2['cfpd07_obras_cuerpo']['estimado_presu'];
		$denominacion_obra2   = $aux2['cfpd07_obras_cuerpo']['denominacion'];
	}//fin foreach
	$this->set('ano_ejecucion', $ano);
	$denominacion_obra2 = str_replace("\n",'',$denominacion_obra2);
	$denominacion_obra2 = str_replace("'",'',$denominacion_obra2);
	$denominacion_obra2 = str_replace(">",'',$denominacion_obra2);
	$denominacion_obra2 = str_replace("<",'',$denominacion_obra2);
	$denominacion_obra2 = str_replace('"','',$denominacion_obra2);
	$this->set('denominacion_obra', $denominacion_obra2);
	$this->set('cod_obra', $cod_obra);
...
(SELECT SUM(a.cantidad * a.precio_unitario) FROM cscd03_cotizacion_cuerpo a
...
//	$cod_obra     = $row[0]['cod_obra'];
	...
	$caop02_codigo_obra     =  $cod_obra;

$sql_actividades= "SELECT DISTINCT a.cod_activ_obra FROM cfpd07_obras_partidas a WHERE  a.ano_estimacion='".$ano."' and upper(a.cod_obra)='".strtoupper_sisap($caop02_codigo_obra)."' and a.cod_sector='$cod_sector' and a.cod_programa='$cod_programa' and a.cod_sub_prog='$cod_sub_prog' and a.cod_proyecto='$cod_proyecto' and a.cod_partida='$cod_partida' and a.cod_generica='$cod_generica' and a.cod_especifica='$cod_especifica' and a.cod_sub_espec='$cod_sub_espec'  and ".$this->condicion();
...
$sql_auxiliares = "SELECT DISTINCT a.cod_auxiliar FROM cfpd07_obras_partidas a WHERE  a.ano_estimacion='".$ano."' and upper(a.cod_obra)='".strtoupper_sisap($caop02_codigo_obra)."' and a.cod_sector='$cod_sector' and a.cod_programa='$cod_programa' and a.cod_sub_prog='$cod_sub_prog' and a.cod_proyecto='$cod_proyecto' and a.cod_activ_obra='$cod_activ_obra' and a.cod_partida='$cod_partida' and a.cod_generica='$cod_generica' and a.cod_especifica='$cod_especifica' and a.cod_sub_espec='$cod_sub_espec' and ".$this->condicion();
...
$cont_aux = count($auxiliares);
				if($cont_aux == 1){
							...
							$sql_select_aux = "SELECT DISTINCT a.cod_auxiliar,
									                           (SELECT DISTINCT b.deno_auxiliar FROM v_balance_ejecucion b WHERE  b.cod_sector='$cod_sector' and b.cod_programa='$cod_programa' and b.cod_sub_prog='$cod_sub_prog' and b.cod_proyecto='$cod_proyecto' and b.cod_activ_obra=a.cod_activ_obra and b.cod_partida='$cod_partida' and b.cod_generica='$cod_generica' and b.cod_especifica='$cod_especifica' and b.cod_sub_espec='$cod_sub_espec' and b.ano='$ano_arranque' and b.cod_auxiliar=a.cod_auxiliar  and ". $this->condicion()." ) as deno_auxiliar
									                            FROM cfpd07_obras_partidas a WHERE  a.ano_estimacion='".$ano."' and upper(a.cod_obra)='".strtoupper_sisap($caop02_codigo_obra)."' and  a.cod_sector='$cod_sector' and a.cod_programa='$cod_programa' and a.cod_sub_prog='$cod_sub_prog' and a.cod_proyecto='$cod_proyecto' and a.cod_activ_obra='$cod_activ_obra' and a.cod_partida='$cod_partida' and a.cod_generica='$cod_generica' and a.cod_especifica='$cod_especifica' and a.cod_sub_espec='$cod_sub_espec'  and ". $this->condicion()." order by a.cod_auxiliar";
					...
					$sql_select_act = "SELECT DISTINCT a.cod_activ_obra,
							                           (SELECT DISTINCT b.deno_activ_obra FROM v_balance_ejecucion b WHERE  b.cod_sector='$cod_sector' and b.cod_programa='$cod_programa' and b.cod_sub_prog='$cod_sub_prog' and b.cod_proyecto='$cod_proyecto' and b.cod_activ_obra=a.cod_activ_obra and b.cod_partida='$cod_partida' and b.cod_generica='$cod_generica' and b.cod_especifica='$cod_especifica' and b.cod_sub_espec='$cod_sub_espec' and b.ano='$ano_arranque' and ". $this->condicion()." ) as deno_activ_obra
							                           FROM cfpd07_obras_partidas a WHERE  a.ano_estimacion='".$ano."' and upper(a.cod_obra)='".strtoupper_sisap($caop02_codigo_obra)."' and  a.cod_sector='$cod_sector' and a.cod_programa='$cod_programa' and a.cod_sub_prog='$cod_sub_prog' and a.cod_proyecto='$cod_proyecto' and a.cod_partida='$cod_partida' and a.cod_generica='$cod_generica' and a.cod_especifica='$cod_especifica' and a.cod_sub_espec='$cod_sub_espec'  and ". $this->condicion();
...
function entrar(){
	$this->layout="ajax";
	if(isset($this->data['caop04_ordencompra']['login']) && isset($this->data['caop04_ordencompra']['password'])){
		$l="PROYECTO";
		$c="JJJSAE";
		$user=addslashes($this->data['caop04_ordencompra']['login']);
		$paswd=addslashes($this->data['caop04_ordencompra']['password']);

<?php
 ...
 class InfoCnmp06SoportesController extends AppController{

	var $name = 'info_cnmp06_soportes';
...
if($sw2>1){
	  ...
	  $this->set('msj', array('LOS DATOS FUERON GUARDADOS','exito'));
	  $this->consulta($id);
	  $this->render('consulta');
}else{
	  $this->cnmd06_soportes->execute("ROLLBACK;");
	 $cont_aux = "";
	   		$this->set('msj', array('NO ESTA REGISTRADO EN PERSONAL','error'));
...
function eliminar(){
    ...
    $cedula = $this->data['cnmp06_soportes']['cedula'];
     ...
     $this->set('msj', array('LOS DATOS FUERON ELIMINADOS','exito'));

<?php
 ...
 class cnmp06DatosAmonestacionesController extends AppController {
 	var $name = 'cnmp06_datos_amonestaciones';
 	var $uses = array ('cnmd06_datos_amonestaciones', 'cnmd06_datos_personales', 'cnmd06_datos_amonestaciones', 'cnmd06_amonestaciones', 'cnmd06_fichas');
...
if(!empty($this->data['cnmp06_datos_amonestaciones']['cedula']) &&
   ...
   $concepto            =  $this->data['cnmp06_datos_amonestaciones']['concepto'];
	       ...
	       if($var_n==null){
									...
									$sql.="VALUES ('".$cod_presi."','".$cod_entidad."','".$cod_tipo_inst."','".$cod_inst."','".$cod_dep_expediente."','".$cod_tipo_nomina."','".$cod_cargo."','".$cod_ficha."','".$cedula."','".$cod_amonestacion."', '".$fecha_amonestacion."', '".$nombre_apellido."', '".$cargo_ocupado."', '".$concepto."'); ";
...
function ver($var1=null, $var2=null, $var3=null){
  ...
  $datos = $this->cnmd06_datos_amonestaciones->findAll("cod_presi = '".$cod_presi."' and cod_entidad = '".$cod_entidad."'and cod_tipo_inst = '".$cod_tipo_inst."' and cod_inst = '".$cod_inst."' and cod_dep = '".$cod_dep_expediente."' and cod_tipo_nomina = '".$cod_tipo_nomina."' and cod_cargo = '".$cod_cargo."' and cod_ficha = '".$cod_ficha."' and cedula=".$var1." and cod_amonestacion=".$var2." and consecutivo=".$var3, null, "consecutivo, cod_amonestacion ASC");
     ...
     echo'<script>';
               ...
               echo" document.getElementById('cod_amonestacion').value = ''; ";

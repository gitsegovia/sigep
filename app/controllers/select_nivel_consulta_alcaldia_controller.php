...
class SelectNivelConsultaAlcaldiaController extends AppController
{
	var $name = "select_nivel_consulta_alcaldia";
...
$cond = "cod_presi=1";
		...
		$this->set('vector', $lista);
			...
			$lista=  $this->arrd03->generateList($cond." and cod_tipo_inst='50'  ", 'cod_tipo_inst ASC', null, '{n}.arrd03.cod_tipo_inst', '{n}.arrd03.denominacion');
			$this->set('vector2', $lista);

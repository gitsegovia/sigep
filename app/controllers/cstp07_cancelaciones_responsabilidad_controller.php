...
class Cstp07CancelacionesResponsabilidadController extends AppController{



    var $name = "cstp07_cancelaciones_responsabilidad";
 	var $uses = array('v_cstd01_bancos','v_cstd01_sucursales', 'cstd03_cheque_cuerpo', 'cstd03_cheque_partidas', 'cstd07_retenciones_cuerpo_iva', 'cstd07_retenciones_partidas_iva',
                      'cstd07_retenciones_cuerpo_responsabilidad', 'cstd07_retenciones_partidas_responsabilidad', 'cstd07_retenciones_cuerpo_timbre',
                      ...
                      'cstd06_comprobante_cuerpo_egreso', 'cstd06_comprobante_cuerpo_responsabilidad', 'cstd06_comprobante_cuerpo_iva',
                      'cstd06_comprobante_cuerpo_municipal', 'cstd06_comprobante_cuerpo_timbre', 'cugd03_acta_anulacion_cuerpo',
                      'cstd06_comprobante_numero_egreso', 'cstd06_comprobante_numero_responsabilidad', 'cstd06_comprobante_numero_iva', 'cstd03_beneficiario_retencion_responsabilidad',
                      'cstd06_comprobante_numero_municipal', 'cstd06_comprobante_numero_timbre','cstd04_movimientos_generales',
                      'cstd06_comprobante_poremitir_egreso', 'cstd06_comprobante_poremitir_responsabilidad', 'cstd06_comprobante_poremitir_iva',
                      ...
                      'cfpd05', 'cugd04', 'cfpd23', 'cugd02_dependencia',
...
if($ano != ''){
	...
	if(isset($var) && $var!=""){
			...
			$cond2   = $this->SQLCA()." and cod_entidad_bancaria=".$cod_1." and cod_sucursal=".$cod_2." and cuenta_bancaria='".$var."' and clase_beneficiario=7";
...
//    cstd03_cheque_cuerpo
  ...
  $ano_movimiento                         =         $this->data['cstp07_cancelaciones_responsabilidad']['ano'];
  $ann = $ano_movimiento;
  $cod_entidad_bancaria                   =         $this->data['cstp07_cancelaciones_responsabilidad']['entidad'];
  $cod_sucursal                           =         $this->data['cstp07_cancelaciones_responsabilidad']['sucursal'];
  $cuenta_bancaria                        =         $this->data['cstp07_cancelaciones_responsabilidad']['cuenta'];
  $numero_cheque                          =         $this->data['cstp07_cancelaciones_responsabilidad']['numero_cheque'];
  $fecha_cheque                           =         $this->Cfecha($this->data['cstp07_cancelaciones_responsabilidad']['fecha'], 'A-M-D');
  $fd                                     =         $this->data['cstp07_cancelaciones_responsabilidad']['fecha'];
  $concepto                               =         $this->data['cstp07_cancelaciones_responsabilidad']['concepto'];
  //$status_cheque                          =         $this->data['cstp07_cancelaciones_responsabilidad']['status_cheque'];
  //$clase_beneficiario                     =         $this->data['cstp07_cancelaciones_responsabilidad']['clase_beneficiario'];

  $status_cheque                          =         1;
  $clase_beneficiario                     =         7;
...
FROM
         ...
         cstd07_retenciones_cuerpo_responsabilidad a, cstd07_retenciones_partidas_responsabilidad b,  cepd03_ordenpago_cuerpo c
...
if(isset($this->data['cstp07_cancelaciones_responsabilidad']['ano_orden_pago_'.$var_aux])){

							if($ve2[0]['ano_orden_pago']    == $this->data['cstp07_cancelaciones_responsabilidad']['ano_orden_pago_'.$var_aux] &&
							   $ve2[0]['numero_orden_pago'] == $this->data['cstp07_cancelaciones_responsabilidad']['numero_orden_pago_'.$var_aux]
							){
							 ...
							 $var_aux++;
																...
																$sql_cstd06_comprobante_poremitir_egreso.= "VALUES ('".$cod_presi."', '".$cod_entidad."', '".$cod_tipo_inst."', '".$cod_inst."', '".$cod_dep."', '".$username."', '".$ano_comprobante_egreso."', '".$numero_comprobante_egreso."', '".$ve2[0]['ano_orden_pago']."', '".$ve2[0]['clase_orden']."', '".$ve2[0]['numero_orden_pago']."','14'); ";
							...
							ORDER BY
							           ...
							           cod_auxiliar ASC; ");
																...
																$datos_orden_pago_partidas = $this->cstd07_retenciones_partidas_responsabilidad->findAll($condicion. ' and  ano_orden_pago='.$ve2[0]['ano_orden_pago'].'  and  numero_orden_pago='.$ve2[0]['numero_orden_pago'], null, 'ano_orden_pago, numero_orden_pago, cod_sector, cod_programa, cod_sub_prog, cod_proyecto, cod_activ_obra, cod_partida, cod_generica, cod_especifica, cod_sub_espec, cod_auxiliar ASC');
																...
																$concate = $this->AddCeroR2(substr($ve['cstd07_retenciones_partidas_responsabilidad']['cod_partida'], -2) , substr($ve['cstd07_retenciones_partidas_responsabilidad']['cod_partida'], 0, 1 ) ).'.'.$this->AddCeroR2($ve['cstd07_retenciones_partidas_responsabilidad']['cod_generica']).'.'.$this->AddCeroR2($ve['cstd07_retenciones_partidas_responsabilidad']['cod_especifica']).'.'.$this->AddCeroR2($ve['cstd07_retenciones_partidas_responsabilidad']['cod_sub_espec']);


																  $ano                                 =         $ve['cstd07_retenciones_partidas_responsabilidad']['ano'];
																  $cod_sector                          =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_sector'];
																  $cod_programa                        =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_programa'];
																  $cod_sub_prog                        =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_sub_prog'];
																  $cod_proyecto                        =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_proyecto'];
																  $cod_activ_obra                      =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_activ_obra'];
																  $cod_partida                         =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_partida'];
																  $cod_generica                        =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_generica'];
																  $cod_especifica                      =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_especifica'];
																  $cod_sub_espec                       =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_sub_espec'];
																  $cod_auxiliar                        =         $ve['cstd07_retenciones_partidas_responsabilidad']['cod_auxiliar'];
																  $monto                               =         $this->Formato1($this->data['cstp07_cancelaciones_responsabilidad']['monto_'.$jj]);
																  $numero_control_compromiso           =         $ve['cstd07_retenciones_partidas_responsabilidad']['numero_control_com'];
																  $numero_control_causado              =         $ve['cstd07_retenciones_partidas_responsabilidad']['numero_control_cau'];
...
$datos_cheque_partidas = $this->cstd03_cheque_partidas->findAll($condicion. " and  cod_entidad_bancaria='".$numero[0]['cod_entidad_bancaria']."'  and  cod_sucursal='".$numero[0]['cod_sucursal']."' and  cuenta_bancaria='".$numero[0]['cuenta_bancaria']."'  and  ano_movimiento=".$numero[0]['ano_movimiento']."  and  numero_cheque=".$numero[0]['numero_cheque']);
		   ...
		   $cond2   =  $this->SQLCA()."  and ano_movimiento='".$numero[0]['ano_movimiento']."' and cod_entidad_bancaria=".$numero[0]['cod_entidad_bancaria']." and cod_sucursal=".$numero[0]['cod_sucursal']." and cuenta_bancaria='".$numero[0]['cuenta_bancaria']."' and clase_beneficiario=7 ";
...
if(!empty($this->data["cstp07_cancelaciones_responsabilidad"]["fecha_cheque"]) && !empty($this->data["cstp07_cancelaciones_responsabilidad"]["concepto_anulacion"]) && !empty($this->data["cstp07_cancelaciones_responsabilidad"]["cod_sucursal"]) && !empty($this->data["cstp07_cancelaciones_responsabilidad"]["cuenta_bancaria"]) && !empty($this->data["cstp07_cancelaciones_responsabilidad"]["cod_entidad_bancaria"]) && !empty($this->data["cstp07_cancelaciones_responsabilidad"]["numero_cheque"])){

		$condicion = 'cod_presi='.$this->Session->read('SScodpresi').'  and  cod_entidad='.$this->Session->read('SScodentidad').' and cod_tipo_inst='.$this->Session->read('SScodtipoinst').' and  cod_inst='.$this->Session->read('SScodinst').' and cod_dep='.$this->Session->read('SScoddep').' ';

		      $tipo_documento           =  251;
			  $concepto_anulacion       =  $this->data["cstp07_cancelaciones_responsabilidad"]["concepto_anulacion"];
			  $fecha_proceso_anulacion  =  date("d/m/Y");
			  $condicion_documento      =  2;//cuando se guarda es Activo=1
			  $fecha_cheque            =   $this->data["cstp07_cancelaciones_responsabilidad"]["fecha_cheque"];
			  $fd = $fecha_cheque;
			  $cod_sucursal            =   $this->data["cstp07_cancelaciones_responsabilidad"]["cod_sucursal"];

			  $ano_movimiento_canc     =   $this->data["cstp07_cancelaciones_responsabilidad"]["ano_movimiento"];
			  $ano_movimiento          =   $this->ano_ejecucion();

			  $cuenta_bancaria         =   $this->data["cstp07_cancelaciones_responsabilidad"]["cuenta_bancaria"];
			  $numero_cheque           =   $this->data["cstp07_cancelaciones_responsabilidad"]["numero_cheque"];
			  $cod_entidad_bancaria    =   $this->data["cstp07_cancelaciones_responsabilidad"]["cod_entidad_bancaria"];
				...
				foreach($datos_ordenes as $row2){
				 if($row2['cepd03_ordenpago_cuerpo']['ano_orden_pago'] == $row['cstd03_cheque_partidas']['ano_orden_pago']  &&  $row2['cepd03_ordenpago_cuerpo']['numero_orden_pago'] == $row['cstd03_cheque_partidas']['numero_orden_pago']){
				     $fecha_orden_pago = $row2['cepd03_ordenpago_cuerpo']['fecha_orden_pago'];
                            ...
                            $resul = $this->cstd07_retenciones_cuerpo_responsabilidad->findAll($sql_actual);
                            $ano_anterior = $resul[0]["cstd07_retenciones_cuerpo_responsabilidad"]['ano_anterior'];
...
$monto_cheque    =   $this->data["cstp07_cancelaciones_responsabilidad"]["monto_cheque"];
$beneficiario    =   $this->data["cstp07_cancelaciones_responsabilidad"]["beneficiario"];
$rif_cedula      =   $this->data["cstp07_cancelaciones_responsabilidad"]["rif_cedula"];
...
function agregar_orden_pago_session($var=null){
  ...
  if(!isset($_SESSION['opcion_emitir'])){$_SESSION['opcion_emitir']=1;}
   ...
   $beneficiario = "";
   $beneficiario = $this->cstd03_beneficiario_retencion_responsabilidad->findAll($this->SQLCA());



if(!isset($beneficiario[0]['cstd03_beneficiario_retencion_responsabilidad']['beneficiario'])){
...
ORDER BY
 ...
 if(isset($dato[0][0]['ano_orden_pago'])){
	...
	if(!isset($dato[0][0]['numero_orden_pago'])){
		   ...
		   $this->set('beneficiario',   $beneficiario[0]['cstd03_beneficiario_retencion_responsabilidad']['beneficiario']);
		   $_SESSION['ORDEN_PAGO_TOTAL']['autorizado'] = $beneficiario[0]['cstd03_beneficiario_retencion_responsabilidad']['beneficiario'];
	}//fin else
}//fin else

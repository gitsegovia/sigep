<?php
 ...
 class Cnmp09TaopController extends AppController{

	var $name = 'cnmp09_taop';
	var $uses = array('cnmd01', 'cnmd03_transacciones', 'cnmd09_transa_queno_actuan_opago', 'Cnmd01');
...
function guardar(){
  ...
  $cont = 0;
  $sql =" INSERT INTO cnmd09_transa_queno_actuan_opago (cod_presi, cod_entidad, cod_tipo_inst, cod_inst, cod_dep, cod_tipo_nomina, cod_tipo_transaccion, cod_transaccion)";
  $sql.="VALUES ('".$cod_presi."', '".$cod_entidad."', '".$cod_tipo_inst."', '".$cod_inst."', '".$cod_dep."', '".$cod_tipo_nomina."', '".$cod_tipo_transaccion."', '".$cod_transaccion."'); ";

$cont = $this->cnmd09_transa_queno_actuan_opago->findCount($this->SQLCA()." and cod_tipo_nomina= '".$cod_tipo_nomina."' and cod_tipo_transaccion='".$cod_tipo_transaccion."' and cod_transaccion= '".$cod_transaccion."' ");
...
$sw2  = $this->Cnmd01->execute($sql);
  ...
  $resultado= $this->Cnmd01->execute("SELECT
              ...
              b.denominacion         as denominacion_cnmd03
			      ...
			      from  cnmd09_transa_queno_actuan_opago a, cnmd03_transacciones b where
...
function eliminar($var=null, $var2=null, $var3=null){
  ...
  $sql="BEGIN;  DELETE FROM cnmd09_transa_queno_actuan_opago  WHERE cod_presi = '".$cod_presi."' and cod_entidad  = '".$cod_entidad."' and  cod_tipo_inst = '".$cod_tipo_inst."' and cod_inst = '".$cod_inst."'  and  cod_dep  = '".$cod_dep."' and  cod_tipo_nomina= '".$var."' and cod_tipo_transaccion='".$var2."' and cod_transaccion= '".$var3."' ";

...
class ReporteFormulacionAlc2014Controller extends AppController{

	var $name = 'reporte_formulacion_alc2014';
...
function limpia_menu(){
	...
	// funcion que retorna SQL para busqueda de codigos de arranque con y sin año:
...
function forma_2100($var=null){
        ...
        if($var==null){
            ...
            $titulo_a = "DIRECCIÓN DE PRESUPUESTO";
...
}//fin de función forma:2100




function forma_2101($var=null){
...
$this->set('entidad_federal', $this->Session->read('entidad_federal'));
	...
	function forma_2103($opcion = null){
		if($opcion=='si'){
	...
	if($ano_actual == $anos[sprintf('%02d', $minCount-1)]){
		...
		$this->set('entidad_federal', $this->Session->read('entidad_federal'));
	} // Fin Function forma_2103





	function forma_2104($opcion = null){
		if($opcion=='si'){
	...
	if($ano_actual == $anos[sprintf('%02d', $minCount-1)]){
	    ...
	    $this->set('ano_formulacion', $dato);
			...
			$datos = $this->$modelo->findAll($condicion, 'ano, cod_sector, cod_programa, ingresos_propios, situado_municipal, estadal_municipal, fci, otras_fuentes_municipal, total, denominacion');
			$this->set('modelo', $modelo);
			$this->set('datos', $datos);
		}//fin else

		$this->set('entidad_federal', $this->Session->read('entidad_federal'));
	} // Fin Function forma_2104




	function forma_2104_b($opcion = null){
		if($opcion=='si'){
	...
	if($ano_actual == $anos[sprintf('%02d', $minCount-1)]){
	    ...
	    $this->set('ano_formulacion', $dato);
			...
			$datos = $this->$modelo->findAll($condicion, 'ano, cod_sector, cod_programa, cod_sub_prog, ingresos_propios, situado_municipal, estadal_municipal, fci, otras_fuentes_municipal, total, denominacion');
			$this->set('modelo', $modelo);
			$this->set('datos', $datos);
		}//fin else

		$this->set('entidad_federal', $this->Session->read('entidad_federal'));
	} // Fin Function forma_2104_B
	...
	function forma_2105($opcion = null){
		if($opcion=='si'){
	...
	if($ano_actual == $anos[sprintf('%02d', $minCount-1)]){
	    ...
	    $this->set('ano_formulacion', $dato);
			...
			$datos = $this->$modelo->findAll($condicion, 'ano, cod_partida, ingresos_propios, situado_municipal, estadal_municipal, fci, otras_fuentes_municipal, total, denominacion');
			$this->set('modelo', $modelo);
			$this->set('datos', $datos);
		}//fin else

		$this->set('entidad_federal', $this->Session->read('entidad_federal'));
	} // Fin Function forma_2105
	...
	function forma_2106($opcion = null){
		if($opcion=='si'){
...
$this->set('entidad_federal', $this->Session->read('entidad_federal'));
}//fin funcion forma_2109





function forma_2110($year=null) {
set_time_limit(0);
	$sql='';
...
$this->set('entidad_federal', $this->Session->read('entidad_federal'));
}//fin funcion forma_2110





function forma_2111($year=null){
	$sql='';
...
$this->set('entidad_federal', $this->Session->read('entidad_federal'));
	...
	function forma_2112($opcion = null){
		if($opcion=='si'){
	...
	if($ano_actual == $anos[sprintf('%02d', $minCount-1)]){
		...
		$this->set('entidad_federal', $this->Session->read('entidad_federal'));
	} // Fin Function forma_2112




function forma_2113($var1=null, $var2=null){
    $cod_presi                =       $this->Session->read('SScodpresi');
	$cod_entidad              =       $this->Session->read('SScodentidad');
	$cod_tipo_inst            =       $this->Session->read('SScodtipoinst');
	$cod_inst                 =       $this->Session->read('SScodinst');
...
if($var1==1){
	...
	if(!empty($this->data['organismo']['ano'])){
		...
		$datos = $this->v_2014_dpsp->execute("SELECT * FROM v_2014_dpsp WHERE ".$filtro.";");
        $this->set('datos',$datos);
...
$this->set('entidad_federal', $this->Session->read('entidad_federal'));
}//fin funcion forma_2117





function forma_2118 ($year=null) {
...
}//fin funcion forma_2118




function forma_2119($opcion=null, $opcion2=null, $opcion3=null){
	$sql='';
...
$this->set('entidad_federal', $this->Session->read('entidad_federal'));
}//fin function forma_2119





function forma_2120($tipo=null, $year=null){
	$sql='';
    set_time_limit(0);
    $SScoddeporig             =       $this->Session->read('SScoddeporig');
    $SScoddep                 =       $this->Session->read('SScoddep');
...
}//fin function forma 2120




function forma_2121($var1=null, $var2=null){
    $cod_presi                =       $this->Session->read('SScodpresi');
	$cod_entidad              =       $this->Session->read('SScodentidad');
	$cod_tipo_inst            =       $this->Session->read('SScodtipoinst');
	$cod_inst                 =       $this->Session->read('SScodinst');
...
}//fin funcion forma_2125




function forma_2126($var1=null, $var2=null){
    $cod_presi                =       $this->Session->read('SScodpresi');
	$cod_entidad              =       $this->Session->read('SScodentidad');
	$cod_tipo_inst            =       $this->Session->read('SScodtipoinst');
	$cod_inst                 =       $this->Session->read('SScodinst');
...
}//fin function forma_2126





function forma_2127($year=null) {
set_time_limit(0);
	$sql='';

...
$datos=$this->shd001_registro_contribuyentes->findAll("rif_cedula='".$var1."'");
	...
	$sacar=$this->v_shd100_patente->findAll($this->SQLCA()." and rif_cedula='".$var1."'");
	$sacar2=$this->shd600_solicitud_arrendamiento->findAll($this->SQLCA()." and rif_cedula='".$var1."'");
	if($sacar2!=null){
		$num2 = $sacar2[0]['shd600_solicitud_arrendamiento']['numero_solicitud'];
	}else{
		$num2=0;
	}
...
echo "document.getElementById('cobrador_actual').value='".$sacar[0]['v_shd100_patente']['rif_ci_cobrador']."';   ";
echo "document.getElementById('deno_cobrador_actual').value='".$sacar[0]['v_shd100_patente']['deno_cobrador']."';	 ";
echo "document.getElementById('numero_solicitud').value='".$sacar[0]['v_shd100_patente']['numero_solicitud']."';   ";
echo "document.getElementById('numero_patente').value='".$sacar[0]['v_shd100_patente']['numero_patente']."';	 ";
echo "document.getElementById('numero_solicitud2').value='".$num2."';   ";
echo'</script>';
					/*echo "<script>";
	...
	$vacio='';
					echo "<script>";
						...
						echo "document.getElementById('numero_patente').value='".$vacio."';   ";
						echo "document.getElementById('numero_solicitud2').value='".$vacio."';   ";
					echo "</script>";
}
}
...
function guardar(){
	$this->layout="ajax";
	$rif_contribuyente	 = $this->data['shp002_cobradores_reasig']['rif_constribuyente'];
	$cobrador_actual	 = $this->data['shp002_cobradores_reasig']['cobrador_actual'];
	$cobrador_cambio	 = $this->data['shp002_cobradores_reasig']['cobrador_cambio'];
	$numero_solicitud	 = $this->data['shp002_cobradores_reasig']['numero_solicitud'];
	$numero_patente		 = $this->data['shp002_cobradores_reasig']['numero_patente'];
	$numero_solicitud2	 = $this->data['shp002_cobradores_reasig']['numero_solicitud2'];

	$update1 = 	"update shd100_patente set rif_ci_cobrador='".$cobrador_cambio."' where numero_solicitud='".$numero_solicitud."' and numero_patente='".$numero_patente."' and rif_ci_cobrador='".$cobrador_actual."' and ".$this->SQLCA();

...
class Cstp07CancelacionesIvaController extends AppController{

    var $name = "cstp07_cancelaciones_iva";
...
//    cstd03_cheque_cuerpo
  ...
  $ano_movimiento                         =         $this->data['cstp07_cancelaciones_iva']['ano'];
  $ann = $ano_movimiento;
  $cod_entidad_bancaria                   =         $this->data['cstp07_cancelaciones_iva']['entidad'];
  $cod_sucursal                           =         $this->data['cstp07_cancelaciones_iva']['sucursal'];
  $cuenta_bancaria                        =         $this->data['cstp07_cancelaciones_iva']['cuenta'];
  $numero_cheque                          =         $this->data['cstp07_cancelaciones_iva']['numero_cheque'];
  $fecha_cheque                           =         $this->Cfecha($this->data['cstp07_cancelaciones_iva']['fecha'], 'A-M-D');
  $fd                                     =         $this->data['cstp07_cancelaciones_iva']['fecha'];
  $concepto                               =         $this->data['cstp07_cancelaciones_iva']['concepto'];
...
FROM
         ...
         cstd07_retenciones_cuerpo_iva a, cstd07_retenciones_partidas_iva b,  cepd03_ordenpago_cuerpo c
...
if(isset($this->data['cstp07_cancelaciones_iva']['ano_orden_pago_'.$var_aux])){

								if($ve2[0]['ano_orden_pago']    == $this->data['cstp07_cancelaciones_iva']['ano_orden_pago_'.$var_aux] &&
								   $ve2[0]['numero_orden_pago'] == $this->data['cstp07_cancelaciones_iva']['numero_orden_pago_'.$var_aux]
								){
								 ...
								 $var_aux++;
																			...
																			$sql_cstd06_comprobante_poremitir_egreso.= "VALUES ('".$cod_presi."', '".$cod_entidad."', '".$cod_tipo_inst."', '".$cod_inst."', '".$cod_dep."', '".$username."', '".$ano_comprobante_egreso."', '".$numero_comprobante_egreso."', '".$ve2[0]['ano_orden_pago']."', '".$ve2[0]['clase_orden']."', '".$ve2[0]['numero_orden_pago']."','11'); ";
								...
								ORDER BY
								           ...
								           cod_auxiliar ASC; ");
																			...
																			$datos_orden_pago_partidas = $this->cstd07_retenciones_partidas_iva->findAll($condicion. ' and  ano_orden_pago='.$ve2[0]['ano_orden_pago'].'  and  numero_orden_pago='.$ve2[0]['numero_orden_pago'], null, 'ano_orden_pago, numero_orden_pago, cod_sector, cod_programa, cod_sub_prog, cod_proyecto, cod_activ_obra, cod_partida, cod_generica, cod_especifica, cod_sub_espec, cod_auxiliar ASC');
																			...
																			$concate = $this->AddCeroR2(substr($ve['cstd07_retenciones_partidas_iva']['cod_partida'], -2) , substr($ve['cstd07_retenciones_partidas_iva']['cod_partida'], 0, 1 ) ).'.'.$this->AddCeroR2($ve['cstd07_retenciones_partidas_iva']['cod_generica']).'.'.$this->AddCeroR2($ve['cstd07_retenciones_partidas_iva']['cod_especifica']).'.'.$this->AddCeroR2($ve['cstd07_retenciones_partidas_iva']['cod_sub_espec']);


																			  $ano                                 =         $ve['cstd07_retenciones_partidas_iva']['ano'];
																			  $cod_sector                          =         $ve['cstd07_retenciones_partidas_iva']['cod_sector'];
																			  $cod_programa                        =         $ve['cstd07_retenciones_partidas_iva']['cod_programa'];
																			  $cod_sub_prog                        =         $ve['cstd07_retenciones_partidas_iva']['cod_sub_prog'];
																			  $cod_proyecto                        =         $ve['cstd07_retenciones_partidas_iva']['cod_proyecto'];
																			  $cod_activ_obra                      =         $ve['cstd07_retenciones_partidas_iva']['cod_activ_obra'];
																			  $cod_partida                         =         $ve['cstd07_retenciones_partidas_iva']['cod_partida'];
																			  $cod_generica                        =         $ve['cstd07_retenciones_partidas_iva']['cod_generica'];
																			  $cod_especifica                      =         $ve['cstd07_retenciones_partidas_iva']['cod_especifica'];
																			  $cod_sub_espec                       =         $ve['cstd07_retenciones_partidas_iva']['cod_sub_espec'];
																			  $cod_auxiliar                        =         $ve['cstd07_retenciones_partidas_iva']['cod_auxiliar'];
																			  $monto                               =         $this->Formato1($this->data['cstp07_cancelaciones_iva']['monto_'.$jj]);
																			  $numero_control_compromiso           =         $ve['cstd07_retenciones_partidas_iva']['numero_control_compromiso'];
																			  $numero_control_causado              =         $ve['cstd07_retenciones_partidas_iva']['numero_control_causado'];
																			...
																			$datos_cepd03_ordenpago_facturas = $this->cepd03_ordenpago_facturas->findAll($condicion. ' and  ano_orden_pago='.$ve2[0]['ano_orden_pago'].'  and  numero_orden_pago='.$ve2[0]['numero_orden_pago']);
...
if($this->cstd02_cuentas_bancarias->execute("UPDATE cstd02_cuentas_bancarias SET cheque_dia=".$cheque_dia.", cheque_mes=".$cheque_mes.", cheque_ano=".$cheque_ano.", monto_cheque_por_emitir=".$monto_cheque_por_emitir.", disponibilidad_libro=".$disponibilidad_libro."   WHERE cod_presi='".$cod_presi."' and cod_entidad='".$cod_entidad."' and  cod_tipo_inst='".$cod_tipo_inst."' and  cod_inst='".$cod_inst."' and cod_dep='".$cod_dep."' and cod_entidad_bancaria = '".$cod_entidad_bancaria."' and   cod_sucursal='".$cod_sucursal."' and  cuenta_bancaria='".$cuenta_bancaria."'; ")>=1){}else{$opcion = 'no';}//fin else
	...
	}else{$this->cstd03_cheque_cuerpo->execute("ROLLBACK;"); $this->set('errorMessage', 'La datos no fueron almacenados'); $this->index(); $this->render('index');}//fin else


}else{	$this->cstd03_cheque_cuerpo->execute("ROLLBACK;");  $this->set('errorMessage', 'Los datos no pueden ser almacenado verifique el n&uacute;mero de comprobante egreso'); $this->index(); $this->render('index'); }//fin else
}else{	$this->cstd03_cheque_cuerpo->execute("ROLLBACK;"); $this->set('errorMessage', 'Los datos no pueden ser almacenados');}//fin else
}else{	$this->cstd03_cheque_cuerpo->execute("ROLLBACK;");  $this->set('errorMessage', 'Los datos ya existen'); $this->index(); $this->render('index'); }//fin else
...
function agregar_orden_pago_session($var=null){
  ...
  if(!isset($_SESSION['opcion_emitir'])){$_SESSION['opcion_emitir']=1;}
   ...
   $beneficiario = "";
   $beneficiario = $this->cstd03_beneficiario_retencion_iva->findAll($this->SQLCA());



if(!isset($beneficiario[0]['cstd03_beneficiario_retencion_iva']['beneficiario'])){
...
ORDER BY
 ...
 if(isset($dato[0][0]['ano_orden_pago'])){
	...
	if(!isset($dato[0][0]['numero_orden_pago'])){
		   ...
		   $this->set('beneficiario',   $beneficiario[0]['cstd03_beneficiario_retencion_iva']['beneficiario']);
		   $_SESSION['ORDEN_PAGO_TOTAL']['autorizado'] = $beneficiario[0]['cstd03_beneficiario_retencion_iva']['beneficiario'];
	}//fin else
}//fin else

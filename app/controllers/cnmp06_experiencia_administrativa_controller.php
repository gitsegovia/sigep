...
if(!empty($this->data['cnmp06_experiencia_administrativa']['entidad_federal'.$var_n]) &&
   ...
   $fecha_egreso      =  cambiar_formato_fecha($this->data['cnmp06_experiencia_administrativa']['fecha_egreso'.$var_n]);
   $fecha_ingreso     =  cambiar_formato_fecha($this->data['cnmp06_experiencia_administrativa']['fecha_ingreso'.$var_n]);
   ...
   $cedula            =  $var1;
					if($var_n==null){
										...
										$sw2 = $this->cnmd06_experiencia_administrativa->execute($sql);
										   ...
										   if($var1!=null){
												  $accion =  $this->cnmd06_experiencia_administrativa->findAll('cedula='.$var1, null, "fecha_ingreso ASC");
											 }//fin if
										  $this->set('accion', $accion);
										...
										$sw2 = $this->cnmd06_experiencia_administrativa->execute($sql);
                                         ...
                                         $var_datos = $this->cnmd06_experiencia_administrativa->findAll("cedula=".$var1." and consecutivo=".$var_n);
...
/*
$aux_a = "<input name=data[][fecha_ingreso".$var2."] value=".cambia_fecha($var_c)." id=fecha_ingreso".$var2." style=text-align:right size=7 readOnly><img src=/img/date.png onclick=displayCalendar(document.forms[0].fecha_ingreso".$var2.",formarto,this) style=margin:0pt;padding:0pt alt=Calendario border=0 width=13%>";
$aux_b = "<input name=data[cnmp06_experiencia_administrativa][fecha_egreso".$var2."] value=".cambia_fecha($var_d)." id=fecha_egreso".$var2." style=text-align:right size=7 readOnly><img src=/img/date.png onclick=displayCalendar(document.forms[0].fecha_egreso".$var2.",formarto,this) style=margin:0pt;padding:0pt alt=Calendario border=0 width=13%>";
      ...
      echo'<script> formarto = "dd/mm/yyyy"; ';
           ...
           echo" document.getElementById('campo_a_".$var2."').innerHTML = '<input name=data[cnmp06_experiencia_administrativa][entidad_federal".$var2."]      value=\'".$var_a."\'  id=entidad_federal".$var2."      style=text-align:left class=inputtext>'; ";
           echo" document.getElementById('campo_b_".$var2."').innerHTML = '<input name=data[cnmp06_experiencia_administrativa][cargo_desempenado".$var2."]    value=\'".$var_b."\'  id=cargo_desempenado".$var2."    style=text-align:left class=inputtext>'; ";
           echo" document.getElementById('campo_c_".$var2."').innerHTML = '$aux_a'; ";
           echo" document.getElementById('campo_d_".$var2."').innerHTML = '$aux_b'; ";
           echo" document.getElementById('campo_e_".$var2."').innerHTML = '<input name=data[cnmp06_experiencia_administrativa][motivo_salida".$var2."]        value=\'".$var_e."\'  id=motivo_salida".$var2."    style=text-align:left class=inputtext>'; ";
     echo'</script>';*/

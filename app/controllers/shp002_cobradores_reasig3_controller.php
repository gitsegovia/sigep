...
$datos=$this->shd001_registro_contribuyentes->findAll("rif_cedula='".$var1."'");
	...
	$sacar=$this->v_shd300_propaganda->findAll($this->SQLCA()." and rif_cedula='".$var1."'");
...
echo'<script>';
 ...
 echo "document.getElementById('cobrador_actual').value='".$sacar[0]['v_shd300_propaganda']['rif_ci_cobrador']."';   ";
 echo "document.getElementById('deno_cobrador_actual').value='".$sacar[0]['v_shd300_propaganda']['deno_cobrador']."';	 ";
echo'</script>';
					/*echo "<script>";
...
function guardar(){
	$this->layout="ajax";
	$rif_contribuyente	 = $this->data['shp002_cobradores_reasig3']['rif_constribuyente'];
	$cobrador_actual	 = $this->data['shp002_cobradores_reasig3']['cobrador_actual'];
	$cobrador_cambio	 = $this->data['shp002_cobradores_reasig3']['cobrador_cambio'];
	...
	//$this->shd200_vehiculos->execute($update3);
